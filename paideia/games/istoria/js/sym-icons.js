/* ════════════════════════════════════════════════════════════════════
   sym-icons.js — Symposion house line-art icons (viewBox 100, stroke 1.4)
   Ported from the design handoff (reimagine/sym-icons.js). Exposes
   window.SYM = { icon(name), meanderURL, meanderBG(color) }.
   SVGs use stroke:currentColor; inner .lit fills --terra, .acc fills --gold.
   ════════════════════════════════════════════════════════════════════ */
(function(){
  const S = (inner,vb)=>`<svg viewBox="${vb||'0 0 100 100'}" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round" role="img" aria-hidden="true">${inner}</svg>`;
  const I = {
  ...
  // running meander (Greek key) tile — black mask used as background-image
