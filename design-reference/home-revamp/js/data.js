...
const SUBJECTS = {
  'gym-a': [
    ...
    { id:'archaia', roman:'III', illu:'scroll', gr:'Αρχαία Ελληνικά', en:'Ancient Greek', sub:'Ancient Greek',
      ...
      games:[ g('Κλίσις Ρημάτων','Verb Forms','εἰμί · φημί · οἶδα','column'),
  ...
  'gym-c': [
    ...
    { id:'archaia-c', roman:'III', illu:'scroll', gr:'Αρχαία Ελληνικά', en:'Ancient Greek', sub:'Ancient Greek',
      ...
      games:[ g('Κλίση Ουσιαστικών','Noun Declension','200+ λέξεις','column'),
              g('Παραθετικά','Adjective Degrees','10 επίπεδα','wreath'),
  ...
  'lyk-a': [
    { id:'archaia-thx', roman:'III', illu:'column', gr:'Αρχαία Ελληνικά', en:'Ancient Greek', sub:'Thucydides & prose',
      ...
      games:[ g('Κλίση Ουσιαστικών','Noun Declension','3 κλίσεις','column'),
              g('Λύω','Learning to Decline','32 επίπεδα','scroll'),
...
Object.assign(SUBJECTS, {
  'gram-archaia': [
    ...
    { id:'ga-nouns', roman:'II', illu:'column', gr:'Ονόματα & Επίθετα', en:'Nouns & Adjectives', sub:'Ancient Greek',
      ...
      games:[ g('Κλίση Ουσιαστικών','Noun Declension','3 κλίσεις · 200+ λέξεις','column'),
              g('Επίθετα','Adjectives','Κλίση & συμφωνία','scroll'),
              g('Παραθετικά','Adjective Degrees','10 επίπεδα','wreath'),
  ...
  'gram-latin': [
    { id:'gl-decl', roman:'I', illu:'column', gr:'Κλίσεις', en:'Declensions', sub:'Latin',
      ...
      games:[ g('Κλίση Ουσιαστικών','Noun Declension','5 κλίσεις · rosa, dominus','column'),
              g('Επίθετα','Adjectives','Κλίση & βαθμοί','wreath'),
              g('Αντωνυμίες','Pronouns','hic · ille · is','scroll') ] },
    { id:'gl-verbs', roman:'II', illu:'helmet', gr:'Ρήματα', en:'Verbs', sub:'Latin',
      ...
      games:[ g('Κλίση Ρημάτων','Verb Forms','4 συζυγίες','column'),
              g('Ανώμαλα Ρήματα','Irregular Verbs','possum · eo · fero','helmet'),
