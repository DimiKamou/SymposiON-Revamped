...
const SUBJECTS = {
  ...
  'lyk-a': [
    { id:'archaia-thx', roman:'III', illu:'column', gr:'Αρχαία Ελληνικά', en:'Ancient Greek', sub:'Thucydides & prose',
      ...
      games:[ g('Κλίση Ουσιαστικών','Noun Declension','3 κλίσεις','column',{fn:'openOusiastika'}),
  ...
  'lyk-c': [
    ...
    { id:'latinika-c', roman:'VI', illu:'walls', gr:'Λατινικά', en:'Latin', sub:'Latin · Προσανατολισμού',
      summary:{ gr:'Εισαγωγή, ανάλυση κειμένων (16–50) και γραμματική ανά κείμενο.', en:'Introduction, text analysis (16–50) and per-text grammar.' },
      games:[ g('Εισαγωγή','Introduction','Ρωμαϊκή λογοτεχνία · συγγραφείς · παιχνίδι','book',{fn:'openLatinIntro'}),
              g('Ανάλυση Κειμένων','Text Analysis','Ενότητες 16–50 · επιλογή κειμένου','scroll',{fn:'openLatinTextPicker'}),
              g('Ρήματα ανά Κείμενο','Verbs by Text','Αρχικοί χρόνοι ανά ενότητα','helmet',{fn:'openLatKata'}),
              g('Ουσιαστικά ανά Κείμενο','Nouns by Text','Κλίση ανά ενότητα','column',{fn:'openLatNounsKata'}),
              g('Επίθετα ανά Κείμενο','Adjectives by Text','Κλίση & βαθμοί ανά ενότητα','wreath',{fn:'openLatEpithetaKata'}) ] },
  ],
};
  ...
  'gram-latin': [
    ...
    { id:'gl-verbs', roman:'II', illu:'helmet', gr:'Ρήματα', en:'Verbs', sub:'Latin',
      ...
      games:[ g('Κλίση Ρημάτων','Verb Forms','4 συζυγίες · ενεργ. & παθ.','column',{fn:'openLatVerbs'}),
              g('Ανώμαλα Ρήματα','Irregular Verbs','possum · eo · fero','helmet',{fn:'openLatAnwmala'}),
              g('Θεωρία Ανωμάλων','Theory','Σημειώσεις · κανόνες','book',{fn:'openLatAnwmalaTheory'}) ] },
    // ── Θεωρία Συντακτικού — αυτόνομα διαδραστικά κεφάλαια συντακτικών φαινομένων. ──
    { id:'gl-syntax', roman:'III', illu:'labyrinth', gr:'Θεωρία Συντακτικού', en:'Syntax Theory', sub:'Latin · Προσανατολισμού',
    ...
    { id:'gl-morph', roman:'IV', illu:'column', gr:'Θεωρία Μορφολογίας', en:'Morphology Theory', sub:'Latin · Προσανατολισμού',
...
window.SYM.SUBJECT_TAGS = {
  ...
  'gl-decl':['grammar','latin'],     'gl-verbs':['grammar','latin'],
