...
const SUBJECTS = {
  ...
  'lyk-b': [
    ...
    { id:'latinika-b-texts', roman:'VII', illu:'scroll', gr:'Ανάλυση Κειμένων', en:'Text Analysis', sub:'Latin · Β΄ Λυκείου',
      ...
      games:[ gSoon('Ενότητες 1–15','Units 1–15','Πλήρης ανάλυση κάθε ενότητας · σύντομα','scroll') ] },
  ...
  'lyk-c': [
    ...
    { id:'agnwsto-kat', roman:'IV', illu:'scroll', gr:'Άγνωστο Κείμενα', en:'Unseen Texts', sub:'Αδίδακτο',
      summary:{ gr:'Αδίδακτο κείμενο — ανάλυση, μετάφραση και λεξιλόγιο ανά περίοδο, ανά συγγραφέα.', en:'Unseen text — analysis, translation and vocabulary by period, by author.' },
      games:[ g('Αδίδακτο · Εξάσκηση','Unseen Text','Ανάλυση · μετάφραση · λεξιλόγιο ανά περίοδο','scroll',{fn:'openAdidakto'}) ] },
    { id:'istoria-kat', roman:'V', illu:'acropolis', gr:'Ιστορία Κατεύθυνσης', en:'History (Advanced)', sub:'History',
      summary:{ gr:'Πανελλήνιες — τα πέντε θέματα της εξεταστέας ύλης, το καθένα με μελέτη → εξάσκηση → πηγές στον Άτλαντα.', en:'National exams — the five exam themes, each with study → practice → sources in the Atlas.' },
      games:[ g('Οικονομία','Economy','Αγροτικό & εργατικό ζήτημα, εμπόριο, τράπεζες, πτώχευση, κρίση 1929 · 3 κεφ.','coin',{fn:'openIstoria',args:['g3','oikonomia']}),
              g('Πολιτικά','Politics','Κόμματα, δεδηλωμένη, δικομματισμός, Διχασμός, εκσυγχρονισμός · 5 κεφ.','scales',{fn:'openIstoria',args:['g3','politika']}),
              g('Προσφυγικό','Refugees','Μικρασιατική καταστροφή, ΕΑΠ, Λοζάνη, αποκατάσταση προσφύγων · 10 κεφ.','caique',{fn:'openIstoria',args:['g3','prosfygiko']}),
              g('Κρητικό','Cretan','Κρητική Πολιτεία, Θέρισο, αρμοστείες, ένωση με την Ελλάδα · 9 κεφ.','labyrinth',{fn:'openIstoria',args:['g3','kritiko']}),
              g('Ποντιακό','Pontic','Παρευξείνιος ελληνισμός — ακμή, αγώνες για κράτος, γενοκτονία · 3 κεφ.','eagle',{fn:'openIstoria',args:['g3','pontiako']}),
    ...
    { id:'latinika-c-texts', roman:'VII', illu:'scroll', gr:'Ανάλυση Κειμένων', en:'Text Analysis', sub:'Latin · Προσανατολισμού',
      summary:{ gr:'Πλήρης ανάλυση κάθε ενότητας: κείμενο & σύνταξη, μετάφραση, ουσιαστικά/επίθετα, παραθετικά, αντωνυμίες, ρήματα, SOS.', en:'Full per-unit analysis: text & syntax, translation, nouns/adjectives, degrees, pronouns, verbs, SOS.' },
      games:[ g('Ενότητες 16–50','Units 16–50','Εισαγωγή + πλήρης ανάλυση κάθε ενότητας · κείμενο & σύνταξη, μετάφραση, SOS','scroll',{fn:'openLatinText16'}) ] },
