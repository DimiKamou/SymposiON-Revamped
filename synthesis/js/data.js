  ...
  'gram-latin': [
    ...
    { id:'gl-texts', roman:'VI', illu:'scroll', gr:'Ανάλυση Κειμένων', en:'Text Analysis', sub:'Latin · Προσανατολισμού',
      ...
      games:[ g('Εισαγωγή','Introduction','Ρωμαϊκή λογοτεχνία · συγγραφείς · ασκήσεις','book',{fn:'openLatinIntro'}),
              ...
              g('Ενότητα 26','Unit 26','Ο Πλίνιος αναγγέλλει ένα θλιβερό γεγονός','scroll',{fn:'openLatinText26'}),
              g('Ενότητα 27','Unit 27','Το πνεύμα ωριμάζει όπως και οι καρποί','scroll',{fn:'openLatinText27'}),
              g('Ενότητα 28','Unit 28','Στα ίχνη ενός δραπέτη δούλου','scroll',{fn:'openLatinText28'}),
              g('Ενότητα 29','Unit 29','Ο Οκταβιανός, ο παπουτσής και το κοράκι','scroll',{fn:'openLatinText29'}),
              g('Ενότητα 30','Unit 30','Ο Λικίνιος Μουρήνας και τα ήθη της Ανατολής','scroll',{fn:'openLatinText30'}),
