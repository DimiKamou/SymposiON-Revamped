...
export const UNIT = {
  ...
  etymology: [
    { la:"Iulia", el:"Ιουλία" },
    { la:"Augusti, Augustus", el:"Αύγουστος" },
    { la:"mature", el:"(= ώριμος) // (γαλλ.) maturité (= ωριμότητα)" },
    { la:"habere", el:"(γερμ.) haben (= έχω) // (αγγλ.) have" },
    { la:"legere [< lego]", el:"λέγω" },
    { la:"secrete [< secretus < se-cerno]", el:"κρίνω // (γαλλ.) secret (= μυστικό)" },
    { la:"solebat [< soleo]", el:"(γαλλ.) ob-solète (= απαρχαιωμένος), in-solent (= ιταμός, αήθης)" },
    { la:"re", el:"ρεαλισμός (< γαλλ.) // (αγγλ.) real (= πραγματικός)" },
    { la:"audita [< audio]", el:"ἀΐω" },
    { la:"voluit [< volo], mallet, malo [< magis + volo], nolis [< nolo < ne- + volo]", el:"βούλομαι // (αγγλ.) volunteer (= εθελοντής)" },
    { la:"de-terrere [< de-terreo]", el:"τρέω, τρόμος // (γαλλ.) terroriste (= τρομοκράτης)" },
    { la:"faceret, faciant [< facio]", el:"(αγγλ.) facts (= γεγονότα), factory (= εργοστάσιο)" },
    { la:"repente", el:"(ισπ.) repentino (= ξαφνικός)" },
    { la:"inter-venit", el:"βαίνω // (γαλλ.) venir (= έρχομαι), intervenir (= παρεμβαίνω), avenue (= λεωφόρος)" },
    { la:"op-pressit [< op-primo]", el:"πρέσα // (γαλλ.) oppression (= καταπίεση) // κομπρεσέρ (< γαλλ.) // κομπρέσα (< ιταλ.)" },
    { la:"ornatrices [< orno (= κοσμώ)]", el:"(γαλλ.) orner (= διακοσμώ) // (αγγλ.) ornate (= περίτεχνος)" },
    { la:"super vestem", el:"ὑπέρ // ἐσθής, ἔννυμι // βεστιάριο (< ιταλ.)" },
    { la:"de-pre-hendit", el:"χανδάνω (= κρατώ, χωρώ) // (αγγλ.) com-prehend (= κατανοώ, περιλαμβάνω)" },
    { la:"dis-simulavit", el:"(αγγλ.) similar (= όμοιος) // (γαλλ.) similarité (= ομοιότητα)" },
    { la:"aliis [< alius]", el:"ἄλλος, ἄλλη, ἄλλο" },
    { la:"vidisse", el:"(ϝιδεῖν) ιδέα, βίντεο (< αγγλ.)" },
    { la:"sermonibus", el:"(αγγλ.) sermon (= ομιλία, κήρυγμα)" },
    { la:"tempus", el:"τέμπο (< ιταλ.) // (ισπαν.) tiempo (= χρόνος)" },
    { la:"ex-traxit [< ex-traho]", el:"(αγγλ.) extra-ction (= εξαγωγή) / τρακτέρ (< γαλλ.)" },
    { la:"in-duxit [< in-duco]", el:"(γαλλ.) in-ductif (= επαγωγικός), con-ducteur (= οδηγός) // (αγγλ.) ad-ductor (= προσαγωγός μυς)" },
    { la:"mentionem [< mentio < mens]", el:"μέμνημαι, μνήμη, μνημονικός // μένος // (γαλλ.) mental (= δια-νοητικός)" },
    { la:"aetatis [< aetas < aevitas]", el:"(αγγλ.) eternal (= αιώνιος)" },
    { la:"interrogavit", el:"(γαλλ.) inter-rogation (= ερώτημα, ανάκριση), inter-rogatif (= ερωτηματικός)" },
    { la:"annos", el:"(γαλλ.) année (= έτος)" },
    { la:"esse", el:"εἰμί" },
    { la:"calva, calvam", el:"(γαλλ.) calvitie (= φαλάκρα)" },
    { la:"re-spondisset", el:"σπένδω, σπονδή, ἄσπονδος // (πορτογαλ.) responder (= απαντώ)" },
    { la:"ego", el:"εγώ" },
    { la:"pater", el:"πατήρ // (γαλλ.) paternel (= πατρικός)" },
    { la:"mendacium [< mendax < mentior]", el:"μένος, μνήμη / (γαλλ.) mentir (= ψεύδομαι) / (αγγλ.) mendacious (= ψεύτης, ψευδής)" },
    { la:"ob-iecit", el:"ἵημι (= ρίχνω)" },
    { la:"dubito [< dubius (= αμφίβολος)]", el:"δοιοί (= δύο, δύο τρόπων/ειδών), διττῶς, δύο // (αγγλ.) doubt (= αμφιβάλλω)" },
    { la:"times [< timeo]", el:"(αγγλ.) timorous (= δειλός, φοβικός)" }
  ]
};
