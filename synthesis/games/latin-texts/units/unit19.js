...
export const UNIT = {
  ...
  etymology: [
    ...
    { la:"generis", el:"γένος· γενιά // (αγγλ.) genus (= γένος (ταξινομική κατηγορία)) // (γαλλ.) genre (= είδος, γένος (π.χ. λογοτεχνικό))." },
    { la:"ingenii", el:"(αγγλ.) engine (= κινητήρας), ingenious (= ευφυής, επινοητικός) // (ισπαν.) ingenio (= ευφυΐα, πνεύμα / μηχανή)." },
    { la:"pravissimi", el:"μπράβος [< ιταλ. bravo (= μισθωτός σωματοφύλακας / ταραχοποιός)] // (αγγλ.) depraved (deprave) (= διεφθαρμένος (διαφθείρω))." },
    { la:"contra", el:"(επίρρημα) κόντρα (< ιταλ.) // (αγγλ.) contrary (= αντίθετος, ενάντιος), counter- (encounter) (= αντι- / αντιτίθεμαι, συναντώ)." },
    { la:"rem", el:"ρεαλισμός (< γαλλ.) // (αγγλ.) real (= πραγματικός), rebus (= εικονογραφικός γρίφος) // (γαλλ.) rien (= τίποτα)." },
    { la:"publicam", el:"(γαλλ.) publique (= δημόσιος) // (αγγλ.) public (= δημόσιος, κοινός), publish (= δημοσιεύω, εκδίδω)." },
    ...
    { la:"con-iurāvit (ius)", el:"(γαλλ.) justice (= δικαιοσύνη), juste (= δίκαιος) // (αγγλ.) justice, conjure (= επικαλούμαι, μαγεύω), jury (= σώμα ενόρκων, ένορκοι)." },
    { la:"clari", el:"(αγγλ.) clear (= καθαρός, σαφής), clarity (= σαφήνεια, διαύγεια), declare (= δηλώνω, διακηρύσσω) // (γαλλ.) clair (= καθαρός, φωτεινός)." },
    { la:"im-probi", el:"(αγγλ.) probity (= χρηστότητα, ακεραιότητα), prove (= αποδεικνύω, δοκιμάζω), probable (= πιθανός), approve (= εγκρίνω) // (γαλλ.) prouver (= αποδεικνύω)." },
    { la:"consecūti erant", el:"(αγγλ.) sequent (= ακόλουθος), sequence (= ακολουθία, σειρά), consecutive (= διαδοχικός) // (γαλλ.) suivre (= ακολουθώ)." },
    { la:"urbe", el:"(γαλλ.) urbain (= αστικός) // (αγγλ.) urban (= αστικός), suburb (= προάστιο) // (ιταλ.) urbano (= αστικός)." },
    { la:"expulsus est (ex-pellor)", el:"(αγγλ.) expulsion (= εκδίωξη, απέλαση), expelled (= διωγμένος, αποβληθείς), compel (= εξαναγκάζω), propel (= προωθώ, ωθώ), pulse (= σφυγμός, παλμός) // (γαλλ.) pousser (= σπρώχνω, ωθώ)." },
    { la:"socii", el:"(αγγλ.) social (= κοινωνικός), society (= κοινωνία), associate (= συνεταιρίζομαι, συνεργάτης) // σοσιαλισμός (< γαλλ.) // (γαλλ.) société (= κοινωνία, εταιρεία)." },
    { la:"de-prehensi sunt", el:"(αγγλ.) com-prehend (= κατανοώ, περιλαμβάνω), apprehend (= συλλαμβάνω, αντιλαμβάνομαι), prehensile (= συλληπτικός, που πιάνει) // (γαλλ.) prendre (= παίρνω, πιάνω)." },
    { la:"carcere", el:"(αγγλ.) in-carceration (= φυλάκιση, κάθειρξη), carceral (= σχετικός με τη φυλακή, σωφρονιστικός) // (ιταλ.) carcere (= φυλακή) // (ισπαν.) cárcel (= φυλακή)." },
    { la:"strangulāti sunt", el:"στραγγαλίζω // (αγγλ.) strangulate, strangle (= στραγγαλίζω, πνίγω) // (γαλλ.) étrangler // (ιταλ.) strangolare (= στραγγαλίζω) // (ισπαν.) estrangular (= στραγγαλίζω)." },
    { la:"exercitu", el:"(ισπαν.) ejército (= στρατός) // (γαλλ.) exercice (= άσκηση) // (αγγλ.) exercise (= άσκηση, ασκώ) // (ιταλ.) esercito (= στρατός)." },
    { la:"victus", el:"(γαλλ.) victoire, (αγγλ.) victory, vaincre (= νικώ) // (αγγλ.) convince (= πείθω), convict (= καταδικάζω, κατάδικος), invincible (= ανίκητος)." },
    { la:"inter-fectus est", el:"(αγγλ.) facts (= γεγονότα), factory (= εργοστάσιο), effect (= αποτέλεσμα, επίδραση), perfect (= τέλειος)." },
    { la:"Gaius Sallustius", el:"Γάιος Σαλλούστιος." },
    { la:"tradit", el:"(γαλλ.) tradition (= παράδοση) // (αγγλ.) traitor (= προδότης), treason (= προδοσία) // (ιταλ.) tradire (= προδίδω)." },
    { la:"multos", el:"μάλα (= πολύ) // (αγγλ.) multitude (= πλήθος), multiple (= πολλαπλός) // (ιταλ.) molto (= πολύ) // (ισπαν.) mucho (= πολύς)." },
    { la:"milites", el:"μιλιταρισμός (< γαλλ.) // (αγγλ.) military (= στρατιωτικός), militia (= πολιτοφυλακή), militant (= μαχητικός)." },
    { la:"Rōmānos", el:"Ρώμη, Ρωμαίος, ρωμαϊκός, ρωμιός // (αγγλ.) romance (= ιπποτικό μυθιστόρημα / ρομάντζο), romantic (= ρομαντικός) // (γαλλ.) roman (= μυθιστόρημα) // (ιταλ.) romanzo (= μυθιστόρημα)." },
    { la:"pugnā", el:"πύξ (= γροθιά)· πυγμή // (αγγλ.) pugnacious (= επιθετικός, καβγατζής), impugn (= αμφισβητώ, προσβάλλω) // (γαλλ.) poing (= γροθιά) // (ιταλ.) pugno (= γροθιά)." },
    { la:"graviter", el:"(γαλλ.) gravement (= βαριά, σοβαρά), gravité (= βαρύτητα, σοβαρότητα) // (αγγλ.) gravity (= βαρύτητα), aggravate (= επιδεινώνω)." },
