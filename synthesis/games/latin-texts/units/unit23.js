export const UNIT = {
  ...
  etymology: [
    ...
    { la:"Paetus", el:"Παίτος." },
    { la:"maritus, marito, mariti", el:"(γαλλ.) mari (= σύζυγος), mariage (= γάμος)." },
    { la:"Arriae, Arria", el:"Αρρία." },
    { la:"mortuus", el:"βροτός // (γαλλ.) mort (= νεκρός) // (αγγλ.) mortal (= θνητός)." },
    { la:"funus", el:"(γαλλ.) funérailles, (αγγλ.) funeral." },
    { la:"paravit", el:"(γαλλ.) pré-parer (= ετοιμάζω)." },
    { la:"ignoraretur", el:"(γαλλ.) ignorer (= αγνοώ), ignorance (= άγνοια)." },
    { la:"cubiculum", el:"κουβούκλιο // (αγγλ.) shower cubicle (= καμπίνα λουτρού)." },
    { la:"intraverat", el:"(γαλλ.) entrer (= μπαίνω)." },
    { la:"vivere", el:"βίος // βιταλισμός (< γαλλ. vitalisme), βιταμίνη (< γαλλ.)." },
    { la:"simulabat, simul", el:"(αγγλ.) similar (= όμοιος) // (γαλλ.) similarité (= ομοιότητα)." },
    { la:"interroganti", el:"(γαλλ.) interrogation (= ερώτημα, ανάκριση)." },
    { la:"ageret", el:"ἄγω." },
    { la:"puer", el:"puerulus → pullus (= μικρό ζώο) → (κατάληξη) -πουλος." },
    { la:"respondebat", el:"σπένδω, σπονδή· άσπονδος // (πορτογαλ.) responder (= απαντώ)." },
    { la:"bene", el:"μπονα-μάς [< ιταλ. bona mano (= καλό χέρι)], μπουνάτσα (< βενετ., = καλοκαιρία), μπόνους." },
    { la:"quievit", el:"(αγγλ.) quiet (= ησυχία)." },
    { la:"libenter", el:"(γερμ.) liebe (= αγάπη)." },
    { la:"lacrimae", el:"δάκρυμα (= αιτία δακρύων, δάκρυ), δάκρυον." },
    { la:"cohibitae", el:"(γερμ.) haben (= έχω), (αγγλ.) have." },
    { la:"vincerent", el:"(γαλλ.) victoire (= νίκη), (αγγλ.) victory." },
    { la:"egrediebatur", el:"(αγγλ.) egress (= έξοδος) // κογκρέσον (= συνάθροιση) < ιταλ. congresso, με αλλαγή της σημασίας κατά το αγγλικό congress." },
    { la:"dolori", el:"(αγγλ.) dolor (= θλίψη, πόνος)." },
    { la:"dabat", el:"δίδωμι· δώρημα, δώρο // (γαλλ.) donner (= δίνω)." },
    { la:"paulo", el:"παῦρος (= μικρός, λίγος)." },
    { la:"siccis", el:"σέκος (< ιταλ.)." },
    { la:"oculis", el:"ὄπ-ωπα, ὄμ-μα." },
    { la:"redibat", el:"εἶμι." },
    { la:"Scribonianus, Scriboniano", el:"Σκριβωνιανός." },
    { la:"arma", el:"άρμα, αρματολός // (γαλλ.) armée (= στρατός)." },
    { la:"Illyrico", el:"Ιλλυρία." },
    { la:"contra", el:"(επίρρ.) κόντρα (< ιταλ.)." },
    { la:"Claudium", el:"Κλαύδιος." },
    { la:"moverat", el:"(αγγλ.) move (= κινούμαι), motion (= κίνηση) // μοτέρ (< γαλλ.) // μοτίβο [< ιταλ. motivo (= κίνητρο)]." },
    { la:"partibus", el:"πάρτη, παρτίδα // (γαλλ.) partie." },
    { la:"Romam", el:"Ρώμη, Ρωμαίος, ρωμαϊκός, ρωμιός." },
    { la:"trahebatur", el:"τρακτέρ (< γαλλ.) // (αγγλ.) ex-traction (= εξαγωγή)." },
    { la:"erat, est", el:"εἰμί." },
    { la:"ascensurus", el:"ασανσέρ (< γαλλ. ascenseur)." },
    { la:"navem, naviculam", el:"ναῦς· ναύτης, ναυτικός." },
    { la:"milites", el:"μιλιταρισμός (< γαλλ.)." },
    { la:"orabat", el:"(αγγλ.) orator (= ρήτορας) // ορατόριο (είδος θρησκευτικής όπερας) (< ιταλ.)." },
    { la:"imponeretur", el:"(γαλλ.) positionner (= τοποθετώ) // position (= θέση)." },
    { la:"impetravit", el:"(γαλλ.) per-pétrer (= διαπράττω) // (αγγλ.) per-petration (= διάπραξη)." },
    { la:"conduxit", el:"(αγγλ.) ad-ductor (= προσαγωγός μυς) // (γαλλ.) con-ducteur (= οδηγός)." },
    { la:"piscatoriam", el:"πισίνα (< βενετ., κυρίως «ιχθυοτροφείο»)." },
    { la:"secuta", el:"ἕπομαι // (αγγλ.) sequent (= ακόλουθος) // (γαλλ.) seconde (= δευτερόλεπτο) // σεκόντο (= δεύτερη φωνή) (< ιταλ.)." }
  ]
};
