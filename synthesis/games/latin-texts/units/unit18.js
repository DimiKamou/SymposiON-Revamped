// ============================================================================
//  ΛΑΤΙΝΙΚΑ — ΦΥΛΛΟ ΔΕΔΟΜΕΝΩΝ ΕΝΟΤΗΤΑΣ 18
// ============================================================================
...
export const UNIT = {
  ...
  periods: [
    { n: 1, kids: [
      { type:"main", key:"kyria", label:"Κύρια", kids:[
        ...
        { l:"dicitur", r:"Ρήμα", g:"γ΄ ενικ. οριστ. ενεστ. παθ. φωνής", d:"dico, dixi, dictum, dicere (3) — λέω" },
        ...
        { l:"in eum locum", k:"locus", r:"Εμπρόθετος επιρρ. προσδ. του τόπου (κατεύθυνση)", to:"στο adduxisse", g:"in (πρόθ. + αιτ.) + locum (αιτ. ενικ.)· eum: επιθετικός προσδ. στο locum", d:"in — σε, προς· locus, -i (αρσ. β΄) — ο τόπος, το μέρος", note:"locus: ετερογενές (πληθ. loci = χωρία βιβλίου, loca = τόποι).", a:"," },
        { type:"sub", key:"anaforiki", label:"Αναφορική", note:"Δευτ. ονοματική αναφορική επιθετική προσδιοριστική πρόταση, ως επεξήγηση στο «eum locum» της εξάρτησής της.", kids:[
          ...
          { l:"condidit", r:"Ρήμα", g:"γ΄ ενικ. οριστ. παρακειμένου ενεργ. φωνής", d:"condo, condidi, conditum, condere (3) — χτίζω" },
          { l:"urbem", r:"Αντικείμενο", to:"στο condidit", g:"αιτ. ενικ.", d:"urbs, urbis (θηλ. γ΄) — η πόλη", note:"Γεν. πληθ.: urbium." },
          { l:"Romam", r:"Επεξήγηση", to:"στο urbem", g:"αιτ. ενικ.", d:"Roma, -ae (θηλ. α΄) — η Ρώμη", note:"Δεν έχει πληθ. αριθμό.", a:"." }
        ]}
      ]}
    ]},
    ...
    { n: 2, kids: [
      ...
      { type:"main", key:"kyria", label:"Κύρια", note:"Εννοούνται το ρήμα fertur και το υποκείμενο Hercules.", kids:[
        ...
        { l:"dormivisse", r:"Αντικείμενο (ειδικό απαρέμφατο)", to:"στο (εννοούμενο) fertur", g:"απαρέμφατο παρακειμένου ενεργ. φωνής", d:"dormio, dormi(v)i, dormitum, dormire (4) — κοιμάμαι", note:"Υποκείμενο Hercules (ταυτοπροσωπία)." },
        { l:"ibi", r:"Επιρρ. προσδ. του τόπου", to:"στο dormivisse", g:"τοπικό επίρρημα", d:"ibi — εκεί", a:"." }
      ]}
    ]},
    ...
    { n: 4, kids: [
      { type:"main", key:"kyria", label:"Κύρια", note:"Εννοούμενο υποκείμενο: Hercules. Οι χρονικές (Ubi … aspexit / … sensit) λειτουργούν ως επιρρ. προσδ. του χρόνου στο pergit.", kids:[
        { type:"sub", key:"xroniki", label:"Χρονική", note:"Δευτ. επιρρ. χρονική, ως επιρρ. προσδ. του χρόνου στο pergit. Εισάγεται με τον χρονικό σύνδεσμο ubi και εκφέρεται με οριστική, γιατί δηλώνει κάτι το πραγματικό.", kids:[
          ...
          { l:"excitatus", r:"Επιρρ. χρονική μετοχή", to:"στο aspexit", g:"ονομ. ενικ., αρσ. — μτχ. παρακ. παθ. φωνής", d:"excito, excitavi, excitatum, excitare (1) — σηκώνω· excitor e somno = ξυπνώ", note:"Υποκείμενο Hercules (συνημμένη)." },
          { l:"e somno", k:"somnus", r:"Εμπρόθετος επιρρ. προσδ. (έξοδος από κατάσταση)", to:"στο excitatus", g:"e(x) (πρόθ. + αφαιρ.) + somno (αφαιρ. ενικ.)", d:"e / ex — από· somnus, -i (αρσ. β΄) — ο ύπνος", a:"," },
        ...
        { type:"sub", key:"xroniki", label:"Χρονική", note:"Δευτ. επιρρ. χρονική, ως επιρρ. προσδ. του χρόνου στο pergit. Εισάγεται (εννοείται) με τον ubi — συνδέεται παρατακτικά με την προηγούμενη — και εκφέρεται με οριστική, γιατί δηλώνει κάτι το πραγματικό.", kids:[
          { l:"sensit", r:"Ρήμα", g:"γ΄ ενικ. οριστ. παρακειμένου ενεργ. φωνής", d:"sentio, sensi, sensum, sentire (4) — αισθάνομαι, αντιλαμβάνομαι", note:"Εννοούμενο υποκείμενο: Hercules." },
          ...
          { l:"partem", r:"Υποκείμενο απαρεμφάτου", to:"στο abesse", g:"αιτ. ενικ.", d:"pars, partis (θηλ. γ΄) — το μέρος, το τμήμα", a:"," }
        ]},
    ...
    { n: 5, kids: [
      ...
      { type:"main", key:"kyria", label:"Κύρια", note:"Εννοούμενο υποκείμενο: Hercules.", kids:[
        { type:"sub", key:"xroniki", label:"Χρονική", note:"Δευτ. επιρρ. χρονική, ως επιρρ. προσδ. του χρόνου στο coepit. Εισάγεται με τον χρονικό σύνδεσμο postquam και εκφέρεται με οριστική, γιατί δηλώνει κάτι το πραγματικό (προτερόχρονο).", kids:[
          ...
          { l:"vidit", r:"Ρήμα", g:"γ΄ ενικ. οριστ. παρακειμένου ενεργ. φωνής", d:"video, vidi, visum, videre (2) — βλέπω", note:"Εννοούμενο υποκείμενο: Hercules." },
          ...
          { l:"versa", r:"Κατηγορηματικός προσδ.", to:"στο vestigia", g:"αιτ. πληθ., ουδ. — μτχ. παρακ. παθ. φωνής", d:"verto, verti, versum, vertere (3) — στρέφω", a:"," }
        ]},
        ...
        { l:"coepit", r:"Ρήμα", g:"γ΄ ενικ. οριστ. παρακειμένου ενεργ. φωνής — ελλειπτικό", d:"coepi, coepisse — άρχισα", note:"Εννοούμενο υποκείμενο: Hercules." },
        ...
        { l:"ex infesto loco", k:"locus", r:"Εμπρόθετος επιρρ. προσδ. του τόπου (απομάκρυνση από το εγγύς)", to:"στο amovere", g:"ex (πρόθ. + αφαιρ.) + loco (αφαιρ. ενικ.)· infesto: επιθετικός προσδ.", d:"ex — από· locus, -i (αρσ. β΄) — ο τόπος· infestus, -a, -um — εχθρικός", a:"." }
      ]}
    ]},
    ...
    { n: 6, kids: [
      ...
      { type:"main", key:"kyria", label:"Κύρια", kids:[
        ...
        { l:"convertit", r:"Ρήμα", g:"γ΄ ενικ. οριστ. ενεστ. ενεργ. φωνής", d:"converto, converti, conversum, convertere (3) — γυρίζω / στρέφω κάποιον προς τα πίσω", note:"Ενεστ. convertit (ομόγραφο με τον παρακ.)." },
        { l:"Herculem", r:"Αντικείμενο", to:"στο convertit", g:"αιτ. ενικ., αρσ. — ανώμ. γ΄ κλ.", d:"Hercules, Herculis / Herculi (αρσ. γ΄) — ο Ηρακλής", a:"." }
      ]}
    ]},
    ...
    { n: 7, kids: [
      { type:"main", key:"kyria", label:"Κύρια", kids:[
        ...
        { l:"conatus", r:"Επιρρ. χρονική μετοχή", to:"στο interficitur", g:"ονομ. ενικ., αρσ. — μτχ. παρακ. (αποθ. ρήμα)", d:"conor, conatus sum, conari (1, αποθ.) — προσπαθώ", note:"Υποκείμενο Cacus (συνημμένη)." },
        ...
        { l:"vi", r:"Αφαιρετική του τρόπου", to:"στο prohibere", g:"αφαιρ. ενικ.", d:"vis (θηλ. γ΄) — η δύναμη· εδώ: η βία", a:"," },
        { l:"interficitur", r:"Ρήμα", g:"γ΄ ενικ. οριστ. ενεστ. παθ. φωνής", d:"interficio, interfeci, interfectum, interficere (3, 15 σε -io) — σκοτώνω" },
        { l:"clava", r:"Αφαιρετική του οργάνου", to:"στο interficitur", g:"αφαιρ. ενικ.", d:"clava, -ae (θηλ. α΄) — το ρόπαλο" },
        { l:"Herculis", r:"Γενική κτητική", to:"στο clava", g:"γεν. ενικ., αρσ. — ανώμ. γ΄ κλ.", d:"Hercules, Herculis / Herculi (αρσ. γ΄) — ο Ηρακλής", a:"." }
      ]}
    ]}
  ],
  ...
  alignment: [
    { la:"Hercules dicitur", el:"Ο Ηρακλής λέγεται" },
    { la:"adduxisse boves Geryonis", el:"ότι οδήγησε τα βόδια του Γηρυόνη" },
    { la:"ex Hispania in eum locum,", el:"από την Ισπανία σε αυτόν τον τόπο," },
    { la:"ubi postea Romulus", el:"όπου αργότερα ο Ρωμύλος" },
    { la:"condidit urbem Romam.", el:"έχτισε την πόλη Ρώμη." },
    { la:"Prope Tiberim fluvium", el:"Κοντά στον Τίβερη ποταμό" },
    { la:"Hercules fertur refecisse boves", el:"ο Ηρακλής λέγεται ότι ξεκούρασε τα βόδια" },
    { la:"et ipse fessus de via", el:"και ο ίδιος κουρασμένος από τον δρόμο" },
    { la:"dormivisse ibi.", el:"κοιμήθηκε εκεί." },
    { la:"Tum Cacus pastor,", el:"Τότε ο Κάκος ο βοσκός," },
    { la:"fretus viribus,", el:"έχοντας εμπιστοσύνη στις δυνάμεις του," },
    { la:"traxit caudis quosdam boves", el:"τράβηξε από τις ουρές μερικά βόδια" },
    { la:"in speluncam", el:"σε μια σπηλιά" },
    { la:"aversos.", el:"γυρισμένα ανάποδα." },
    { la:"Ubi Hercules,", el:"Μόλις ο Ηρακλής," },
    { la:"excitatus e somno,", el:"αφού σηκώθηκε από τον ύπνο," },
    { la:"aspexit gregem", el:"κοίταξε το κοπάδι" },
    { la:"et sensit abesse partem,", el:"και κατάλαβε ότι έλειπε ένα μέρος," },
    { la:"pergit ad proximam speluncam;", el:"κατευθύνεται στην κοντινότερη σπηλιά·" },
    { la:"sed postquam vidit vestigia boum", el:"αλλά, αφού είδε τα ίχνη των βοδιών" },
    { la:"foras versa,", el:"στραμμένα προς τα έξω," },
    { la:"confusus", el:"μπερδεμένος" },
    { la:"coepit amovere gregem", el:"άρχισε να απομακρύνει το κοπάδι" },
    { la:"ex infesto loco.", el:"από τον εχθρικό τόπο." },
    { la:"Sed mugitus bovum", el:"Αλλά το μουγκρητό των βοδιών" },
    { la:"auditus ex spelunca", el:"που ακούστηκε από τη σπηλιά" },
    { la:"convertit Herculem.", el:"γύρισε πίσω τον Ηρακλή." },
    { la:"Tum Cacus,", el:"Τότε ο Κάκος," },
    { la:"conatus prohibere eum vi,", el:"ενώ προσπαθούσε να τον εμποδίσει με τη βία," },
    { la:"interficitur clava Herculis.", el:"σκοτώνεται από το ρόπαλο του Ηρακλή." }
  ],
