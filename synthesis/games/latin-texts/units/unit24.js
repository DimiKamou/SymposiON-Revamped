export const UNIT = {
  ...
  etymology: [
    ...
    { la:"poetam", el:"ποιέω-ῶ· ποιητής, ποίηση· εκποίηση, προσποίηση." },
    { la:"venisset", el:"βαίνω // (γαλλ.) avenue (= λεωφόρος)." },
    { la:"ancilla, ancillae", el:"(αγγλ.) ancillary (= επικουρικός)." },
    { la:"dixisset, dixisse", el:"δείκ-νυμι (= δείχνω) // (γαλλ.) dictionnaire (= λεξικό), dictée (= ορθογραφία, υπαγόρευση)." },
    { la:"domi, domini", el:"δέμω, δόμος // δώμα, δωμάτιο, νεόδμητος // (γαλλ.) domestique (= εξημερωμένος), dominant (= κυρίαρχος), dominer (= κυριαρχώ)." },
    { la:"esse, erat, es", el:"εἰμί." },
    { la:"sensit", el:"(γαλλ.) sentir (= αισθάνομαι, νιώθω), sensible (= ευαίσθητος)." },
    { la:"intus", el:"ἔνδον, ἐντός // (γαλλ.) interiorité (= εσωτερικότητα)." },
    { la:"accipe", el:"(γαλλ.) accepter (= δέχομαι) // (ιταλ.) capire (= καταλαβαίνω)." },
    { la:"nunc", el:"νῦν." },
    { la:"fecerit", el:"(αγγλ.) facts (= γεγονότα), factory (= εργοστάσιο)." },
    { la:"paucis (paulus)", el:"παῦρος (= λίγος)." },
    { la:"diebus", el:"(Ζεύς, γενική Διός) Δίας (ως «θεός του φωτός»)." },
    { la:"ianua", el:"Ianus (= Ιανός) > Ιανουάριος." },
    { la:"exclamavit", el:"ρεκλάμα [< γαλλ. réclame (= διαφήμιση)]." },
    { la:"indignatus", el:"(γαλλ.) dignité (= αξιοπρέπεια), αντιθ. indignité." },
    { la:"aperte", el:"(ιταλ.) aprire (= ανοίγω)." },
    { la:"mentiebatur", el:"μένος, μνήμη // (γαλλ.) mentir (= ψεύδομαι)." },
    { la:"ego", el:"ἐγώ." },
    { la:"cognosco", el:"γι-γνώσκω." },
    { la:"vocem", el:"(αγγλ.) vocal (= φωνητικός), voice (= φωνή), revocation (= ανάκληση) // (γαλλ.) vocabulaire (= λεξιλόγιο)." },
    { la:"vis(ne)", el:"βούλομαι // (αγγλ.) volunteer (= εθελοντής)." },
    { la:"scire", el:"(γαλλ.) science (= επιστήμη), con-scient (= ειδήμων)." },
    { la:"responderit", el:"σπένδω, σπονδή· ἄσπονδος // (πορτογαλ.) responder (= απαντώ)." },
    { la:"homo", el:"ουμανισμός (< γαλλ.)." },
    { la:"impudens", el:"(αγγλ.) impudence (= αναίδεια) // (γαλλ.) pudique (= σεμνός, μετριόφρων)." },
    { la:"credidi, credis", el:"(αγγλ.) credible (= πιστευτός), αντιθ. incredible." }
  ]
};
