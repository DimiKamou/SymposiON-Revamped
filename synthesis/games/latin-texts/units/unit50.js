...
export const UNIT = {
  ...
  etymology: [
    ...
    { la:"Cotta", el:"Κόττας" },
    { la:"consules", el:"(γαλλ.) consul (= πρόξενος), consulter (= συμβουλεύω) // (αγγλ.) consultant (= σύμβουλος)" },
    { la:"senatu", el:"(αγγλ.) senator (= γερουσιαστής), senior (= ηλικιωμένος)" },
    { la:"con-tenderent [< contendo < cum + tendo]", el:"τείνω, τένων (= τένοντας) // (γαλλ.) tendu (= τεντωμένος) // (αγγλ.) contender (= αντίπαλος)" },
    { la:"ad-versus", el:"(verso) βέρσο (= πίσω μέρος σελίδας), v.s. (= εναντίον)· ρεβέρ (< γαλλ.)" },
    { la:"Viriathum", el:"Βιρίαθος" },
    { la:"Hispaniam", el:"Ισπανία" },
    { la:"mitteretur, mitti [< mitto]", el:"(αγγλ.) mission (= αποστολή)" },
    { la:"magna", el:"μέγας // (αγγλ.) magnific (= μεγαλοπρεπής) // (γαλλ.) magnificence (= μεγαλοπρέπεια)" },
    { la:"patres", el:"πατήρ // (γαλλ.) paternel (= πατρικός)" },
    { la:"con-scriptos [< conscribo]", el:"σκάριφος (= όργανο γραφής), σκαρίφημα // (αγγλ.) script (= σενάριο κινηματογραφικής ταινίας)" },
    { la:"dis-sensio, dis-sensit [< dissentio < dis + sentio]", el:"(γαλλ.) dissension (= διαφωνία), (αγγλ.) dissent" },
    { la:"erat, est", el:"εἰμί" },
    { la:"aliis [< alius]", el:"ἄλλος, ἄλλη, ἄλλο" },
    { la:"dicentibus, dicta [< dico]", el:"δείκνυμι (= δείχνω) // (γαλλ.) dictionnaire (= λεξικό), dictée (= ορθογραφία, υπαγόρευση)" },
    { la:"solus", el:"σόλο (< ιταλ.), σολίστας // (γαλλ.) solitude (= μοναξιά)" },
    { la:"Publius", el:"Πόπλιος" },
    { la:"Scipio", el:"Σκιπίωνας" },
    { la:"Aemilianus [< Aemilius]", el:"Αιμιλιανός, Αιμίλιος" },
    { la:"toto [< totus]", el:"(αγγλ.) total (= σύνολο) // totalité (= ολότητα)" },
    { la:"neutrum, neuter [< neuter < ne- + uter]", el:"οὐδέτερος // (γαλλ.) neutre" },
    { la:"placet", el:"(αγγλ.) placebo (= εικονικό φάρμακο)" },
    { la:"alter, alteri", el:"ἄλλος, ἄλλη, ἄλλο" },
    { la:"satis", el:"ἅδην [< *σαδ-ην] // (γαλλ.) satis-fait (= ικανοποιημένος)" },
    { la:"habet", el:"(γερμ.) haben (= έχω), (αγγλ.) have" },
    { la:"aeque [< aequus]", el:"(αγγλ.) equal (= ίσος)" },
    { la:"malam [< malus], male-volentia [< malevolens < male- + volo]", el:"μέλας, (γαλλ.) mal (= κακός), (ισπαν.) male-volencia (= μοχθηρία) // βούλομαι, (αγγλ.) volunteer (= εθελοντής)" },
    { la:"imperii", el:"ιμπεριαλισμός (< γαλλ.)" },
    { la:"magistram [< magister < magis]", el:"μάγιστρος, μαέστρος (< ιταλ.), μάστορας" },
    { la:"iudicabat [< iudico < ius dico]", el:"(γαλλ.) justice (= δικαιοσύνη), juste (= δίκαιος) // δείκνυμι (= δείχνω)" },
    { la:"avaritiam", el:"(γαλλ.) avarice (= φιλαργυρία)" },
    { la:"sententia [< sentio]", el:"(αγγλ.) sentence (= πρόταση και απόφαση)" },
    { la:"graviter [< gravis]", el:"βαρύς // (γαλλ.) gravité (= βαρύτητα, σοβαρότητα) // grièvement (= βαριά, σοβαρά)" },
    { la:"obtinuit [< obtineo < ob + teneo]", el:"τείνω // (γαλλ.) tenir (= κρατώ), obtenir (= αποκτώ)" },
    { la:"provinciam", el:"(γαλλ.) province (= επαρχία)" }
  ]
};
