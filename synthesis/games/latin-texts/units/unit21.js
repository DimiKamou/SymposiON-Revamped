export const UNIT = {
  ...
  etymology: [
    ...
    { la:"dux", el:"δούκας." },
    { la:"Galli, Gallos", el:"Γάλλοι, Γαλλία." },
    { la:"Alliam", el:"Αλίας." },
    { la:"flumen", el:"φλέω (= είμαι κατάμεστος), φλύω (= αναβράζω), φλοῖσβος (= ήχος κυμμάτων) // (γερμ.) fluss (= ποτάμι)." },
    { la:"deletis", el:"(αγγλ.) delete (= διάγραψε)." },
    { la:"legionibus", el:"λέγω." },
    { la:"Romanorum, Romam", el:"Ρώμη, Ρωμαίος, ρωμαϊκός, ρωμιός." },
    { la:"everterunt, reversus", el:"(verso) βέρσο (= πίσω μέρος σελίδας), ρεβέρ (< γαλλ.), v.s. (= εναντίον)." },
    { la:"urbem", el:"(γαλλ.) urbain (= αστικός)." },
    { la:"Capitolium (< caput)", el:"Καπιτώλιο // καπέλο [< ιταλ. capello (= κάλυμμα κεφαλιού)] // (γαλλ.) capitalisme." },
    { la:"immensam (< in + metior)", el:"μέτρον, μέτριος." },
    { la:"acceperunt, recepit", el:"(γαλλ.) accepter (= δέχομαι) // (ιταλ.) capire (= καταλαβαίνω)." },
    { la:"Camillus", el:"Κάμιλλος // (γαλλ.) Camille." },
    { la:"Ardeam", el:"Αρδέα." },
    { la:"exilio, exilium", el:"(γαλλ.) exil (= εξορία)." },
    { la:"praedam", el:"(αγγλ.) prey (= λεία)." },
    { la:"aequo", el:"(αγγλ.) equal (= ίσος)." },
    { la:"iure", el:"(αγγλ.) justice, (γαλλ.) justice (= δικαιοσύνη) // (γαλλ.) juste (= δίκαιος)." },
    { la:"divisam", el:"(γαλλ.) diviser (= χωρίζω)." },
    { la:"absens, est", el:"εἰμί." },
    { la:"dictator, dicitur", el:"δείκ-νυμι (= δείχνω) // δικτάτορας // (γαλλ.) dictionnaire (= λεξικό), dictée (= ορθογραφία, υπαγόρευση)." },
    { la:"factus, factum", el:"(αγγλ.) facts (= γεγονότα), factory (= εργοστάσιο)." },
    { la:"abeuntes, rediit", el:"εἶμι // ιταμός." },
    { la:"secutus", el:"ἕπομαι // (αγγλ.) sequent (= ακόλουθος) // (γαλλ.) seconde (= δευτερόλεπτο) // σεκόντο (= δεύτερη φωνή) (< ιταλ.)." },
    { la:"aurum", el:"(γαλλ.) or." },
    { la:"appensum, pensatum", el:"(αγγλ.) pending (= εκκρεμής) // (γαλλ.) peser (= ζυγίζω)." },
    { la:"civitati", el:"κοίτη· (αγγλ.) city (= πόλη) // (γαλλ.) civilisation (= πολιτισμός)." },
    { la:"nomen", el:"ὄνομα // (γαλλ.) nom (= όνομα, ουσιαστικό), (αγγλ.) name." },
    { la:"dedit", el:"δίδωμι· δώρημα, δώρο // (γαλλ.) donner (= δίνω)." },
    { la:"Pisaurum", el:"Πίσαυρο // (ιταλ.) Pesaro." },
    { la:"rogatus", el:"(γαλλ.) inter-rogation (= ερώτημα, ανάκριση)." }
  ]
};
