export const UNIT = {
  ...
  etymology: [
    { la:"Octavianus", el:"Οκταβιανός." },
    { la:"victoriam, victor", el:"(γαλλ.) victoire (= νίκη), (αγγλ.) victory." },
    { la:"Actiacam", el:"Άκτιο." },
    { la:"Romam", el:"Ρώμη, Ρωμαίος, ρωμαϊκός, ρωμιός." },
    { la:"rediret", el:"εἶμι // ιταμός." },
    { la:"homo", el:"ουμανισμός (< γαλλ.)." },
    { la:"occurrit", el:"κούρσα (< γαλλ.) // κουρσάρος (< ιταλ.)." },
    { la:"corvum, corvus, corvo", el:"κόραξ // (γαλλ.) corbeau." },
    { la:"tenens", el:"(γαλλ.) tenir (= κρατώ) // (αγγλ.) con-tent (= περιεχόμενο)." },
    { la:"instituerat", el:"ινστιτούτο // (γαλλ.) instituer (= θεσπίζω, ιδρύω)." },
    { la:"dicere, dixit", el:"δείκ-νυμι (= δείχνω) // (γαλλ.) dictionnaire (= λεξικό), dictée (= ορθογραφία, υπαγόρευση)." },
    { la:"Caesar, Caesaris, Caesari", el:"Καίσαρας, καισαρική (τομή), καισαρισμός." },
    { la:"imperator", el:"ιμπεριαλισμός (< γαλλ.)." },
    { la:"multum", el:"μάλα (= πολύ)." },
    { la:"emere, emit", el:"(γερμ.) nehmen (= παίρνω)." },
    { la:"viginti", el:"εἴκοσι // (γαλλ.) vingt." },
    { la:"milibus", el:"μίλι // (γαλλ.) mille (= χίλια), million (= εκατομμύριο)." },
    { la:"sestertium", el:"σηστέρτιος." },
    { la:"exemplum", el:"(γαλλ.) exemple (= παράδειγμα)." },
    { la:"sutorem, sutor (< suo = ράβω)", el:"κοστούμι (< ιταλ.) // (γαλλ.) suture (= ραφή, ράμμα)." },
    { la:"incitavit", el:"(γαλλ.) inciter (= υποκινώ)." },
    { la:"doceret", el:"δοκέω, δόγμα // ντοκουμέντο (< ιταλ.) // (γαλλ.) docteur (= διδάκτωρ)." },
    { la:"parem", el:"(γαλλ.) pareil (= όμοιος), comparer (= συγκρίνω) // (αγγλ.) com-pare." },
    { la:"salutationem, salutatione, salutationum", el:"(γαλλ.) salutation (= χαιρετισμός)." },
    { la:"operam (< opus)", el:"όπερα, οπερέτα (< ιταλ.)." },
    { la:"frustra", el:"(αγγλ.) frustrate (= ματαιώνω)." },
    { la:"impendebat", el:"(γαλλ.) dé-penser (= ξοδεύω)." },
    { la:"avis, avem", el:"αἰετός, αετός // (γαλλ.) aviateur (= αεροπόρος), aviation (= αεροπορία)." },
    { la:"respondebat", el:"σπένδω, σπονδή· άσπονδος // (πορτογαλ.) responder (= απαντώ)." },
    { la:"oleum", el:"ἔλαιον // (αγγλ.) oil (= λάδι) // (γαλλ.) olive (= ελιά)." },
    { la:"perdidi", el:"δίδωμι // (γαλλ.) perdre (= χάνω), perdition (= απώλεια)." },
    { la:"didicit", el:"δι-δάσκομαι." },
    { la:"cupidus", el:"(γαλλ.) cupide (= άπληστος), cupidité (= απληστία)." },
    { la:"audita, audio", el:"ἀΐω (= ακούω)." },
    { la:"domi, domini", el:"δέμω, δόμος // δώμα, δωμάτιο, νεόδμητος // (γαλλ.) domestique (= εξημερωμένος)." },
    { la:"satis", el:"ἄδην (< *σαδ-ην) // (γαλλ.) satis-fait (= ικανοποιημένος)." },
    { la:"venit", el:"βαίνω // (γαλλ.) avenue (= λεωφόρος)." },
    { la:"mentem", el:"μιμνήσκω, μνήμη, μέντωρ // (γαλλ.) mental (= διανοητικός)." },
    { la:"verborum, verba", el:"(Fερέω) ἐρῶ // (γαλλ.) verbe (= ρήμα)· βερμπαλισμός (< γαλλ.)." },
    { la:"Augustus", el:"Αύγουστος." },
