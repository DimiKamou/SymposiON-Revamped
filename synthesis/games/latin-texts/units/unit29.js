  ...
  periods: [
    ...
    { n: 5, kids: [
      { type:'main', key:'kyria', label:'Κύρια', note:'Κύρια πρότ. κρίσεως.', kids:[
        ...
        { l:'incitavit', r:'Ρήμα', g:'γ΄ ενικ. οριστ. παρακ. ενεργ.', d:'incito, incitavi, incitatum, incitare (1) — παρακινώ' },
    ...
    { n: 6, kids: [
      { type:'main', key:'kyria', label:'Κύρια', note:'Κύρια πρότ. κρίσεως.', kids:[
        ...
        { l:'operam', r:'Αντικείμενο', to:'στο impendebat', g:'αιτ. ενικ., θηλ.', d:'opera, operae (θηλ. α΄) — ο κόπος (πληθ. operae = οι μισθωτοί εργάτες, ετερόσημο)', a:';' }
      ]}
    ]},
