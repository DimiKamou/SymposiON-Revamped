...
export const UNIT = {
  ...
  etymology: [
    { la:"Porcia", el:"Πορκία" },
    { la:"Brutus", el:"Βρούτος" },
    { la:"uxor", el:"(γαλλ.) uxori-cide (= συζυγοκτονία)" },
    { la:"viri", el:"βιρτουόζος (< ιταλ. virtuoso)" },
    { la:"inter-ficiendo [< interficio < inter + facio], officium [< officio < ob + facio], factum [< facio]", el:"(αγγλ.) facts (= γεγονότα), factory (= εργοστάσιο) // (γαλλ.) office (= γραφείο), officiel (= επίσημος)" },
    { la:"Caesare", el:"Καίσαρας, καισαρική (τομή), καισαρισμός" },
    { la:"cognovisset [< cognosco < cum + gnosco (αρχαϊκός τύπος του nosco)]", el:"γι-γνώσκω" },
    { la:"cultellum [< culter]", el:"σκάλλω, σκαλίζω // (αγγλ.) co(u)lter (= μαχαίρι)" },
    { la:"tonsorium, tonsoris [< tonsor < tondeo]", el:"(αγγλ.) tonsure (= κουρά) // (γαλλ.) tondre (= κουρεύω)" },
    { la:"unguium [< unguis]", el:"ὄνυξ (= νύχι) // (αγγλ.) ungula (= οπλή)" },
    { la:"re-secandorum [< re-seco]", el:"σέγα [< (ιταλ.) sega (= πριόνι)]" },
    { la:"causa", el:"(γαλλ.) cause (= αιτία), accusation (= κατηγορία)" },
    { la:"forte", el:"φουρτούνα (< ιταλ.) // (γαλλ.) fortune (= τύχη)" },
    { la:"clamore [< clamor < clamo]", el:"ρε-κλάμα [< (γαλλ.) reclame (= διαφήμιση)]" },
    { la:"ancillarum", el:"(αγγλ.) ancillary (= επικουρικός)" },
    { la:"cubiculum", el:"κουβούκλιο // (αγγλ.) shower cubicle (= καμπίνα λουτρού)" },
    { la:"vocatus [< voco < vox]", el:"(αγγλ.) vocal (= φωνητικός), voice (= φωνή) // (γαλλ.) vocabulaire (= λεξιλόγιο)" },
    { la:"obiurgandam [< obiurgo < ob + iurgo < iure ago]", el:"ἄγω // (γαλλ.) justice (= δικαιοσύνη) // (αγγλ.) justice // (γαλλ.) juste (= δίκαιος)" },
    { la:"venit [< venio]", el:"βαίνω // (γαλλ.) venir (= έρχομαι), avenue (= λεωφόρος)" },
    { la:"prae-ripuisset [< praeripio < prae + rapio]", el:"(γαλλ.) rapt (= απαγωγή)" },
    { la:"secreto [< secretus < se-cerno], certissimum [< certus]", el:"κρίνω // (γαλλ.) secret (= μυστικό), certain (= βέβαιος)" },
    { la:"est, essem", el:"εἰμί" },
    { la:"indicium [< index < indico < in + dico]", el:"δείκνυμι (= δείχνω) // (γαλλ.) dictionnaire (= λεξικό), dictée (= ορθογραφία, υπαγόρευση)" },
    { la:"amoris [< amor]", el:"αμόρε (< ιταλ.) // (γαλλ.) amour (= αγάπη), ami (= φίλος)" },
    { la:"ex-periri [< ex-perior]", el:"πείρα, πειρατής, άπειρος, απειρία // εξπέρ [< (γαλλ.) expert (= ειδικός)]" },
    { la:"volui [< volo]", el:"βούλομαι // (αγγλ.) volunteer (= εθελοντής)" },
    { la:"elapso [< elabor < ex + labor]", el:"λαμβάνω // (αγγλ.) labor (= μόχθος) // (γαλλ.) laborieux (= κοπιώδης)" },
    { la:"vulneravit [< vulnero < vulnus]", el:"οὐλή (= επουλωμένο τραύμα) // (αγγλ.) vulnerable (= τρωτός, ευπαθής)" },
    { la:"aequo", el:"(αγγλ.) equal (= ίσος)" },
    { la:"animo", el:"ανιμισμός (< γαλλ.) // άνεμος" },
    { la:"ferro", el:"(γαλλ.) ferreux (= σιδηρούχος)" },
    { la:"inter-emptura [< interimo < inter + emo]", el:"(γερμ.) nehmen (= παίρνω)" },
    { la:"sententia [< sentio]", el:"(αγγλ.) sentence (= απόφαση)" },
    { la:"cessisset [< cedo]", el:"(γαλλ.) céder (= παραχωρώ), recession (= ύφεση, επιβράδυνση)" }
  ]
};
