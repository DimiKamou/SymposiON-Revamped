...
export const UNIT = {
  ...
  etymology: [
    { la:"nonnulli [< non + nullus]", el:"νούλα [< ιταλ. nulla (= μηδενικό, χωρίς αξία)] // (αγγλ.) annul (= ακυρώνω), nullify (= εκμηδενίζω, ακυρώνω)." },
    { la:"sunt, esse [< sum]", el:"εἰμί // (αγγλ.) essence (= ουσία), essential (= ουσιώδης)." },
    { la:"ordine [< ordo]", el:"(αγγλ.) order (= διαταγή), ordinary (= συνήθης), ordinal (= τακτικός (αριθμός)), coordinate (= συντονίζω / συντεταγμένη) // (γαλλ.) ordinaire (= συνήθης), ordre (= τάξη)." },
    { la:"imminent [< im-mineo]", el:"μένος, μανία // (αγγλ.) eminent (= διαπρεπής), prominent (= εξέχων) // (γαλλ.) éminent (= διαπρεπής)." },
    { la:"videant, vident, videat [< video]", el:"(Ϝιδεῖν) ιδέα, βίντεο (< αγγλ.) // (αγγλ.) vision (= όραση, όραμα), evident (= προφανής) // (γαλλ.) voir (= βλέπω)." },
    { la:"dis-simulent [< dis-simulo]", el:"(αγγλ.) similar (= όμοιος), simulate (= προσομοιώνω), simultaneous (= ταυτόχρονος) // (γαλλ.) similarité (= ομοιότητα), dissimuler (= αποκρύπτω, προσποιούμαι)." },
    { la:"spem [< spes]", el:"(γαλλ.) espoir (= ελπίδα), espérer (= ελπίζω) // Σπεράντζα // (αγγλ.) despair (= απελπισία, απελπίζομαι), desperate (= απελπισμένος) // (ισπαν.) esperanza (= ελπίδα)." },
    { la:"Catilīnae", el:"Κατιλίνας." },
    { la:"mollibus [< mollis]", el:"(γαλλ.) ra-mollir (= μαλακώνω) // (αγγλ.) mollify (= κατευνάζω, μαλακώνω), emollient (= μαλακτικό), mollusc (= μαλάκιο)." },
    { la:"sententiis [< sentio]", el:"(αγγλ.) sentence (= απόφαση), sense (= αίσθηση), sentiment (= συναίσθημα), consent (= συναινώ) // (γαλλ.) sentir (= αισθάνομαι)." },
    { la:"aluērunt [< alo]", el:"ἀλ-δαίνω (= ενδυναμώνω, αυξάνω) // (γαλλ.) alourdir (= βαραίνω) // (αγγλ.) adult (= ενήλικος), adolescent (= έφηβος), aliment (= τροφή), alumnus (= απόφοιτος)." },
    { la:"con-iurationem [< coniuro < cum + ius]", el:"(γαλλ.) justice (= δικαιοσύνη), juste (= δίκαιος), jurer (= ορκίζομαι) // (αγγλ.) conjure (= επικαλούμαι, μαγεύω), jury (= ένορκοι), injury (= βλάβη, αδικία)." },
    { la:"nascentem [< nascor]", el:"γί-γνο-μαι, γνήσιος // (γαλλ.) nature (= φύση), naturel· νατουραλισμός, naissance (= γέννηση) // (αγγλ.) native (= ιθαγενής, έμφυτος), nation (= έθνος), nascent (= εκκολαπτόμενος)." },
    { la:"credendo [< credo]", el:"(αγγλ.) credible (= πιστευτός), αντιθ. incredible, credit (= πίστωση, εμπιστοσύνη) // (γαλλ.) croire (= πιστεύω)." },
    { la:"con-firmavērunt [< confirmo]", el:"(γαλλ.) confirmer (= επιβεβαιώνω) // φίρμα (< ιταλ.)." },
    { la:"auctoritātem [< augeo]", el:"αυξάνω - αύξω // (αγγλ.) authoritative (= έγκυρος, έγκριτος), augment (= επαυξάνω), auction (= δημοπρασία)." },
    { la:"secūti [< sequor]", el:"ἕπομαι // (αγγλ.) sequent (= ακόλουθος), sequence (= ακολουθία, σειρά), consequence (= συνέπεια) // (γαλλ.) seconde (= δευτερόλεπτο)· σεκόντο (< ιταλ.)." },
    { la:"multi", el:"μάλα (= πολύ) // (αγγλ.) multitude (= πλήθος) // (ιταλ.) molto (= πολύ) // (ισπαν.) mucho (= πολύ)." },
    { la:"solum", el:"σόλο (< ιταλ.), σολίστ(ας) // (γαλλ.) solitude (= μοναξιά), seul (= μόνος) // (αγγλ.) sole (= μοναδικός), solitary (= μοναχικός)." },
    { la:"im-probi, im-probum", el:"(αγγλ.) probity (= χρηστότητα, ακεραιότητα), prove (= αποδεικνύω), probable (= πιθανός)." },
    { la:"im-perīti", el:"πείρα, πειρατής· άπειρος, απειρία // εξπέρ [< γαλλ. expert (= ειδικός)] // (αγγλ.) experience (= εμπειρία), experiment (= πείραμα)." },
    { la:"anim-ad-vertissem", el:"(verso) βέρσο (= πίσω μέρος σελίδας), ρεβέρ (< γαλλ.), v.s. (= εναντίον) // ανιμισμός (< γαλλ.), άνεμος // (αγγλ.) advertise (= διαφημίζω), convert (= μετατρέπω), animal (= ζώο)." },
    { la:"crudeliter [< crudelis < crudus < cruor]", el:"κρέας // (αγγλ.) cruel (= σκληρός, ωμός), crude (= ωμός, ακατέργαστος)." },
    { la:"regie", el:"ρήγας // (αγγλ.) royal (= βασιλικός) // (γαλλ.) roi (= βασιλιάς) // (ιταλ.) re (= βασιλιάς)." },
    { la:"factum, factam [< facio]", el:"(αγγλ.) facts (= γεγονότα), factory (= εργοστάσιο) // (γαλλ.) faire (= κάνω) // (ιταλ.) fare (= κάνω) // (ισπαν.) hacer (= κάνω)." },
    { la:"dicerent, dicit [< dico]", el:"δείκ-νυμι (= δείχνω) // (γαλλ.) dictionnaire (= λεξικό), dictée (= υπαγόρευση) // (αγγλ.) dictate (= υπαγορεύω) // (ιταλ.) dire (= λέω) // (ισπαν.) decir (= λέω)." },
    { la:"nunc", el:"νῦν." },
    { la:"intellego", el:"(γαλλ.) intelligent (= ευφυής) // (αγγλ.) intellect (= νους, διάνοια)." },
    { la:"Manliāna", el:"Μάνλιος." },
    { la:"castra", el:"κάστρο // (αγγλ.) castle (= κάστρο, φρούριο), -chester / Chester (= κατάληξη τοπωνυμίων, π.χ. Manchester) // (γαλλ.) château (= πύργος, κάστρο)." },
    { la:"per-vēnerit [< per + venio]", el:"βαίνω // (γαλλ.) parvenir (= φθάνω), avenue (= λεωφόρος) // (αγγλ.) prevent (= εμποδίζω, προλαμβάνω), event (= γεγονός)." },
    { la:"in-tendit [< in + tendo]", el:"τείνω, τένων (= τένοντας) // (γαλλ.) étendre (= τείνω), tendu (= τεντωμένος) // (αγγλ.) intention (= πρόθεση, σκοπός), tension (= ένταση, τάση)." },
    { la:"neminem [< nemo < ne + homo]", el:"ουμανισμός (< γαλλ.) // (αγγλ.) human (= ανθρώπινος) // (γαλλ.) homme (= άνθρωπος)." },
    { la:"stultum", el:"(αγγλ.) stultify (= μωραίνω)." },
    { la:"fateātur [< fateor]", el:"φημί, φάσκω, φατός, φάτις // (αγγλ.) confess (= ομολογώ, εξομολογούμαι), profession (= επάγγελμα)." }
  ]
};
