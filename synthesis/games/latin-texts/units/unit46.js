...
export const UNIT = {
  ...
  etymology: [
    { la:"philosophi", el:"φιλόσοφος, φιλοσοφία" },
    { la:"mundum, mundi", el:"μουντιάλ (ισπαν.) // (γαλλ.) monde (= κόσμος)" },
    { la:"censent [< censeo]", el:"(γαλλ.) censeur (= λογοκριτής) // (αγγλ.) censure (= επίκριση)" },
    { la:"regi [< rego]", el:"ρήγας" },
    { la:"numine", el:"νεύω, νεύμα" },
    { la:"deorum", el:"Ζεύς, (γενική) Διός" },
    { la:"esse, est, sit", el:"εἰμί, ἐστί" },
    { la:"putant", el:"(αγγλ.) dis-putation (= συζήτηση, λογομαχία), putative (= υποτιθέμενος)" },
    { la:"commūnem, commūnis", el:"(γαλλ.) commune // κομμουνισμός (< γαλλ. communisme)" },
    { la:"urbem", el:"(γαλλ.) urbain (= αστικός)" },
    { la:"civitatem", el:"κοίτη // (αγγλ.) city (= πόλη) // (γαλλ.) civilisation (= πολιτισμός)" },
    { la:"hominum", el:"ουμανισμός (< γαλλ.)" },
    { la:"unum, unius", el:"ένας // (γαλλ.) un (= ένας), unique (= μοναδικός), unité (= ενότητα)" },
    { la:"partem", el:"πάρτη, παρτίδα // (γαλλ.) partie" },
    { la:"ante-ponamus, ante-ponunt [< ante + pono]", el:"(γαλλ.) positionner (= τοποθετώ), position (= θέση)" },
    { la:"leges, legibus", el:"λέγω" },
    { la:"salutem, saluti, salutis", el:"(γαλλ.) salutation (= χαιρετισμός)" },
    { la:"singulorum", el:"(αγγλ.) single (= μοναδικός) // (γαλλ.) singularité (= μοναδικότητα)" },
    { la:"vir", el:"βιρτουόζος (< ιταλ. virtuoso)" },
    { la:"bonus", el:"μποναμάς [< ιταλ. bona mano (= καλό χέρι)], μπουνάτσα (< βενετ.), μπόνους" },
    { la:"sapiens", el:"(ισπαν.) sabio (= σοφός) // (γαλλ.) savoir (= γνωρίζω)" },
    { la:"consulit", el:"(γαλλ.) consulter (= συμβουλεύομαι) // (αγγλ.) consultant (= σύμβουλος)" },
    { la:"vituperandus", el:"(αγγλ.) vituperation (= ύβρις, ψόγος)" },
    { la:"proditor [< pro-do]", el:"προδίδωμι, προδότης, προδοσία" },
    { la:"patriae, patriam", el:"πατρίς, πατήρ" },
    { la:"desertor [< desero]", el:"(γαλλ.) déserter (= εγκαταλείπω) // (αγγλ.) desert (= έρημος)" },
    { la:"natura", el:"γίγνομαι, γνήσιος // (αγγλ.) nature (= φύση), natural (= φυσικός) // νατουραλισμός (< γαλλ.)" },
    { la:"con-sequitur [< cum + sequor]", el:"ἕπομαι // (αγγλ.) sequent (= ακόλουθος) // (γαλλ.) seconde (= δευτερόλεπτο) // σεκόντο (< ιταλ.)" },
    { la:"utilitatem, utilitāti, utilitātis", el:"(αγγλ.) utility (= χρησιμότητα), use (= χρήση) // (γαλλ.) utile (= χρήσιμος)" },
    { la:"fit", el:"φύω, φύσις" },
    { la:"laudandus [< laudo]", el:"(γαλλ.) laudatif (= κολακευτικός) // (αγγλ.) laudable (= αξιέπαινος)" },
    { la:"re", el:"ρεαλισμός (< γαλλ.) // (αγγλ.) real (= πραγματικός)" },
    { la:"publica", el:"(γαλλ.) publique (= δημόσιος)" },
    { la:"re publica", el:"ρεπουμπλικανός, ρεπουμπλικανισμός // ρεπούμπλικα (< ιταλ.)" },
    { la:"cadat [< cado]", el:"κάζο (< ιταλ. caso = συμβάν)" },
    { la:"decet", el:"(γαλλ.) décent (= αξιοπρεπής)" },
    { la:"cariorem [< carus]", el:"(γαλλ.) caritatif (= φιλανθρωπικός)" }
  ]
};
