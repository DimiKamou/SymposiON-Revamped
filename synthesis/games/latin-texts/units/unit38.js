export const UNIT = {
  ...
  etymology: [
    ...
    { la:"uxor", el:"(γαλλ.) uxori-cide (= συζυγοκτονία) // (αγγλ.) uxorious (= αφοσιωμένος/δουλοπρεπής προς τη σύζυγο)." },
    { la:"audiretur [< audio]", el:"ἀΐω // (αγγλ.) audible (= ακουστός), audience (= ακροατήριο) // (γαλλ.) audition (= ακρόαση)." },
    { la:"puella, puellae, puellam [< puer]", el:"(γαλλ.) puéril (= παιδικός) // (αγγλ.) puerile (= παιδαριώδης)." },
    { la:"Metelli [< Metellus]", el:"Μέτελλος." },
    { la:"more [< mos]", el:"αμοραλισμός (< γαλλ.) // (αγγλ.) moral (= ηθικό), morality (= ηθική), morose (= σκυθρωπός, κατσούφης)." },
    { la:"prisco [< prior]", el:"πρό, πρότερος, πριν // (γαλλ.) priorité (= προτεραιότητα)." },
    { la:"omen", el:"(αγγλ.) omen (= οιωνός), ominous (= δυσοίωνος, απειλητικός), abominable (= απαίσιος, βδελυρός)." },
    { la:"nuptiale [< nuptiae]", el:"νύμφη // (αγγλ.) nuptial (= γαμήλιος), nubile (= σε ηλικία γάμου), connubial (= συζυγικός, γαμήλιος) // (γαλλ.) nuptialité (= ο αριθμός των γάμων κατ' έτος)." },
    { la:"petit [< peto]", el:"πίπτω, πέτομαι // (αγγλ.) petition (= αίτηση, αναφορά), appetite (= όρεξη) // (γαλλ.) pétition (= αίτηση)." },
    { la:"sororis [< soror]", el:"(γαλλ.) sœur, cousin (= ξάδελφος) // (αγγλ.) sister, sorority (= αδελφότητα (γυναικών)), cousin (= ξάδελφος)." },
    { la:"fecit [< facio]", el:"(αγγλ.) facts (= γεγονότα), factory (= εργοστάσιο), manufacture (= κατασκευή) // (γαλλ.) faire (= κάνω)." },
    { la:"sacello [< sacrum < sacer]", el:"(αγγλ.) sacrifice (= θυσία), sacred (= ιερός), sacrament (= μυστήριο) // (γαλλ.) sanctifier (= αγιάζω), sacré (= ιερός)." },
    { la:"nocte [< nox]", el:"νύξ (γεν. νυκτός) // (ισπαν.) noche // (γαλλ.) nocturne (= νυχτερινός), nuit (= νύχτα) // (αγγλ.) nocturnal (= νυχτόβιος, νυχτερινός), equinox (= ισημερία) // (ιταλ.) notte (= νύχτα)." },
    { la:"per-sedebat [< per-sedeo], sede", el:"ἕζομαι, ἕδρα // (αγγλ.) pos-session (= κατοχή, κτήση), sedentary (= καθιστικός), sediment (= ίζημα), president (= πρόεδρος)." },
    { la:"expectabat [< expecto < ex + specto]", el:"(αγγλ.) expect (= αναμένω), pro-spect (= προοπτική), spectator (= θεατής), inspect (= επιθεωρώ) // (γαλλ.) expectative (= προσδοκία), spectacle (= θέαμα)." },
    { la:"vox", el:"(αγγλ.) vocal (= φωνητικός), voice (= φωνή), re-vocation (= ανάκληση), vowel (= φωνήεν), advocate (= συνήγορος) // (γαλλ.) vocabulaire (= λεξιλόγιο), voix (= φωνή) // (ιταλ.) voce (= φωνή)." },
    { la:"congruens [< congruo]", el:"(αγγλ.) congruent (= σύμφωνος), incongruous (= ασυνάρτητος, αταίριαστος), congruity (= συμφωνία, αντιστοιχία) // (γαλλ.) congruence (= αναλογία, αντιστοιχία)." },
    { la:"pro-posito [< pro-pono]", el:"(γαλλ.) positionner (= τοποθετώ), position (= θέση), proposition (= πρόταση) // (αγγλ.) proponent (= υποστηρικτής, εισηγητής), component (= συστατικό, εξάρτημα), opponent (= αντίπαλος), postpone (= αναβάλλω)." },
    { la:"-ulus, pullus (= μικρό ζώο)", el:"(κατάληξη) -πουλος // (αγγλ.) poultry / pullet (= πουλερικά / νεαρή όρνιθα) // (γαλλ.) poule / poulet (= κότα / κοτόπουλο) // (ιταλ.) pollo (= κοτόπουλο) // (ισπαν.) pollo (= κοτόπουλο)." },
    { la:"longa [< longus]", el:"δολιχός // (αγγλ.) long, longitude (= γεωγραφικό μήκος), prolong (= παρατείνω), elongate (= επιμηκύνω) // (γαλλ.) longue, longueur (= μήκος) // (ιταλ.) lungo (= μακρύς)." },
    { la:"mora", el:"μέριμνα, μάρτυς // μορατόριουμ [< moratorius (= αυτός που καθυστερεί)] // (αγγλ.) demur (= εγείρω αντίρρηση, διστάζω) // (γαλλ.) demeurer (= κατοικώ, παραμένω)." },
    { la:"standi [< sto]", el:"ἵστημι, στάσις // (γαλλ.) station (= στάση, σταθμός) // (αγγλ.) status (= κατάσταση, υπόσταση), stable (= σταθερός), constant (= σταθερός, συνεχής) // (ιταλ.) stare (= στέκομαι, βρίσκομαι) // (ισπαν.) estar (= είμαι, βρίσκομαι)." },
    { la:"fessa [< fatiscor]", el:"(γαλλ.) fatigué (= κουρασμένος) // (αγγλ.) indefatigable (= ακούραστος) // (ιταλ.) fatica (= κόπος, κούραση) // (ισπαν.) fatiga (= κόπωση)." },
    { la:"rogavit [< rogo]", el:"(γαλλ.) inter-rogatif (= ερωτηματικός) // (αγγλ.) interrogate (= ανακρίνω), prerogative (= προνόμιο), arrogant (= αλαζόνας), surrogate (= υποκατάστατο)." },
    { la:"materteram, matri-monium [< mater]", el:"μήτηρ // (γαλλ.) maternel (= μητρικός), matrimonial (= συζυγικός, γαμήλιος), mère (= μητέρα) // (αγγλ.) matrimony (= γάμος), maternity (= μητρότητα), matron (= σεβάσμια κυρία, προϊσταμένη) // (ιταλ.) madre (= μητέρα)." },
    { la:"paulisper [< paulus], paulo", el:"παῦρος (= μικρός, λίγος)." },
    { la:"loco [< locus]", el:"(γαλλ.) locale (= τοπικός), lieu (= τόπος) // (αγγλ.) location (= τοποθεσία), locomotive (= ατμάμαξα), allocate (= κατανέμω) // (ισπαν.) lugar (= τόπος)." },
    { la:"cederet [< cedo]", el:"(γαλλ.) céder (= παραχωρώ), re-cession (= ύφεση, επιβράδυνση) // (αγγλ.) concede (= παραχωρώ), proceed (= προχωρώ), access (= πρόσβαση), ancestor (= πρόγονος)." },
    { la:"dixit, dictum [< dico]", el:"δείκνυμι (= δείχνω) // (γαλλ.) dictionnaire (= λεξικό), dictée (= ορθογραφία, υπαγόρευση) // (αγγλ.) dictate (= υπαγορεύω), predict (= προβλέπω), verdict (= ετυμηγορία), contradict (= αντιφάσκω)." },
    { la:"ego", el:"ἐγώ // (αγγλ.) ego (= το εγώ), egoism (= εγωισμός)." },
    { la:"libenter", el:"(γερμ.) Liebe (= αγάπη) // (αγγλ.) libido (= γενετήσια ορμή)." },
    { la:"res", el:"ρεαλισμός (< γαλλ.) // (αγγλ.) real (= πραγματικός), republic (= δημοκρατία), rebus (= εικονόγριφος) // (γαλλ.) rien (= τίποτα)." },
    { la:"con-firmavit [< con-firmo]", el:"(γαλλ.) confirmer (= επιβεβαιώνω), fermer (= κλείνω) // φίρμα (< ιταλ.) // (αγγλ.) affirm (= βεβαιώνω), firmament (= στερέωμα)." },
    { la:"mortua [< morior]", el:"βροτός // (γαλλ.) mort (= νεκρός) // (αγγλ.) mortal (= θνητός), immortal (= αθάνατος), mortality (= θνησιμότητα) // (ισπαν.) morir (= πεθαίνω)." },
    { la:"vivit [< vivo]", el:"βίος // βιταλισμός (< γαλλ. vitalisme), βιταμίνη (< γαλλ. vitamine) // (αγγλ.) survive (= επιβιώνω), vivid (= ζωηρός) // (γαλλ.) vivre (= ζω)." },
    { la:"multum", el:"μάλα (= πολύ) // (αγγλ.) multitude (= πλήθος), multiple (= πολλαπλός) // (ιταλ.) molto (= πολύ) // (ισπαν.) mucho (= πολύ)." },
    { la:"amavit [< amo]", el:"(γαλλ.) amour (= αγάπη), ami (= φίλος), amical (= φιλικός) // (αγγλ.) amateur (= ερασιτέχνης), amiable (= αξιαγάπητος), enemy (= εχθρός) // (ισπαν.) amigo (= φίλος)." },
    { la:"duxit [< duco]", el:"(γαλλ.) conducteur (= οδηγός) // ductor, ad-ductor // (αγγλ.) duke (= δούκας), produce (= παράγω), reduce (= μειώνω) // (ιταλ.) duce (= ηγέτης)." }
  ]
};
