...
export const UNIT = {
  ...
  etymology: [
    { la:"unum", el:"ένας // (γαλλ.) un (= ένας), unique (= μοναδικός), unité (= ενότητα)" },
    { la:"Homēro", el:"Όμηρος, Ομηρικός" },
    { la:"servum", el:"σερβίρω, σερβιτόρος, σερβίτσιο (< ιταλ.) // σέρβις (< αγγλ.), σερβίς (< γαλλ.)" },
    { la:"tres", el:"τρεῖς, τρία· τρίτος" },
    { la:"Platōni", el:"Πλάτωνας" },
    { la:"nullum", el:"νούλα [< ιταλ. nulla (= μηδενικό, χωρίς αξία)]" },
    { la:"Zenōni", el:"Ζήνωνας" },
    { la:"tra-dunt [< tra-do], dotem [< do]", el:"δί-δω-μι· δώρημα, δώρο // (γαλλ.) tradition (= παράδοση), donner (= δίνω)" },
    { la:"nemo [< ne + homo]", el:"ουμανισμός (< γαλλ.)" },
    { la:"miserētur", el:"μιζέρια, μίζερος (< ιταλ.)" },
    { la:"in-feliciter, felīces", el:"(γαλλ.) félicité (= ευτυχία)" },
    { la:"vixerint [< vivo]", el:"βίος // βιταλισμός (< γαλλ. vitalisme), βιταμίνη (< γαλλ.)" },
    { la:"Menēnius", el:"Μενήνιος" },
    { la:"Agrippa", el:"Αγρίππας" },
    { la:"patres, pater", el:"πατήρ // (γαλλ.) paternel (= πατρικός)" },
    { la:"plēbem", el:"πίμπλημι / πληθύς· πλέμπα, πληβείος" },
    { la:"publicae, publice", el:"(γαλλ.) publique (= δημόσιος) // ρε-πουμπλικανός" },
    { la:"gratiae", el:"(αγγλ.) grateful (= ευγνώμων) // (γαλλ.) con-gratuler (= συγχαίρω)" },
    { la:"sequester [< sequor]", el:"ἕπομαι // (αγγλ.) sequent (= ακόλουθος) // (γαλλ.) seconde (= δευτερόλεπτο) // σεκόντο (= δεύτερη φωνή) (< ιταλ.)" },
    { la:"funerātus [< funero < funus]", el:"(γαλλ.) funérailles (= κηδεία), (αγγλ.) funeral" },
    { la:"est, esse, ab-erat, erat", el:"εἰμί" },
    { la:"Atilius", el:"Ατίλιος" },
    { la:"Rēgulus", el:"Ρήγουλος" },
    { la:"Poenos", el:"Φοῖνιξ· Φοίνικες" },
    { la:"Africā", el:"Αφρική, Αφρικανός" },
    { la:"funderet", el:"χύνω· (αγγλ.) con-fused (= μπερδεμένος, συγκεχυμένος) // κομφούζιο (< αγγλ. con-fusion)" },
    { la:"senātum, senatui", el:"(αγγλ.) senator (= γερουσιαστής), senior (= ηλικιωμένος)" },
    { la:"scripsit [< scribo]", el:"σκάριφος (= όργανο γραφής), σκαρίφημα // (αγγλ.) script (= σενάριο ταινίας)" },
    { la:"mercenārium", el:"(αγγλ.) merchant (= έμπορος), (γαλλ.) marchand" },
    { la:"dis-cessisse [< dis-cedo]", el:"(γαλλ.) récession (= ύφεση, επιβράδυνση)" },
    { la:"desertum [< desero]", el:"(γαλλ.) déserter (= εγκαταλείπω) // (αγγλ.) desert (= έρημος)" },
    { la:"rus", el:"ρουστίκ [< (γαλλ.) rustique (= χωριάτικος)] // (γαλλ.) rustre (= αγροίκος, άξεστος)" },
    { la:"curāri", el:"κούρα (< ιταλ.) (= φροντίδα)" },
    { la:"placuit", el:"(αγγλ.) placebo (= εικονικό φάρμακο)" },
    { la:"Scipiōnis, Scipiōni", el:"Σκιπίωνας" },
    { la:"accepērunt [< accipio]", el:"(γαλλ.) accepter (= δέχομαι) // (ιταλ.) capire (= καταλαβαίνω)" },
    { la:"re-liquerat", el:"λείπω, λοιπός // (γαλλ.) relique (= λείψανο, κειμήλιο)" },
    { la:"aequum", el:"(αγγλ.) equal (= ίσος)" },
    { la:"me-hercule", el:"Ηρακλής" },
    { la:"populum, populus", el:"πόπολο, ποπολάρος (< ιταλ.) // (γαλλ.) populaire (= δημοφιλής) // (αγγλ.) people (= λαός)" },
    { la:"Rōmānum, Rōmānus", el:"Ρώμη, Ρωμαίος, ρωμαϊκός, ρωμιός" },
    { la:"tribūtum [< tribus]", el:"(γαλλ.) con-tribution (= συνεισφορά), con-tribuable (= φορολογούμενος)" },
    { la:"con-ferre [< con-fero]", el:"φέρω· διαφορά, φορέας, φορείο // (αγγλ.) trans-fer (= μεταφορά)" },
    { la:"Carthagine", el:"Καρχηδόνα" },
    { la:"semper", el:"(ισπαν.) siempre (= πάντα)" },
    { la:"exigeret [< ex-ago]", el:"ἄγω" },
    { la:"viros [< vir]", el:"βιρτουόζος (< ιταλ. virtuoso)" },
    { la:"puellārum (puer)", el:"puerulus → pullus (= μικρό ζώο) → (κατάληξη) -πουλο(ς)" },
    { la:"loco", el:"(γαλλ.) locale (= τοπικός) // (αγγλ.) location (= τοποθεσία)" },
