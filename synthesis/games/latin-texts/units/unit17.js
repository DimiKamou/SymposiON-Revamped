export const UNIT = {
  ...
  etymology: [
    { la:"magnus", el:"μέγας // (αγγλ.) magnify (= μεγεθύνω), magnificent (= μεγαλοπρεπής), magnate (= μεγιστάνας)." },
    { la:"timor", el:"(αγγλ.) timorous (= δειλός, φοβισμένος), timid (= δειλός), intimidate (= εκφοβίζω) // (ιταλ.) timore (= φόβος) // (ισπαν.) temor (= φόβος)." },
    { la:"exercitum", el:"(ισπαν.) ejército (= στρατός) // (γαλλ.) exercice (= άσκηση) // (αγγλ.) exercise (= άσκηση) // (ιταλ.) esercito (= στρατός)." },
    { la:"occupāvit", el:"(ιταλ.) capire (= καταλαβαίνω) // (αγγλ.) occupy (= καταλαμβάνω), occupation (= κατοχή) // (γαλλ.) occuper (= καταλαμβάνω)." },
    { la:"vocibus", el:"(αγγλ.) revocation (= ανάκληση), vocal (= φωνητικός), voice (= φωνή) // (γαλλ.) vocabulaire (= λεξιλόγιο), voix (= φωνή)." },
    { la:"Gallōrum", el:"Γάλλος, Γαλλία." },
    { la:"mercatōrum", el:"(αγγλ.) merchant, (γαλλ.) marchand, market (= αγορά) // (ιταλ.) mercante (= έμπορος) // (ισπαν.) mercader (= έμπορος)." },
    { la:"Germānos", el:"Γερμανός, Γερμανία // (αγγλ.) German (= Γερμανός, γερμανικός)." },
    { la:"magnitudine", el:"μέγας // (αγγλ.) magnitude (= μέγεθος, σημασία), magnify (= μεγεθύνω, εξυμνώ), magnificent (= μεγαλοπρεπής), magnate (= μεγιστάνας, ισχυρός παράγοντας) // (γαλλ.) magnifique (= θαυμάσιος)." },
    { la:"corporum", el:"κόρπους (= σώμα κειμένων) // (αγγλ.) corporal (= σωματικός), corporation (= εταιρεία, νομικό σώμα), corpse (= πτώμα, νεκρό σώμα) // (γαλλ.) corps (= σώμα (π.χ. στρατιωτικό))." },
    { la:"in-credibili", el:"(αγγλ.) incredible, credit (= πίστωση, εμπιστοσύνη), creed (= δόγμα, θρησκευτικό σύμβολο πίστεως)." },
    { la:"virtūte (vir)", el:"βιρτουόζος (< ιταλ. virtuoso) // (αγγλ.) virile (= ανδρικός, αρρενωπός), virtue (= αρετή), virtual (= εικονικός, δυνητικός) // (γαλλ.) vertu (= αρετή)." },
    { la:"esse (es-)", el:"είμι // (αγγλ.) essence (= ουσία), essential (= ουσιώδης, απαραίτητος)." },
    { la:"prae-dicābant", el:"δείκ-νυμι (= δείχνω) // (γαλλ.) dictionnaire (= λεξικό), dictée (= ορθογραφία, υπαγόρευση), prêcher (= κηρύττω) // (αγγλ.) preach (= κηρύττω), predicate (= κατηγορούμενο· κατηγορώ (λογ./γραμμ.))." },
    { la:"alius, aliā", el:"ἄλλος, ἄλλη, ἄλλο // (αγγλ.) alias (= ψευδώνυμο· άλλως), alibi (= άλλοθι), alien (= ξένος, αλλοδαπός)." },
    { la:"causā", el:"(αγγλ.) cause, accuse (= κατηγορώ), excuse (= δικαιολογώ· δικαιολογία) // (γαλλ.) chose (= πράγμα) // (ιταλ.) cosa (= πράγμα) // (ισπαν.) cosa (= πράγμα)." },
    { la:"cupiēbat", el:"(γαλλ.) cupidité (= απληστία) // (αγγλ.) covet (= εποφθαλμιώ, ποθώ)." },
    { la:"nonnulli", el:"νούλα [< ιταλ. nulla (= μηδενικό, χωρίς αξία)] // (αγγλ.) annul (= ακυρώνω), nullify (= εκμηδενίζω, ακυρώνω)." },
    { la:"adducti", el:"(αγγλ.) adductor (= προσαγωγός μυς), adduce (= επικαλούμαι, προσάγω ως επιχείρημα)." },
    { la:"remanēbant", el:"μένω, μόνος // (αγγλ.) remain (= παραμένω), permanent (= μόνιμος), mansion (= έπαυλη, μέγαρο) // (γαλλ.) maison (= σπίτι)." },
    { la:"fingere", el:"φιγούρα, φιγουράρω, φιγουρίνι (< ιταλ. figura, figurare, figurino) // (αγγλ.) fiction (= μυθοπλασία, πλάσμα), feign (= προσποιούμαι), effigy (= ομοίωμα)." },
    { la:"lacrimas", el:"δάκρυμα (= αιτία δακρύων, δάκρυ), δάκρυον // (αγγλ.) lachrymose (= δακρύβρεχτος, κλαψιάρικος), lacrimal (= δακρυϊκός) // (γαλλ.) larme (= δάκρυ)." },
    { la:"tenēre", el:"(γαλλ.) tenir (= κρατώ) // (αγγλ.) tenant (= ενοικιαστής), tenacious (= επίμονος, ανθεκτικός), tenure (= θητεία, κατοχή)." },
    { la:"poterant [(potis = δυνατός) + sum]", el:"πόσις, δεσ-πότης («κύριος σπιτιού») // (αγγλ.) potent (= ισχυρός), potential (= δυνητικός, δυναμικό), possible (= δυνατός, πιθανός) // (γαλλ.) pouvoir (= μπορώ / δύναμη)." },
    { la:"tabernaculis (< taberna)", el:"ταβέρνα // (αγγλ.) tavern (= ταβέρνα, πανδοχείο), tabernacle (= σκηνή, ιερή σκηνή) // (γαλλ.) taverne (= ταβέρνα)." },
    { la:"fatum", el:"φημί (= λέω, ισχυρίζομαι), φατός (= αυτός που μπορεί να ειπωθεί, ονομαστός) // fata morgana (είδος αντικατοπτρισμού) // (αγγλ.) fate (= μοίρα, πεπρωμένο), fatal (= μοιραίος, θανάσιμος), fairy (= νεράιδα, ξωτικό) // (γαλλ.) fée (= νεράιδα)." },
    { la:"familiaribus (familia)", el:"φαμίλια // (γαλλ.) famille (= οικογένεια) // (αγγλ.) family (= οικογένεια / οικογενειακός), familiar (= οικείος, γνώριμος) // (ιταλ.) famiglia (= οικογένεια) // (ισπαν.) familia (= οικογένεια)." },
    { la:"commūne", el:"(γαλλ.) commune // κομμουνισμός (< γαλλ. communisme) // (αγγλ.) common (= κοινός), community (= κοινότητα)." },
    { la:"periculum, perīti", el:"πείρα, πειρατής· απειρία // (αγγλ.) peril (= κίνδυνος) // (γαλλ.) péril (= κίνδυνος) // (ιταλ.) pericolo (= κίνδυνος) // (ισπαν.) peligro (= κίνδυνος)." },
    { la:"miserabantur", el:"μιζέρια, μίζερος (< ιταλ.) // (αγγλ.) miserable (= άθλιος, ελεεινός), misery (= δυστυχία, αθλιότητα) // (γαλλ.) misère (= δυστυχία, ένδεια)." },
    { la:"totis", el:"(γαλλ.) totalité (= ολότητα), tout (= όλος, ολόκληρος) // (αγγλ.) total (= σύνολο, άθροισμα) // (ιταλ.) tutto (= όλος, ολόκληρος) // (ισπαν.) todo (= όλος, ολόκληρος)." },
    { la:"castris", el:"κάστρο // (αγγλ.) castle (= κάστρο, φρούριο), -chester / -caster (Manchester, Lancaster) (= κατάληξη αγγλικών τοπωνυμίων) // (γαλλ.) château (= πύργος, κάστρο)." },
    { la:"testamenta", el:"(αγγλ.) testament, testify (= καταθέτω, μαρτυρώ), testimony (= μαρτυρία, κατάθεση)." },
    { la:"ob-signabantur", el:"σινιάλο (< ιταλ.) // (αγγλ.) sign (= σήμα, σημάδι), signal (= σήμα, σινιάλο), seal (= σφραγίδα, βούλα (σε έγγραφο)), signature (= υπογραφή) // (γαλλ.) signe (= σήμα, σημάδι, δείγμα)." },
    { la:"timōre", el:"(αγγλ.) timorous (= δειλός, φοβισμένος), timid (= δειλός, φοβισμένος), intimidate (= εκφοβίζω, τρομοκρατώ)." },
    { la:"paulātim (paulus)", el:"παῦρος (= μικρός, λίγος)." },
    { la:"rei", el:"ρεαλισμός (< γαλλ.) // (αγγλ.) real (= πραγματικός), reality (= πραγματικότητα), rebus (= εικονογρίφος)." },
    { la:"militāris", el:"μιλιταρισμός (< γαλλ.) // (αγγλ.) military (= στρατιωτικός), militia (= πολιτοφυλακή, εθνοφρουρά)." },
    { la:"habebantur", el:"(γερμ.) haben, (αγγλ.) have // (αγγλ.) habit (= συνήθεια), prohibit (= απαγορεύω), exhibit (= εκθέτω, παρουσιάζω), able (= ικανός) // (γαλλ.) avoir (= έχω)." },
    { la:"per-turbabantur", el:"τύρβη (= ταραχή), τούρμπο, τουρμπίνα (< γαλλ.) // (αγγλ.) perturb (= αναστατώνω, ταράζω), disturb (= ενοχλώ, διαταράσσω), trouble (= ταραχή, μπελάς), turbulent (= ταραχώδης, θυελλώδης)." }
  ]
};
