...
export const UNIT = {
  ...
  etymology: [
    ...
    { la:"occupāta [< occupo < ob + capio]", el:"(ιταλ.) capire (= καταλαβαίνω) // (γαλλ.) occuper (= καταλαμβάνω)" },
    { la:"urbe, urbem", el:"(γαλλ.) urbain (= αστικός)" },
    { la:"senātum, senex", el:"(αγγλ.) senator (= γερουσιαστής), senior (= ηλικιωμένος)" },
    { la:"armātus", el:"άρμα, αρματολός // (γαλλ.) armée (= στρατός)" },
    { la:"coegerat [< cogo < cum + ago], agmina [< ago]", el:"ἄγω" },
    { la:"Gaius", el:"Γάιος" },
    { la:"Marius, Marium, Mario", el:"Μάριος" },
    { la:"celerrime [< celer]", el:"κέλης (= ταχύς ίππος), κέλλω // (γαλλ.) célérité (= ταχύτητα)" },
    { la:"hostis, hostem", el:"(αγγλ.) host (= ξενιστής) // (γαλλ.) hostilité (= εχθρότητα)" },
    { la:"iudicarētur, iudicābo [< iudico < ius dico]", el:"(γαλλ.) justice (= δικαιοσύνη) // (αγγλ.) justice // (γαλλ.) juste (= δίκαιος)" },
    { la:"voluntāti [< volo], noluit [< nolo]", el:"βούλομαι // (αγγλ.) volunteer (= εθελοντής)" },
    { la:"nemo [< ne + homo]", el:"ουμανισμός (< γαλλ.)" },
    { la:"obviam [< ob viam], ire", el:"εἶμι, οἶμος (= οδός)" },
    { la:"audēbat [< audeo]", el:"(γαλλ.) audacieux (= τολμηρός), audace (= θράσος)" },
    { la:"solus", el:"σόλο (< ιταλ.), σολίστας // (γαλλ.) solitude (= μοναξιά)" },
    { la:"Quintus", el:"Κόιντος" },
    { la:"Mucius", el:"Μούκιος" },
    { la:"Scaevola [< scaevus (= σκαιός)]", el:"Σκαιόλας" },
    { la:"augur", el:"(γαλλ.) augure (= οιωνός) // (αγγλ.) augury (= οιωνοσκοπία)" },
    { la:"re", el:"ρεαλισμός (< γαλλ.) // (αγγλ.) real (= πραγματικός)" },
    { la:"interrogātus [< inter-rogo]", el:"(γαλλ.) interrogation (= ερώτημα, ανάκριση)" },
    { la:"sententiam [< sentio]", el:"(αγγλ.) sentence (= απόφαση)" },
    { la:"dicere, dixit [< dico]", el:"δείκ-νυμι (= δείχνω) // (γαλλ.) dictionnaire (= λεξικό), dictée (= υπαγόρευση)" },
    { la:"minitans, minitēris [< minitor < minor]", el:"(γαλλ.) menacer (= απειλώ), (ισπαν.) conminar" },
    { la:"instāret [< insto < in + sto]", el:"ἵστημι, στάσις // (γαλλ.) station (= στάση), stable (= σταθερός)" },
    { la:"os-tendas", el:"τείνω, τένων // (γαλλ.) étendre (= τείνω), tendu (= τεντωμένος)" },
    { la:"militum", el:"μιλιταρισμός (< γαλλ.)" },
    { la:"circum-sedisti [< circum-sedeo]", el:"ἕζομαι, ἕδρα· (αγγλ.) possession (= κατοχή)" },
    { la:"mortem", el:"βροτός // (γαλλ.) mort (= νεκρός) // (αγγλ.) mortal (= θνητός)" },
    { la:"ego", el:"ἐγώ" },
    { la:"corpore", el:"κόρπους (= σώμα κειμένων)" },
    { la:"infirmo [< in + firmus]", el:"φίρμα (< ιταλ.) // (αγγλ.) infirm (= ασθενής) // (γαλλ.) confirmer (= επιβεβαιώνω)" },
    { la:"sum, esse", el:"εἰμί" },
