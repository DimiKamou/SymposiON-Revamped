export const UNIT = {
  ...
  etymology: [
    { la:"Cato", el:"Κάτων." },
    { la:"die, diem", el:"(Ζεύς, γενική Διός) Δίας (ως «θεός του φωτός»)." },
    { la:"ficum", el:"σῦκον, φίκος // (αγγλ.) fig (= σύκο)." },
    { la:"praecocem", el:"(γαλλ.) précoce." },
    { la:"Carthagine, Carthago", el:"Καρχηδόνα." },
    { la:"os-tendens", el:"τείνω // (γαλλ.) étendre (= τείνω), tendu (= τεντωμένος)." },
    { la:"patribus, patriam, patriae", el:"πατήρ, πατρίς // (γαλλ.) paternel (= πατρικός)." },
    { la:"interrogo", el:"(γαλλ.) interrogation (= ερώτημα, ανάκριση)." },
    { la:"de-cerptam", el:"καρπός." },
    { la:"esse, est", el:"εἰμί." },
    { la:"putetis", el:"(αγγλ.) dis-putation (= συζήτηση, λογομαχία), putative (= υποτιθέμενος)." },
    { la:"arbore", el:"άλμπουρο (< βενετ.) // (γαλλ.) arbre (= δέντρο)." },
    { la:"recentem", el:"(γαλλ.) récent (= πρόσφατος)." },
    { la:"dixissent", el:"δείκ-νυμι (= δείχνω) // (γαλλ.) dictionnaire (= λεξικό), dictée (= ορθογραφία, υπαγόρευση)." },
    { la:"tertium", el:"τρεῖς, τρία." },
    { la:"scitote", el:"(γαλλ.) science (= επιστήμη), con-scient (= ειδήμων)." },
    { la:"muris", el:"ἄ-μυνα· μουράγιο (< βενετ.) // (γαλλ.) mur (= τείχος)." },
    { la:"habemus", el:"(γερμ.) haben, (αγγλ.) have." },
    { la:"hostem", el:"(αγγλ.) host (= ξενιστής) // (γαλλ.) hostilité (= εχθρότητα)." },
    { la:"cavete", el:"(κοϜέω) κοέω (= παρατηρώ)." },
    { la:"periculum", el:"πείρα, πειρατής· απειρία." },
    { la:"tutamini", el:"(γαλλ.) tuteur (= παιδαγωγός)." },
    { la:"urbis", el:"(γαλλ.) urbain (= αστικός)." },
    { la:"nolite [< ne- + volo]", el:"βούλομαι // (αγγλ.) volunteer (= εθελοντής)." },
    { la:"confidere, fiduciam", el:"πειθώ // (γαλλ.) con-fiance (= εμπιστοσύνη) // (αγγλ.) con-fidence (= αυτοπεποίθηση)." },
    { la:"de-ponite", el:"(γαλλ.) positionner (= τοποθετώ) // position (= θέση)." },
    { la:"credideritis", el:"(αγγλ.) credible (= πιστευτός), αντιθ. incredible." },
    { la:"consulturum, consulueritis", el:"(γαλλ.) consulter (= συμβουλεύω) // (αγγλ.) consultant (= σύμβουλος)." },
    { la:"mementote", el:"μέμνημαι· μνήμη, μνημονικός // (αγγλ.) monument (= μνημείο)." },
    ...
    { la:"extremo", el:"εξτρεμισμός (< γαλλ.)." },
    { la:"dis-crimine", el:"κρίνω // (γαλλ.) crise (= κρίση) // (αγγλ.) crime (= έγκλημα)." },
    { la:"deleta", el:"(αγγλ.) delete (= διάγραψε)." }
  ]
};
