export const UNIT = {
  ...
  etymology: [
    ...
    { la:"servus, servi", el:"σερβίρω, σερβιτόρος, σερβίτσιο (< ιταλ.) // σέρβις (< αγγλ.), σερβίς (< γαλλ.) // (αγγλ.) serf (= δουλοπάροικος), servile (= δουλικός, δουλοπρεπής)." },
    { la:"notus (nosco)", el:"νέος· νότα (< λατ.) // (αγγλ.) new, notorious (= διαβόητος, παγκοίνως γνωστός)." },
    { la:"Roma, Romam", el:"Ρώμη, Ρωμαίος, ρωμαϊκός, ρωμιός // (αγγλ.) romance (= ρομάντζο, ιπποτικό αφήγημα) // (γαλλ.) roman (= μυθιστόρημα)." },
    { la:"Athenas, Athenis", el:"Ἀθῆναι, Αθήνα, Αθηναίος." },
    { la:"fugit, fugitivum, fugitivi", el:"φεύγω, φυγή // (αγγλ.) fugitive (= φυγάς), refuge (= καταφύγιο), centrifugal (= φυγόκεντρος) // (ιταλ.) fuga (= φυγή, φούγκα (μουσ.))." },
    { la:"Patronem", el:"Πάτρωνας // (αγγλ.) patron (= προστάτης, χορηγός) // (ιταλ.) padrone (= αφεντικό, κύριος)." },
    { la:"Epicureum", el:"Επικούρειος, Επίκουρος // (αγγλ.) epicure (= καλοφαγάς, φιλήδονος)." },
    { la:"paucos (paulus), parvus", el:"παῦρος (= μικρός, λίγος) // (αγγλ.) paucity (= σπανιότητα, ένδεια), parvovirus (= παρβοϊός) // (γαλλ.) peu (= λίγο) // (ιταλ.) poco (= λίγο)." },
    { la:"menses", el:"μήν· μήνας // (αγγλ.) month, (ισπαν.) mes, semester (= εξάμηνο), menstrual (= έμμηνος, εμμηνορροϊκός) // (γαλλ.) mois (= μήνας)." },
    { la:"libero", el:"(γαλλ.) libre (= ελεύθερος) // (αγγλ.) liberty (= ελευθερία), libero (= παίχτης με ελεύθερη θέση στο γήπεδο), liberate (= απελευθερώνω), liberal (= φιλελεύθερος)." },
    { la:"Asiam", el:"Ασία." },
    { la:"abiit, rediens", el:"εἶμι // ιταμός // (αγγλ.) exit (= έξοδος), transit (= διέλευση)." },
    { la:"Plato", el:"Πλάτων // (αγγλ.) platonic (= πλατωνικός) // (γαλλ.) platonique (= πλατωνικός)." },
    { la:"Sardianus", el:"Σαρδιανός, Σάρδεις." },
    { la:"esse, sit, est", el:"εἰμί // (αγγλ.) essence (= ουσία) // (γαλλ.) être (= είμαι / το ον) // (ιταλ.) essere (= είμαι)." },
    { la:"litteris", el:"(γαλλ.) lettre (= γράμμα), littérature (= λογοτεχνία) // (αγγλ.) literal (= κυριολεκτικός), obliterate (= εξαλείφω, σβήνω) // (ισπαν.) letra (= γράμμα)." },
    { la:"cognovisset", el:"γι-γνώσκω // (αγγλ.) recognize (= αναγνωρίζω) // (γαλλ.) connaître (= γνωρίζω) // (ιταλ.) conoscere (= γνωρίζω)." },
    { la:"hominem, homo", el:"ουμανισμός (< γαλλ.) // (αγγλ.) human (= ανθρώπινος) // (γαλλ.) homme (= άνθρωπος, άνδρας) // (ισπαν.) hombre (= άνδρας, άνθρωπος)." },
    { la:"comprehendit", el:"(αγγλ.) comprehend (= κατανοώ, περιλαμβάνω), comprehensive (= περιεκτικός, εκτενής) // (γαλλ.) comprendre (= καταλαβαίνω)." },
    { la:"custodiam", el:"κουστωδία // (αγγλ.) custody (= κράτηση, επιμέλεια/φύλαξη), custodian (= φύλακας, επιμελητής)." },
    { la:"Ephesi, Epheso", el:"Έφεσος." },
    { la:"tradidit", el:"δί-δω-μι (= παράδοση) // (γαλλ.) tradition, trahir (= προδίδω) // (αγγλ.) traitor (= προδότης), treason (= προδοσία)." },
    { la:"investiga", el:"(αγγλ.) vestige (= κατάλοιπο), investigate (= διερευνώ), vestigial (= υπολειμματικός) // (γαλλ.) investigation (= έρευνα, εξέταση)." },
    { la:"diligentia", el:"λέγω // (αγγλ.) diligent (= επιμελής) // (γαλλ.) diligence (= επιμέλεια)." },
    { la:"mitte", el:"(αγγλ.) mission (= αποστολή), missile (= βλήμα) // (γαλλ.) mettre (= βάζω, τοποθετώ) // (ιταλ.) mettere (= βάζω, τοποθετώ)." },
    { la:"de-duc", el:"(αγγλ.) ad-ductor (= προσαγωγός μυς), duke (= δούκας), produce (= παράγω) // (γαλλ.) con-ducteur (= οδηγός) // (ιταλ.) duce (= ηγέτης, αρχηγός)." },
    { la:"noli [< ne- + volo]", el:"βούλομαι // (αγγλ.) volunteer (= εθελοντής), voluntary (= εθελοντικός) // (γαλλ.) vouloir (= θέλω) // (ιταλ.) volere (= θέλω)." },
    { la:"spectare", el:"(αγγλ.) pro-spect (= προοπτική, άποψη), spectator (= θεατής), inspect (= επιθεωρώ) // σπέκουλα (= κερδοσκοπία), σπεκουλαδόρος, σπεκουλάρω (< ιταλ.)." },
    { la:"preti", el:"πιπράσκω // (γαλλ.) prix (= τιμή), (αγγλ.) price // (αγγλ.) precious (= πολύτιμος), appreciate (= εκτιμώ) // (ιταλ.) prezzo (= τιμή)." },
    { la:"scelus", el:"(γαλλ.) scélérat (= κάθαρμα / αχρείος) // (ιταλ.) scellerato (= κακούργος, αχρείος)." },
    { la:"audaciam", el:"(γαλλ.) audacieux (= τολμηρός), audace (= θράσος) // (αγγλ.) audacity (= τόλμη, θράσος), audacious (= τολμηρός)." },
    { la:"dolore", el:"(αγγλ.) dolor (= θλίψη, πόνος), indolent (= νωθρός (αρχ. ανώδυνος)) // (γαλλ.) douleur (= πόνος) // (ιταλ.) dolore (= πόνος)." },
    { la:"adfectus", el:"(αγγλ.) facts (= γεγονότα), factory (= εργοστάσιο), affection (= στοργή, συναίσθημα)." },
    { la:"gratius", el:"(αγγλ.) grateful (= ευγνώμων), gratitude (= ευγνωμοσύνη) // (γαλλ.) con-gratuler (= συγχαίρω) // (ιταλ.) grazie (= ευχαριστώ) // (ισπαν.) gracias (= ευχαριστώ)." },
    { la:"possit [potis (= δυνατός) + sum]", el:"πόσις, δεσ-πότης («κύριος σπιτιού») // (αγγλ.) potent (= ισχυρός), power (= δύναμη, εξουσία) // (γαλλ.) pouvoir (= δύναμη· μπορώ)." },
    { la:"recuperatio", el:"(ιταλ.) capire (= καταλαβαίνω) // (γαλλ.) récupération (= επανάκτηση) // (αγγλ.) recover (= ανακτώ, αναρρώνω), recuperate (= αναρρώνω, ανακτώ)." }
  ]
};
