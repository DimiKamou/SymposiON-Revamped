export const UNIT = {
  ...
  etymology: [
    { la:"iudices", el:"(γαλλ.) justice (= δικαιοσύνη) // (αγγλ.) justice // (γαλλ.) juste (= δίκαιος)." },
    { la:"Asia (Asiā, Asiam, Asiae)", el:"Ασία." },
    { la:"viro, virtūtis", el:"βιρτουόζος (< ιταλ. virtuoso)." },
    { la:"fortissimo", el:"(γαλλ.) fort (= σωματική δύναμη) // (ισπαν.) fortaleza (= φρούριο)." },
    { la:"patri, patre, patris", el:"πατήρ // (γαλλ.) paternel (= πατρικός)." },
    { la:"magno", el:"μέγας // (αγγλ.) magni-fic (= μεγαλοπρεπής)." },
    { la:"adiumentum (< ad-iuvo)", el:"(γαλλ.) adiuvant (= βοηθητικός, πρόσθετος)." },
    { la:"periculis", el:"πείρα, πειρατής· απειρία." },
    { la:"solacio", el:"(αγγλ.) solace (= παρηγοριά), (γαλλ.) con-solation." },
    { la:"laboribus", el:"λαμβάνω // (αγγλ.) labor (= μόχθος) // (γαλλ.) laboratoire (= εργαστήριο), laborieux (= κοπιώδης)." },
    { la:"gratulatiōni", el:"(αγγλ.) con-gratulations (= συγχαρητήρια), grateful (= ευγνώμων) // (γαλλ.) con-gratuler (= συγχαίρω)." },
    { la:"victoriā, victōriam", el:"(γαλλ.) victoire, (αγγλ.) victory." },
    { la:"habet, debēmus (de + habeo)", el:"(γερμ.) haben, (αγγλ.) have." },
    { la:"suspiciōnem", el:"(γαλλ.) suspicion (= υποψία) // (αγγλ.) suspect (= ύποπτος)." },
    { la:"luxuriae", el:"λούσο (< ιταλ.), λουξ (< γαλλ.) // luxury (= πολυτέλεια)." },
    { la:"Murēnam, Murēnae", el:"Μουρήνας." },
    { la:"laudāre, laus", el:"(γαλλ.) laudatif (= κολακευτικός) // (αγγλ.) laudable (= αξιέπαινος)." },
    { la:"vidit", el:"(Ϝιδεῖν) ιδέα, βίντεο (< αγγλ.)." },
    { la:"con-tinenter", el:"(γαλλ.) tenir (= κρατώ) // (αγγλ.) content (= περιεχόμενο)." },
    { la:"vixit", el:"βίος // βιταλισμός (< γαλλ. vitalisme), βιταμίνη (< γαλλ.)." },
    { la:"rem", el:"ρεαλισμός (< γαλλ.) // (αγγλ.) real (= πραγματικός)." },
    { la:"accusatōres (< accuso < ad + causa)", el:"(γαλλ.) cause (= αιτία), accusation (= κατηγορία)." },
    { la:"nomen, nomini", el:"όνομα // (γαλλ.) nom (= όνομα, ουσιαστικό), (αγγλ.) name." },
    { la:"obiecērunt", el:"ἵημι (= ρίχνω)." },
    { la:"familiae", el:"φαμίλια // (γαλλ.) famille (= οικογένεια) // (αγγλ.) family (= οικογένεια / οικογενειακός)." },
    { la:"memoria", el:"μέμνημαι· μνήμη, μνημονικός // (αγγλ.) monument (= μνημείο)." },
    { la:"generi", el:"γένος· γενιά." },
    { la:"honos", el:"ονόρε (< ιταλ.) // (αγγλ.) honor (= τιμή) // (γαλλ.) honorable (= αξιότιμος)." },
    { la:"gloria", el:"(αγγλ.) glory, (γαλλ.) gloire." },
    { la:"constitūta", el:"συν-ίστημι // (γαλλ.) con-stituer (= συγκροτώ, καθορίζω)." },
    { la:"est", el:"εἰμί." },
    { la:"dedecus", el:"(γαλλ.) decent (= αξιοπρεπής)." },
    { la:"sus-ceptum", el:"(γαλλ.) ac-cepter (= δέχομαι) // (ιταλ.) capire (= καταλαβαίνω)." },
    { la:"de-portātum", el:"ρα-πόρτο (= αναφορά) (< ιταλ.), πόρτο (= λιμάνι) (< ιταλ.)." },
    { la:"meruisse", el:"μείρ-ομαι, μέρ-ος." },
    { la:"sti-pendia, stipendiōrum", el:"(γαλλ.) dé-penser (= ξοδεύω)." },
    { la:"imperatōre", el:"ιμπεριαλισμός (< γαλλ.)." },
    { la:"libentissime", el:"(γερμ.) liebe (= αγάπη)." },
    { la:"pietātis", el:"(γαλλ.) piété (= ευσέβεια)." },
    { la:"finem", el:"φινάλε, φινίρισμα (< ιταλ.) // (γαλλ.) finaliste (= ο προκριθείς στον τελικό αγώνα διοργάνωσης)." },
    { la:"triumphum", el:"θρίαμβος." },
    { la:"felicitātis", el:"(γαλλ.) félicité (= ευτυχία)." }
  ]
};
