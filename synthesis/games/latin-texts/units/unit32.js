export const UNIT = {
  ...
  etymology: [
    { la:"pleni, plenae", el:"πίμπλημι / πληθύς· πλήθος, πλημμύρα, πλήρης, πλησμονή // (αγγλ.) plenty (= αφθονία) // (γαλλ.) plein (= γεμάτος) // (ιταλ.) pieno (= γεμάτος) // (ισπαν.) lleno (= γεμάτος)." },
    { la:"sunt (esse)", el:"εἰμί // (αγγλ.) essence (= ουσία) // (γαλλ.) être (= είμαι) // (ιταλ.) essere (= είμαι)." },
    { la:"libri", el:"λιμπρέτο (< ιταλ.) // (αγγλ.) library (= βιβλιοθήκη) // (γαλλ.) livre (= βιβλίο) // (ιταλ.) libro (= βιβλίο) // (ισπαν.) libro (= βιβλίο)." },
    { la:"sapientium", el:"(ισπαν.) sabio (= σοφός) // (αγγλ.) sapient (= σοφός) // (γαλλ.) savoir (= γνωρίζω) // (ιταλ.) sapere (= γνωρίζω)." },
    { la:"voces", el:"(αγγλ.) vocal (= φωνητικός), voice (= φωνή) // (γαλλ.) vocabulaire (= λεξιλόγιο), voix (= φωνή) // (ιταλ.) voce (= φωνή) // (ισπαν.) voz (= φωνή)." },
    { la:"exemplorum", el:"(γαλλ.) exemple (= παράδειγμα) // (αγγλ.) example (= παράδειγμα), sample (= δείγμα) // (ιταλ.) esempio (= παράδειγμα) // (ισπαν.) ejemplo (= παράδειγμα)." },
    { la:"vetustas (< vetus)", el:"veteranus → βετεράνος // (γαλλ.) vieux (= γέρος, παλιός) // (ιταλ.) vecchio (= γέρος, παλιός) // (ισπαν.) viejo (= γέρος, παλιός)." },
    { la:"iacerent, ob-icere", el:"ἵημι (= ρίχνω) // (αγγλ.) eject (= εκτινάσσω, αποβάλλω) // (γαλλ.) jeter (= ρίχνω) // (ιταλ.) gettare (= ρίχνω) // (ισπαν.) echar (= ρίχνω)." },
    { la:"tenebris", el:"(γαλλ.) ténèbres (= σκοτάδι) // (αγγλ.) tenebrous (= σκοτεινός) // (ισπαν.) tinieblas (= σκοτάδι)." },
    { la:"litterarum", el:"(γαλλ.) lettre (= γράμμα), littérature (= λογοτεχνία) // (αγγλ.) letter (= γράμμα), literal (= κυριολεκτικός) // (ιταλ.) lettera (= γράμμα) // (ισπαν.) letra (= γράμμα)." },
    { la:"lumen", el:"λευκός, λύχνος // (γαλλ.) lune (= φεγγάρι, σελήνη), lumière (= φως) // (αγγλ.) illuminate (= φωτίζω), luminous (= φωτεινός) // (ιταλ.) lume (= φως, λυχνάρι) // (ισπαν.) lumbre (= φωτιά, φως)." },
    { la:"accederet", el:"(γαλλ.) accéder à (= προσπελαύνω, φτάνω) // (αγγλ.) access (= πρόσβαση) // (ιταλ.) accesso (= πρόσβαση) // (ισπαν.) acceso (= πρόσβαση)." },
    { la:"multas", el:"μάλα (= πολύ) // (αγγλ.) multitude (= πλήθος), multiple (= πολλαπλός) // (ιταλ.) molto (= πολύ) // (ισπαν.) mucho (= πολύ)." },
    { la:"imagines", el:"(γαλλ.) image (= εικόνα) // (αγγλ.) imagine (= φαντάζομαι) // (ιταλ.) immagine (= εικόνα) // (ισπαν.) imagen (= εικόνα)." },
    { la:"fortissimorum", el:"(γαλλ.) fort (= σωματική δύναμη) // (ισπαν.) fortaleza (= φρούριο), fuerte (= δυνατός, ισχυρός) // (αγγλ.) force (= δύναμη) // (ιταλ.) forte (= δυνατός, ισχυρός)." },
    { la:"virorum", el:"βιρτουόζος (< ιταλ. virtuoso) // (αγγλ.) virile (= ανδρικός, αρρενωπός), virtue (= αρετή)." },
    { la:"solum", el:"σόλο (< ιταλ.), σολίστ(ας) // (αγγλ.) sole (= μοναδικός), solitude (= μοναξιά) // (γαλλ.) seul (= μόνος)." },
    { la:"intuendum (in + tueor)", el:"tutor → (γαλλ.) tuteur (= παιδαγωγός) // (αγγλ.) intuition (= διαίσθηση), tuition (= διδασκαλία, δίδακτρα)." },
    { la:"imitandum", el:"(γαλλ.) imiter (= μιμούμαι) // ιμιτασιόν (< imitation, γαλλ.) // (αγγλ.) imitate (= μιμούμαι) // (ιταλ.) imitare (= μιμούμαι)." },
    { la:"scriptores", el:"σκάριφος (= όργανο γραφής), σκαρίφημα // (αγγλ.) script (= σενάριο κινηματογραφικής ταινίας), scribe (= γραφέας) // (γαλλ.) écrire (= γράφω) // (γερμ.) schreiben (= γράφω)." },
    { la:"Graeci", el:"Γραικός // (αγγλ.) Greek (= Έλληνας, ελληνικός) // (γαλλ.) grec (= Έλληνας, ελληνικός) // (γερμ.) Grieche (= Έλληνας)." },
    { la:"Latini", el:"Λάτιο, Λατίνοι, Λατινικός // (αγγλ.) Latin (= λατινικός, Λατίνος) // (γαλλ.) latin (= λατινικός) // (ιταλ.) latino (= λατινικός)." },
    { la:"re-liquerunt", el:"λείπω, λοιπός // (αγγλ.) relinquish (= εγκαταλείπω, παραιτούμαι), relic (= λείψανο, κατάλοιπο) // (γαλλ.) relique (= λείψανο)." },
    { la:"cupidus", el:"(γαλλ.) cupide (= άπληστος), cupidité (= απληστία) // (αγγλ.) cupidity (= απληστία), covet (= εποφθαλμιώ, επιθυμώ σφοδρά)." },
    { la:"bene", el:"μπονα-μάς [< ιταλ. bona mano (= καλό χέρι)], μπουνάτσα (< βενετ.) (= καλοκαιρία), μπόνους // (αγγλ.) benefit (= όφελος), benevolent (= καλοπροαίρετος) // (γαλλ.) bien (= καλά)." },
    { la:"ad-ministrandi", el:"(γαλλ.) ministre (= υπουργός) // (αγγλ.) ad-ministration (= διαχείριση), minister (= υπουργός, λειτουργός), administer (= διαχειρίζομαι, χορηγώ) // (ιταλ.) ministro (= υπουργός)." },
    { la:"rem", el:"ρεαλισμός (< γαλλ.) // (αγγλ.) real (= πραγματικός) // (γαλλ.) rien (= τίποτα)." },
    { la:"publicam", el:"(γαλλ.) publique (= δημόσιος) // (αγγλ.) public (= δημόσιος)." },
    { la:"rem publicam", el:"ρεπουμπλικανός, ρεπουμπλικανισμός // ρεπούμπλικα (= είδος ανδρικού καπέλου) (< ιταλ.) // (αγγλ.) republic (= δημοκρατία, πολιτεία) // (γαλλ.) république (= δημοκρατία)." },
    { la:"semper", el:"(ισπαν.) siempre (= πάντα) // (ιταλ.) sempre (= πάντα)." },
    { la:"proponebam", el:"(γαλλ.) positioner (= τοποθετώ) // position (= θέση) // (αγγλ.) proponent (= υποστηρικτής, εισηγητής), proposition (= πρόταση)." },
    { la:"colendo", el:"κουλτούρα (< ιταλ.) // (αγγλ.) cult (= λατρεία), colony (= αποικία)." },
    { la:"cogitando", el:"(γαλλ.) cogiter (= αναλογίζομαι, σκέφτομαι έντονα) // (αγγλ.) cogitation (= στοχασμός, σκέψη) // (ισπαν.) cuidar (= φροντίζω)." },
    { la:"homines", el:"ουμανισμός (< γαλλ.) // (αγγλ.) human (= ανθρώπινος) // (γαλλ.) homme (= άνθρωπος, άνδρας)." },
    { la:"ex-celentes (< ex + cello < celsus)", el:"κολωνός // (αγγλ.) excellent (= εξαίρετος) // (γαλλ.) exceller (= υπερέχω, διακρίνομαι)." },
    { la:"animi", el:"ανιμισμός (< γαλλ.) / άνεμος // (αγγλ.) animosity (= εχθρότητα, μνησικακία), unanimous (= ομόφωνος)." },
    { la:"mentem", el:"μιμνήσκω, μνήμη, μέντωρ // (γαλλ.) mental (= διανοητικός) // (αγγλ.) dementia (= άνοια) // (ισπαν.) mente (= νους, μυαλό)." },
    { la:"conformabam", el:"φόρμα, φόρμουλα (< ιταλ.) // (αγγλ.) conform (= συμμορφώνομαι) // (γαλλ.) conformer (= προσαρμόζω, συμμορφώνω)." },
    { la:"laudare, laus", el:"(γαλλ.) laudatif (= κολακευτικός), louer (= επαινώ, εξυμνώ) // (αγγλ.) laudable (= αξιέπαινος) // (ιταλ.) lodare (= επαινώ)." },
    { la:"honestatem", el:"ονόρε (< ιταλ.) // (αγγλ.) honor (= τιμή), honesty (= τιμιότητα, εντιμότητα), honest (= τίμιος, έντιμος) // (γαλλ.) honorable (= αξιότιμος), honnête (= τίμιος, έντιμος)." },
    { la:"expetendo", el:"πί-πτ-ω, πετ-ώ // (αγγλ.) petition (= αίτηση, αναφορά), appetite (= όρεξη), compete (= ανταγωνίζομαι)." },
    { la:"corpus", el:"κόρπους (= σώμα κειμένων) // (αγγλ.) corporation (= εταιρεία, σωματείο), corpse (= πτώμα) // (γαλλ.) corps (= σώμα)." },
    { la:"pericula", el:"πείρα, πειρατής· απειρία // (αγγλ.) peril (= κίνδυνος) // (γαλλ.) péril (= κίνδυνος) // (ισπαν.) peligro (= κίνδυνος)." },
    { la:"mortis", el:"βροτός // (γαλλ.) mort (= νεκρός) // (αγγλ.) mortal (= θνητός) // (ιταλ.) morte (= θάνατος) // (ισπαν.) muerte (= θάνατος)." },
    { la:"parvi", el:"παῦρος (= μικρός, λίγος) // (αγγλ.) parvovirus (= παρβοϊός)." },
    { la:"ducendo", el:"(αγγλ.) ad-ductor (= προσαγωγός μυς), duke (= δούκας), produce (= παράγω) // (γαλλ.) con-ducteur (= οδηγός) // (ιταλ.) duce (= ηγέτης, αρχηγός)." },
    { la:"salute", el:"(γαλλ.) salutation (= χαιρετισμός) // (αγγλ.) salute (= χαιρετώ) // (ιταλ.) salute (= υγεία) // (ισπαν.) salud (= υγεία)." },
    { la:"potui (possum < potis + sum)", el:"πόσις, δεσ-πότης (= «κύριος σπιτιού») // (αγγλ.) potent (= ισχυρός, δυνατός), possible (= δυνατός, εφικτός) // (γαλλ.) pouvoir (= μπορώ, εξουσία)." }
  ]
};
