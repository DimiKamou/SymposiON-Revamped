...
export const UNIT = {
  ...
  alignment: [
    ...
    { la:"plenae voces sapientium,", el:"γεμάτοι οι λόγοι των σοφών," },
    { la:"plena exemplorum vetustas;", el:"γεμάτη από παραδείγματα η αρχαιότητα·" },
    { la:"quae omnia iacerent in tenebris,", el:"όλα αυτά θα βρίσκονταν στην αφάνεια," },
    { la:"nisi accederet lumen", el:"εάν δεν τα συνόδευε το φως" },
    { la:"litterarum.", el:"των γραμμάτων." },
    ...
    { la:"nobis reliquerunt scriptores", el:"μας κληροδότησαν συγγραφείς" },
    ...
    { la:"proponebam mihi.", el:"έβαζα μπροστά μου ως παραδείγματα." },
    { la:"Colendo", el:"Με το να λατρεύω" },
    { la:"et cogitando", el:"και να σκέπτομαι" },
    { la:"excellentes homines", el:"τους έξοχους άνδρες," },
    { la:"conformabam animum", el:"διέπλαθα την ψυχή" },
    { la:"et mentem meam.", el:"και το νου μου." },
    { la:"Sic enim", el:"Διότι έτσι" },
    { la:"– expetendo solum", el:"– με το να επιδιώκω μόνο" },
    { la:"laudem et honestatem,", el:"τον έπαινο και την τιμή," },
    { la:"ducendo", el:"με το να θεωρώ" },
    { la:"omnes cruciatus corporis", el:"ότι όλα τα βάσανα του σώματος" },
    { la:"et omnia pericula mortis", el:"και όλοι οι κίνδυνοι του θανάτου" },
    { la:"esse parvi –", el:"είναι μικρής αξίας –" },
