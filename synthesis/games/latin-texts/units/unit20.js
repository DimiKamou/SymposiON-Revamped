...
export const UNIT = {
  ...
  etymology: [
    ...
    { la:"anno", el:"(γαλλ.) année (= έτος, χρονιά)." },
    { la:"imperium", el:"ιμπεριαλισμός (< γαλλ.)." },
    { la:"cepit", el:"(ιταλ.) capire (= καταλαβαίνω)." },
    { la:"mirabili", el:"(γαλλ.) miracle (= θαύμα), admirable (= θαυμαστός)." },
    { la:"casu", el:"κάζο [< ιταλ. caso (= συμβάν)]." },
    { la:"ex-clusus (claudo)", el:"κλείς, κλειδίον // (γαλλ.) clé (= κλειδί)." },
    { la:"insidiatoribus", el:"(γαλλ.) insidieux (= ύπουλος)." },
    { la:"Caligulae", el:"Καλιγούλας." },
    { la:"recesserat", el:"(γαλλ.) récession (= ύφεση, επιβράδυνση)." },
    { la:"diaetam", el:"δίαιτα (= διατροφή) // (αγγλ.) diet (= δίαιτα)." },
    { la:"nomen", el:"όνομα // (γαλλ.) nom (= όνομα, ουσιαστικό), (αγγλ.) name." },
    { la:"Hermaeum", el:"Ερμῆς // Ερμαίο." },
    { la:"paulo", el:"παῦρος (= μικρός, λίγος)." },
    { la:"rumore", el:"(γαλλ.) rumor (= διάδοση, φήμη)." },
    { la:"exterritus", el:"τρέω, τρόμος // (γαλλ.) terroriste (= τρομοκράτης)." },
    { la:"pro-repsit", el:"ἕρπω." },
    { la:"solarium (sol)", el:"σολάριουμ // ἥλιος // (ισπαν.) soleado (= ηλιόλουστος)." },
    { la:"proximum", el:"(γαλλ.) proximité (= εγγύτητα)." },
    { la:"vela", el:"βέλο // (γαλλ.) voile (= πανί, ιστίο)." },
    { la:"prae-tenta (prae-tendo)", el:"τείνω // (γαλλ.) étendre (= τείνω), tendu (= τεντωμένος)." },
    { la:"foribus", el:"θύρα." },
    { la:"discurrens", el:"κούρσα (< γαλλ.), κουρσόρος (< ιταλ.)." },
    { la:"miles, com-militones", el:"μιλιταρισμός (< γαλλ.)." },
    { la:"pedes", el:"πούς (γενική ποδός), πέδον (= έδαφος), πέδη (συνήθως πέδαι = δεσμά ποδιών), πεζῇ (= με τα πόδια)." },
    { la:"anim-ad-vertit", el:"ανιμισμός (< γαλλ.), άνεμος // v.s. (= εναντίον)· (verso) βέρσο (= πίσω μέρος σελίδας), ρεβέρ (< γαλλ.)." },
    { la:"latentem", el:"(αγγλ.) latent (= λανθάνων, κρυμμένος)." },
    { la:"ad-gnovit", el:"γι-γνώσκω." },
    { la:"extractum", el:"(αγγλ.) extraction (= εξαγωγή), τρακτέρ (< γαλλ.)." },
    { la:"imperatorem, imperator", el:"ιμπεριαλισμός (< γαλλ.)." },
    { la:"salutavit", el:"(γαλλ.) salutation (= χαιρετισμός)." },
    { la:"adduxit", el:"(αγγλ.) adductor (= προσαγωγός μυς)." },
    { la:"castra", el:"κάστρο." },
    { la:"tristis", el:"(γαλλ.) triste (= λυπημένος)." },
    { la:"turba", el:"τύρβη (= ταραχή) // τούρμπο, τουρμπίνα (< γαλλ.)." },
    { la:"moriturum", el:"βροτός // (γαλλ.) mort (= νεκρός) // (αγγλ.) mortal (= θνητός)." },
    { la:"miseratur", el:"μιζέρια, μίζερος (< ιταλ.)." },
    { la:"postero", el:"(γαλλ.) postérité (= απόγονοι)." },
    { la:"die", el:"(Ζεύς, γενική Διός) Δίας (ως «θεός του φωτός»)." },
    { la:"factus est", el:"(αγγλ.) facts (= γεγονότα), factory (= εργοστάσιο)." }
  ]
};
