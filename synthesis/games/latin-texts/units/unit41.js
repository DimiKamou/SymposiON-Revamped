...
export const UNIT = {
  ...
  etymology: [
    ...
    { la:"antiquissimi, antiquiores, antiquitatem, antiqui [< antiquus < ante]", el:"αντίκα (< ιταλ.), αντικέρ (< γαλλ.) // (αγγλ.) antique (= παλαιός, αντίκα)." },
    { la:"viri", el:"βιρτουόζος (< ιταλ. virtuoso) // (αγγλ.) virile (= ανδρικός, ανδροπρεπής)." },
    { la:"Horatii", el:"Οράτιος." },
    { la:"di-lucide", el:"λευκός, λύχνος // (γαλλ.) lune (= σελήνη), lumière (= φως) // (αγγλ.) lucid (= σαφής, διαυγής)." },
    { la:"locūti, loquāris, loquere [< loquor]", el:"(γαλλ.) loquace (= ομιλητικός) // (αγγλ.) eloquent (= εύγλωττος), loquacious (= πολυλογάς, φλύαρος)." },
    { la:"sunt, sit, est", el:"εἰμί // (αγγλ.) essence (= ουσία), present (= παρών)." },
    { la:"Sicanōrum", el:"Σικανοί." },
    { la:"Pelasgōrum", el:"Πελασγοί." },
    { la:"primi", el:"πρό, πρότερος, πρῶτος· πριν // πριμαντόνα (< ιταλ.) // (γαλλ.) primaire (= πρωτογενής) // (αγγλ.) prime (= πρώτος, πρωταρχικός), primitive (= πρωτόγονος)." },
    { la:"coluisse [< colo]", el:"κουλτούρα // (αγγλ.) cult (= λατρεία), colony (= αποικία)." },
    { la:"Italiam", el:"Ιταλία // (αγγλ.) italic (= πλάγια γραφή)." },
    { la:"dicuntur, dicas, dicis [< dico]", el:"δείκ-νυμι (= δείχνω) // (γαλλ.) dictionnaire (= λεξικό), dictée (= υπαγόρευση) // (αγγλ.) dictate (= υπαγορεύω)." },
    { la:"aetātis [< aetas < aevitas]", el:"(αγγλ.) eternal (= αιώνιος), age (= ηλικία, εποχή)." },
    { la:"verbis, verbum", el:"(Ϝερέω) ἐρῶ // (γαλλ.) verbe (= ρήμα)· βερμπαλισμός (< γαλλ.) // (αγγλ.) verbatim (= κατά λέξη)." },
    { la:"utebantur, uteris [< utor]", el:"(αγγλ.) utility, use, utensil (= σκεύος, εργαλείο) // (γαλλ.) utile (= χρήσιμος), utiliser (= χρησιμοποιώ)." },
    { la:"matre [< mater]", el:"μήτηρ // (γαλλ.) maternel (= μητρικός), matrimonial (= γαμήλιος) // (αγγλ.) matrix (= μήτρα), material (= υλικό, υλικός)." },
    { la:"Evandri", el:"Εύανδρος." },
    { la:"nunc", el:"νῦν." },
    { la:"sermōne", el:"(αγγλ.) sermon (= ομιλία, κήρυγμα)." },
    { la:"multis", el:"μάλα (= πολύ) // (αγγλ.) multiple (= πολλαπλός) // (ιταλ.) molto (= πολύ)." },
    { la:"annis", el:"(γαλλ.) année (= έτος, χρονιά) // (αγγλ.) annual (= ετήσιος) // (ιταλ.) anno (= έτος, χρόνος)." },
    { la:"obsolēto [< ob-solesco], in-solens [< soleo]", el:"(γαλλ.) obsolète (= απαρχαιωμένος), insolent (= ιταμός)." },
    { la:"neminem [< nemo < ne + homo], homo", el:"ουμανισμός (< γαλλ.) // (αγγλ.) human (= ανθρώπινος)." },
    { la:"scire [< scio]", el:"(γαλλ.) science (= επιστήμη), conscient (= ειδήμων) // (αγγλ.) prescient (= προγνωστικός, διορατικός)." },
    { la:"intellegere [< intellego]", el:"(γαλλ.) intelligent (= ευφυής) // (αγγλ.) intellect (= νους, διάνοια)." },
    { la:"vis [< volo]", el:"βούλομαι // (αγγλ.) volunteer (= εθελοντής), voluntary (= εκούσιος, εθελοντικός), benevolent (= καλοπροαίρετος, ευμενής)." },
    { la:"in-epte [< in + aptus]", el:"ἅπτω // (αγγλ.) inept (= ανάρμοστος, ανόητος), apt (= κατάλληλος, ικανός), adapt (= προσαρμόζω)." },
    { la:"taces", el:"(αγγλ.) tacit (= σιωπηρός), taciturn (= λιγομίλητος, σιωπηλός), reticent (= επιφυλακτικός, λιγομίλητος)." },
    { la:"con-sequāris", el:"ἕπομαι // (αγγλ.) sequent (= ακόλουθος), consequence (= συνέπεια), sequence (= ακολουθία, αλληλουχία) // (γαλλ.) obséquieux (= δουλοπρεπής), seconde (= δευτερόλεπτο)." },
    { la:"placēre", el:"(αγγλ.) placebo (= εικονικό φάρμακο), please (= ευχαριστώ, ικανοποιώ / παρακαλώ), placid (= ήρεμος, γαλήνιος)." },
    { la:"honesta", el:"ονόρε (< ιταλ.) // (αγγλ.) honor (= τιμή), honest (= έντιμος, τίμιος) // (γαλλ.) honorable (= αξιότιμος), honnête (= έντιμος)." },
    { la:"bona", el:"μπονα-μάς [< ιταλ. bona mano], μπουνάτσα (< βενετ.), μπόνους // (αγγλ.) bounty (= γενναιοδωρία, αμοιβή)." },
    { la:"modesta [< modus]", el:"(γαλλ.) modeste (= σεμνός) // (αγγλ.) moderate (= μέτριος, μετριοπαθής)." },
    { la:"vive [< vivo]", el:"βίος // βιταλισμός, βιταμίνη (< γαλλ.) // (αγγλ.) vivid (= ζωηρός, ζωντανός), survive (= επιβιώνω)." },
    { la:"Gaio, Caesare", el:"Γάιος· Καίσαρας, καισαρική (τομή), καισαρισμός // (γερμ.) Kaiser (= αυτοκράτορας)." },
    { la:"scriptum", el:"σκάριφος (= όργανο γραφής), σκαρίφημα // (αγγλ.) script (= σενάριο), manuscript (= χειρόγραφο), scripture (= (Αγία) Γραφή)." },
    { la:"habe", el:"(γερμ.) haben, (αγγλ.) have // (αγγλ.) habit (= συνήθεια, έξη), exhibit (= εκθέτω, παρουσιάζω) // (γαλλ.) avoir (= έχω)." },
    { la:"semper", el:"(ισπαν.) siempre (= πάντα) // (αγγλ.) sempiternal (= αιώνιος, παντοτινός) // (ιταλ.) sempre (= πάντα)." },
    { la:"memoria", el:"μέμνημαι, μνήμη, μνημονικός // (αγγλ.) monument (= μνημείο), memory (= μνήμη) // (γαλλ.) mémoire (= μνήμη)." },
    { la:"pectore", el:"πέτο [< ιταλ. petto (= στήθος)] // (γαλλ.) pectoral (= θωρακικός) // (αγγλ.) expectorate (= αποχρέμπτομαι, βήχω) // (ισπαν.) pecho (= στήθος)." },
    { la:"scopulum", el:"σκόπελος (= βράχος) // (γαλλ.) écueil (= ύφαλος, σκόπελος) // (ιταλ.) scoglio (= ύφαλος, βράχος) // (ισπαν.) escollo (= ύφαλος, εμπόδιο)." },
    { la:"fugias [< fugio]", el:"φεύγω, φυγή // (αγγλ.) fugitive (= φυγάς), refuge (= καταφύγιο) // (γαλλ.) fuir (= φεύγω, αποφεύγω) // (ιταλ.) fuga (= φυγή)." },
    { la:"in-auditum [< audio]", el:"ἄω // (αγγλ.) audience (= ακροατήριο), obey (= υπακούω) // (ισπαν.) oír (= ακούω)." }
  ]
};
