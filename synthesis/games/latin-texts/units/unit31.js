export const UNIT = {
  ...
  etymology: [
    { la:"Latino, Latinus", el:"Λάτιο, Λατίνοι, Λατινικός." },
    { la:"Titus Manlius", el:"Τίτος Μάνλιος." },
    { la:"consul, consulis", el:"(γαλλ.) consul (= πρόξενος), consulter (= συμβουλεύω)." },
    { la:"nobili", el:"γιγνώσκω // (γαλλ.) noble (= ευγενής, αριστοκράτης)." },
    { la:"genere", el:"γένος· γενιά." },
    { la:"natu", el:"γί-γνο-μαι, γνήσιος // natura (= φύση), natural· νατουραλισμός (< γαλλ.)." },
    { la:"exercitu", el:"(ισπαν.) ejército (= στρατός) // (γαλλ.) exercice (= άσκηση)." },
    { la:"Romanorum, Romano", el:"Ρώμη, Ρωμαίος, ρωμαϊκός, ρωμιός." },
    { la:"castris, castra", el:"κάστρο." },
    { la:"abiret", el:"εἶμι // ιταμός." },
    { la:"edixit", el:"δείκ-νυμι (= δείχνω) // (γαλλ.) dictionnaire (= λεξικό), dictée (= ορθογραφία, υπαγόρευση)." },
    { la:"pugna, pugnandi", el:"πύξ (= γροθιά)· πυγμή." },
    { la:"abs-tinerent", el:"(γαλλ.) tenir (= κρατώ), (γαλλ.) abstinence (= αποχή)." },
    { la:"paulo", el:"παῦρος (= μικρός, λίγος)." },
    { la:"hostium, hoste, hostes", el:"(αγγλ.) host (= ξενιστής) // (γαλλ.) hostilité (= εχθρότητα)." },
    { la:"praeter-equitavit", el:"ἵππος." },
    { la:"duce", el:"δούκας." },
    { la:"verbis", el:"(Ϝερέω) ἐρῶ // (γαλλ.) verbe (= ρήμα)· βερμπαλισμός (< γαλλ.)." },
    { la:"est, erant", el:"εἰμί." },
    { la:"congrediamur", el:"κογκρέσο (= συνάθροιση) [< ιταλ. congresso, με αλλαγή της σημασίας κατά το αγγλ. congress] // (αγγλ.) egress (= έξοδος)." },
    { la:"singularis", el:"(γαλλ.) singularité (= μοναδικότητα)." },
    { la:"eventu", el:"βαίνω // (γαλλ.) avenue (= λεωφόρος)." },
    { la:"cernatur", el:"κρίνω." },
    { la:"miles", el:"μιλιταρισμός (< γαλλ.)." },
    { la:"virtute (< vir)", el:"βιρτουόζος (< ιταλ. virtuoso)." },
    { la:"antecellat (< ante + cello < celsus)", el:"κολωνός." },
    { la:"adulescens, adulescentem", el:"(γαλλ.) adulte (= ενήλικος)." },
    { la:"viribus", el:"(Ϝις) ἴς (= δύναμη)." },
    { la:"confisus", el:"πειθώ // (γαλλ.) con-fiance (= εμπιστοσύνη) // (αγγλ.) confidence (= αυτοπεποίθηση)." },
    { la:"cupiditate", el:"(γαλλ.) cupide (= άπληστος), cupidité (= απληστία)." },
    { la:"permotus", el:"μοτέρ (< γαλλ.) // μοτίβο [< ιταλ. motivo (= κίνητρο)] // (αγγλ.) move (= κινούμαι), motion (= κίνηση)." },
    { la:"fortior", el:"(γαλλ.) fort (= σωματική δύναμη) // (ισπαν.) fortaleza (= φρούριο)." },
    { la:"armis", el:"άρμα, αρματολός // (γαλλ.) armée (= στρατός)." },
    { la:"spoliavit", el:"(αγγλ.) spoil (= λάφυρο)." },
    { la:"fuga, fugati", el:"φεύγω, φυγή // (αγγλ.) fugitive (= φυγάς)." },
    { la:"salutem", el:"(γαλλ.) salutation (= χαιρετισμός)." },
    { la:"petiverunt", el:"πέτομαι, πετώ." },
    { la:"revertisset", el:"(γαλλ.) βέρσο (= πίσω μέρος σελίδας), ρεβέρ (< γαλλ.), v.s. (= εναντίον)." },
    { la:"opera (< opus)", el:"όπερα, οπερέτα (< ιταλ.)." },
    { la:"morte", el:"βροτός // (γαλλ.) mort (= νεκρός) // (αγγλ.) mortal (= θνητός)." }
  ]
};
