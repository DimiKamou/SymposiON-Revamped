...
export const UNIT = {
  ...
  etymology: [
    { la:"sapientem, sapiens [< sapio]", el:"σαφής, σοφός // (ισπαν.) sabio (= σοφός) // (γαλλ.) savoir (= γνωρίζω)" },
    { la:"paupertas, paupertāte [< pau-per]", el:"παῦ-ρος // (γαλλ.) pau-vre (= φτωχός), pauvreté (= φτώχεια)" },
    { la:"dolor", el:"(αγγλ.) dolor (= θλίψη, πόνος)" },
    { la:"prohibet [< pro + habeo]", el:"(γερμ.) haben (= έχω), (αγγλ.) have // (γαλλ.) prohiber (= απαγορεύω)" },
    { la:"res", el:"ρεαλισμός (< γαλλ.) // (αγγλ.) real (= πραγματικός)" },
    { la:"imperītos", el:"πείρα, πειρατής· άπειρος, απειρία // εξπέρ [< γαλλ. expert (= ειδικός)]" },
    { la:"a-vertunt [< a + verto]", el:"(verso) βέρσο (= πίσω μέρος σελίδας), ρεβέρ (< γαλλ.)" },
    { la:"praecipites [< prae + caput]", el:"καπέλο (< ιταλ.), καπετάνιος (< βενετ.), καπιταλισμός (< γαλλ.)" },
    { la:"agunt", el:"ἄγω" },
    { la:"premi [< premo]", el:"πρέσα // (γαλλ.) comprimer (= συμπιέζω) // κομπρεσέρ, κομπρέσα (< ιταλ.)" },
    { la:"putas", el:"(αγγλ.) disputation (= συζήτηση), putative (= υποτιθέμενος)" },
    { la:"malis", el:"μέλας // (γαλλ.) mal (= κακός) // (ισπαν.) malevolencia (= μοχθηρία)" },
    { la:"utitur [< utor]", el:"(αγγλ.) utility, use // (γαλλ.) utile (= χρήσιμος), utiliser (= χρησιμοποιώ)" },
    { la:"Phidias", el:"Φειδίας" },
    { la:"sciēbat [< scio]", el:"(γαλλ.) science (= επιστήμη), conscient (= ειδήμων)" },
    { la:"facere, faciēbat, fecisset, efficiet [< facio / efficio]", el:"(αγγλ.) facts (= γεγονότα), factory (= εργοστάσιο)" },
    { la:"simulacra [< simulo]", el:"(αγγλ.) similar // (γαλλ.) similarité, simulacre (= ομοίωμα)" },
    { la:"marmor", el:"μάρμαρος (= σπινθηροβόλος λίθος), μαρμαίρω· μάρμαρο" },
    { la:"viliōrem [< vilis]", el:"(αγγλ.) vile (= αχρείος, ευτελής)" },
    { la:"materiam", el:"μαδέρι (< βενετ.), ματεριαλισμός (= υλισμός) (< γαλλ.)" },
    { la:"fieri", el:"φύω, φύσις" },
    { la:"optimum", el:"(γαλλ.) optimal // οπτιμισμός (< γαλλ.)" },
    { la:"posset, poterit [< potis + sum]", el:"πόσις, δεσ-πότης («κύριος σπιτιού»)" },
    { la:"modo", el:"(γαλλ.) mode (= μόδα), modèle (= μοντέλο)" },
    { la:"virtūtem [< vir]", el:"βιρτουόζος (< ιταλ.)" },
    { la:"licēbit", el:"(αγγλ.) licence (= άδεια)" },
    { la:"divitias", el:"δῖος [< Διός] (= θεϊκός) // (γαλλ.) divin (= θεϊκός)" },
    { la:"explicābit", el:"(γαλλ.) expliquer (= εξηγώ), explicable (= ερμηνεύσιμος)" },
    { la:"minus", el:"μινόρε, μίνιμουμ, μινιατούρα (< ιταλ.) // (γαλλ.) minute" },
    { la:"patriā", el:"πατρίς, πατήρ· πατέρας" },
    { la:"exilio", el:"(γαλλ.) exil (= εξορία)" },
    { la:"imperātor", el:"ιμπεριαλισμός (< γαλλ.)" },
    { la:"miles", el:"μιλιταρισμός (< γαλλ.)" },
    { la:"integer", el:"(αγγλ.) integer [= ακέραιος αριθμός] // (γαλλ.) intégrale (= πλήρης)" },
    { la:"debilis [< de + habilis]", el:"(γαλλ.) débiliter (= εξασθενώ)" },
    { la:"fortūnam", el:"φουρτούνα (< ιταλ.) // (γαλλ.) fortune (= τύχη)" },
    { la:"acceperit [< accipio]", el:"(γαλλ.) accepter (= δέχομαι) // (ιταλ.) capire (= καταλαβαίνω)" },
    { la:"memorabile", el:"μέμνημαι, μνήμη // (γαλλ.) mémorable // (αγγλ.) monument (= μνημείο)" }
  ]
};
