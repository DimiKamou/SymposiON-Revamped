...
export const UNIT = {
  ...
  etymology: [
    { la:"cerva, cervam, cervā", el:"κέρας, κέρατο // (γαλλ.) cerf (= ελάφι) // (ιταλ.) cervo (= ελάφι) // (ισπαν.) ciervo (= ελάφι)." },
    { la:"alba [< albus]", el:"άλμπουμ (= λεύκωμα) // αλμπίνος, αλμπινισμός (< γαλλ.) // (αγγλ.) auburn (= καστανοκόκκινος (αρχικά υπόλευκος)) // (γαλλ.) aube (= αυγή, χαραυγή) // (ιταλ.) alba (= αυγή)." },
    ...
    { la:"dono, data [< do]", el:"δίδωμι, δώρημα, δώρο // (γαλλ.) donner (= δίνω) // (αγγλ.) data (= δεδομένα), donation (= δωρεά) // (ιταλ.) dare (= δίνω)." },
    { la:"erat, essent, esset, esse, est [< sum]", el:"εἰμί // (αγγλ.) essence (= ουσία) // (ιταλ.) essere (= είμαι)." },
    { la:"persuadet [< persuadeo < per + suadeo]", el:"ἁδύς (ἡδύς), ἁνδάνω (= τέρπω), ηδονή // (αγγλ.) sweet (= γλυκύς), persuasion (= πειθώ), persuasive (= πειστικός) // (γαλλ.) persuader (= πείθω)." },
    { la:"instinctam [< in-stinguo]", el:"στίζω, ένστικτο // (γαλλ.) instinct // (αγγλ.) instinctive (= ενστικτώδης)." },
    { la:"numine [< numen]", el:"νεύσω, νεύμα // (αγγλ.) numinous (= θεϊκός, μυστηριακός)." },
    { la:"Dia-nam [< divus]", el:"Ζεύς, γενική Διός // (γαλλ.) divin (= θεϊκός) // (ιταλ.) diva (= ντίβα, πριμαντόνα)." },
    { la:"con-loqui [< con-loquor]", el:"(γαλλ.) loquace (= ομιλητικός), colloque (= συνέδριο, κολλόκβιο) // (αγγλ.) colloquial (= της καθομιλουμένης), eloquent (= εύγλωττος)." },
    { la:"docere [< doceo]", el:"δοκέω, δόγμα // ντοκουμέντο (< ιταλ.) / (γαλλ.) docteur (= διδάκτωρ) // (αγγλ.) doctrine (= δόγμα, διδασκαλία), docile (= πειθήνιος)." },
    { la:"utilia [< utilis]", el:"(αγγλ.) utility (= χρησιμότητα), use (= χρήση), utilize (= χρησιμοποιώ) // (γαλλ.) utile (= χρήσιμος), utiliser (= χρησιμοποιώ)." },
    { la:"factu [< facio]", el:"(αγγλ.) facts (= γεγονότα), factory (= εργοστάσιο) // (γαλλ.) faire (= κάνω) // (ιταλ.) fare (= κάνω) // (ισπαν.) hacer (= κάνω)." },
    { la:"durius [< durus]", el:"ντούρος (< ιταλ.) // (γαλλ.) dur (= σκληρός), durer / durée (= διαρκώ / διάρκεια) // (αγγλ.) durable (= ανθεκτικός), endure (= αντέχω) // (ισπαν.) durar (= διαρκώ)." },
    { la:"videbatur, visum [< video]", el:"(ϝιδεῖν) ιδέα, βίντεο (< αγγλ.) // (αγγλ.) vision (= όραση), visible (= ορατός) // (γαλλ.) voir (= βλέπω) // (ιταλ.) vedere (= βλέπω) // (ισπαν.) ver (= βλέπω)." },
    { la:"imperandum [< impero]", el:"ιμπεριαλισμός (< γαλλ.) // (αγγλ.) emperor (= αυτοκράτορας), empire (= αυτοκρατορία), imperative (= προστακτική) // (γαλλ.) empereur (= αυτοκράτορας) // (ιταλ.) imperatore (= αυτοκράτορας) // (ισπαν.) emperador (= αυτοκράτορας)." },
    { la:"militibus [< miles]", el:"μιλιταρισμός (< γαλλ.) // (αγγλ.) military (= στρατιωτικός), militia (= πολιτοφυλακή) // (γαλλ.) militaire (= στρατιωτικός) // (ιταλ.) militare (= στρατιωτικός) // (ισπαν.) militar (= στρατιωτικός)." },
    { la:"monitum [< moneo]", el:"μιμνήσκω, μνήμη // (αγγλ.) monitor (= επιτηρητής / οθόνη), monument (= μνημείο), premonition (= προαίσθηση) // (γαλλ.) monument (= μνημείο) // (ιταλ.) monito (= προειδοποίηση)." },
    { la:"prae-dicabant [< prae-dico], dixit [< dico]", el:"δείκνυμι (= δείχνω) // (γαλλ.) dictionnaire (= λεξικό), dictée (= ορθογραφία, υπαγόρευση), dire (= λέω) // (αγγλ.) dictate (= υπαγορεύω), predict (= προβλέπω), preach (= κηρύττω) // (ιταλ.) dire (= λέω) // (ισπαν.) decir (= λέω)." },
    { la:"die, diei [< dies]", el:"(Ζεύς, γενική Διός) Δίας (ως «θεός του φωτός») // (αγγλ.) diary (= ημερολόγιο), diurnal (= ημερήσιος) // (γαλλ.) jour (= ημέρα) // (ιταλ.) giorno (= ημέρα) // (ισπαν.) día (= ημέρα)." },
    { la:"fugit [< fugio]", el:"φεύγω, φυγή // (αγγλ.) fugitive (= φυγάς), refuge (= καταφύγιο), centrifuge (= φυγόκεντρος) // (γαλλ.) fuir (= φεύγω) // (ιταλ.) fuga (= φυγή) // (ισπαν.) huir (= φεύγω)." },
    { la:"perisse, perisset [< pereo < per + eo]", el:"εἶμι // (αγγλ.) perish (= χάνομαι, αφανίζομαι) // (γαλλ.) périr (= χάνομαι) // (ιταλ.) perire (= χάνομαι) // (ισπαν.) perecer (= χάνομαι)." },
    { la:"credita [< credo]", el:"(αγγλ.) credible (= πιστευτός), αντιθ. incredible, credit (= πίστωση), creed (= δόγμα πίστεως) // (γαλλ.) croire (= πιστεύω) // (ιταλ.) credere (= πιστεύω) // (ισπαν.) creer (= πιστεύω)." },
    { la:"nuntiavisset [< nuntio]", el:"νεύω // νούντσιος (< ιταλ.) (= διπλωματικός αντιπρόσωπος του Πάπα) // (αγγλ.) announce (= ανακοινώνω), pronounce (= προφέρω), denounce (= καταγγέλλω) // (γαλλ.) annoncer (= αναγγέλλω) // (ιταλ.) annunciare (= αναγγέλλω) // (ισπαν.) anunciar (= ανακοινώνω)." },
    { la:"in-ventam [< invenio < in + venio]", el:"βαίνω // (γαλλ.) venir (= έρχομαι), avenue (= λεωφόρος), inventer (= εφευρίσκω) // (αγγλ.) invention (= εφεύρεση)." },
    { la:"tacere [< taceo]", el:"(αγγλ.) tacit (= σιωπηρός), taciturn (= λιγομίλητος) // (γαλλ.) taire (se taire) (= σιωπώ)." },
    { la:"praecepit [< prae + capio]", el:"(γαλλ.) ac-cepter (= δέχομαι) // (ιταλ.) capire (= καταλαβαίνω) // (αγγλ.) precept (= δίδαγμα, εντολή)." },
    { la:"postero [< posterus]", el:"(αγγλ.) posterior (= μεταγενέστερος), posterity (= μεταγενέστεροι, απόγονοι) // (γαλλ.) postérité (= απόγονοι) // (ισπαν.) posteridad (= αιωνιότητα)." },
    { la:"repente", el:"(ισπαν.) repentino (= ξαφνικός)." },
    { la:"locum [< locus]", el:"(γαλλ.) locale (= τοπικός), lieu (= τόπος) // (αγγλ.) location (= τοποθεσία)." },
    { la:"e-mitteret, ad-missis, e-missa [< mitto]", el:"(αγγλ.) mission (= αποστολή), emit (= εκπέμπω) // (γαλλ.) mettre (= βάζω, τοποθετώ)." },
    { la:"futurus", el:"(γαλλ.) futur (= μέλλον) // (αγγλ.) future (= μέλλον)." },
    { la:"amicis [< amicus]", el:"αμόρε (< ιταλ.) // (γαλλ.) amour (= αγάπη), ami (= φίλος), amical (= φιλικός) // (αγγλ.) amicable (= φιλικός) // (ισπαν.) amigo (= φίλος)." },
    { la:"cubiculum", el:"κουβούκλιο // (αγγλ.) shower cubicle (= καμπίνα λουτρού), incubate / incubator (= επωάζω / εκκολαπτήρας)." },
    { la:"somno [< somnus]", el:"ύπνος // (αγγλ.) insomnia (= αϋπνία) // (γαλλ.) sommeil (= ύπνος)." },
    { la:"reverti [< revertor < re + verto]", el:"(verso) βέρσο (= πίσω μέρος σελίδας), ρεβέρ (< γαλλ.), v.s. (versus) (= εναντίον) // (αγγλ.) reverse / revert (= αντιστρέφω, επιστρέφω)." },
    { la:"servo [< servus]", el:"σερβίρω, σερβιτόρος, σερβίτσιο (< ιταλ.) // σέρβις (< αγγλ.), σερβίς (< γαλλ.) // (αγγλ.) servant (= υπηρέτης) // (γαλλ.) serf (= δουλοπάροικος)." },
    { la:"intro-rupisset [< introrumpo < intra + rumpo]", el:"(γαλλ.) rupture (= ρήξη), corruption (= διαφθορά), rompre (= σπάζω, διακόπτω), route (= δρόμος, διαδρομή) // (αγγλ.) erupt (= εκρήγνυμαι), interrupt (= διακόπτω), abrupt (= απότομος)." },
    { la:"ad-miratio [< ad-miror]", el:"(γαλλ.) miracle (= θαύμα), admirable (= θαυμαστός) // (αγγλ.) admire (= θαυμάζω), marvel (= θαύμα· θαυμάζω), mirror (= καθρέφτης)." },
    { la:"magna [< magnus]", el:"μέγας // (αγγλ.) magnificent (= μεγαλοπρεπής), magnitude (= μέγεθος), magnate (= μεγιστάνας), magnanimous (= μεγαλόψυχος), major (= μείζων, κύριος), maximum (= μέγιστο) // (γαλλ.) magnificence (= μεγαλοπρέπεια)." },
    { la:"orta [< orior]", el:"ὄρνυμι (= κινώ, εγείρω) // (αγγλ.) origin (= καταγωγή, αρχή), orient (= Ανατολή· προσανατολίζω), abort (= αποβάλλω, ματαιώνω)." }
  ]
};
