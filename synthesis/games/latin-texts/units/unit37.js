...
export const UNIT = {
  ...
  etymology: [
    { la:"locum", el:"(γαλλ.) locale (= τοπικός), lieu (= τόπος) // (αγγλ.) location (= τοποθεσία) // (ιταλ.) luogo (= τόπος)." },
    { la:"res", el:"ρεαλισμός (< γαλλ.) // (αγγλ.) real (= πραγματικός), republic (= δημοκρατία) // (γαλλ.) rien (= τίποτα)." },
    { la:"de-ducta [< de-duco]", el:"(γαλλ.) déductif (= επαγωγικός), con-ducteur (= οδηγός) // (αγγλ.) ad-ductor (= προσαγωγός μυς), produce (= παράγω), aqueduct (= υδραγωγείο)." },
    { la:"est, esse, sint, sunt", el:"εἰμί // (αγγλ.) essence (= ουσία) // (γαλλ.) être (= είμαι)." },
    { la:"deus", el:"Ζεύς, (γεν.) Διός // (αγγλ.) deity (= θεότητα) // (γαλλ.) dieu (= θεός) // (ιταλ.) dio (= θεός)." },
    { la:"casus", el:"κάζο [< ιταλ. caso (= συμβάν)] // (αγγλ.) case (= περίπτωση), casual (= τυχαίος)." },
    { la:"sub-venerit [< sub-venio], vēni", el:"βαίνω // (γαλλ.) subvention (= επιχορήγηση), venir (= έρχομαι) // (αγγλ.) convention (= σύμβαση, συνέδριο), intervene (= παρεμβαίνω)." },
    { la:"salvi", el:"σάος = σῶς // (γαλλ.) salvation (= λύτρωση) // (αγγλ.) salve (= ανακουφίζω), save (= σώζω), safe (= ασφαλής)." },
    { la:"urbem", el:"(γαλλ.) urbain (= αστικός) // (αγγλ.) urban (= αστικός), suburb (= προάστιο)." },
    { la:"de-stiti [< de-sisto]", el:"ἵστημι, στάσις // (αγγλ.) desist (= παύω), resist (= αντιστέκομαι), insist (= επιμένω) // (γαλλ.) destitution (= καθαίρεση), résister (= αντιστέκομαι)." },
    { la:"sentīre", el:"(γαλλ.) sentir (= αισθάνομαι, νιώθω), sensible (= ευαίσθητος) // (αγγλ.) sense (= αίσθηση), sentiment (= συναίσθημα), consent (= συναινώ)." },
    { la:"dicere", el:"δείκ-νυμι (= δείχνω) // (γαλλ.) dictionnaire (= λεξικό), dictée (= υπαγόρευση), dire (= λέω) // (αγγλ.) predict (= προβλέπω), verdict (= ετυμηγορία)." },
    { la:"facere", el:"(αγγλ.) facts (= γεγονότα), factory (= εργοστάσιο), facile (= εύκολος), effect (= αποτέλεσμα) // (γαλλ.) faire (= κάνω)." },
    { la:"con-cordiam", el:"καρδία // (γαλλ.) concorde (= ομόνοια, συμφωνία) // (ισπαν.) corazón (= καρδιά) // (αγγλ.) cordial (= εγκάρδιος)." },
    { la:"per-tinērent", el:"τείνω // (γαλλ.) tenir (= κρατώ), pertinent (= σχετικός, συναφής) // (αγγλ.) pertain (= αφορώ, σχετίζομαι), tenacious (= επίμονος)." },
    { la:"furor", el:"(αγγλ.) furor, (γαλλ.) furie, fury (= μανία, οργή), furious (= μανιώδης, έξαλλος)." },
    { la:"in-vaserat [< in-vado]", el:"βάδην, βαίνω // (αγγλ.) invade (= εισβάλλω), invasion (= εισβολή)." },
    { la:"pugnāre", el:"πύξ (= με γροθιά)· πυγμή // (αγγλ.) pugnacious (= μαχητικός, επιθετικός) // (γαλλ.) poing (= γροθιά)." },
    { la:"cuperent [< cupio]", el:"(γαλλ.) cupide (= άπληστος) // (αγγλ.) cupidity (= απληστία, πλεονεξία)." },
    { la:"ego", el:"ἐγώ // (αγγλ.) ego (= εγώ, εαυτός (ψυχολ.)), egoism (= εγωισμός)." },
    { la:"clamābam [< clamo]", el:"ρεκλάμα [< γαλλ. réclame (= διαφήμιση)] // (αγγλ.) claim (= απαιτώ, διεκδικώ), clamor (= κατακραυγή, βοή) // (ιταλ.) chiamare (= καλώ, φωνάζω)." },
    { la:"civīli, civilibus, civilium", el:"κοίτη· (αγγλ.) city (= πόλη) // (γαλλ.) civilisation (= πολιτισμός) // (αγγλ.) civic (= δημοτικός, πολιτικός)." },
    { la:"miserius, misera", el:"μιζέρια, μίζερος (< ιταλ.) // (αγγλ.) miserable (= άθλιος, δυστυχής), misery (= δυστυχία, αθλιότητα)." },
    { la:"victoria, victōres, victor", el:"βικτοριανός (< αγγλ.) // (γαλλ.) victoire (= νίκη), (αγγλ.) victory // (αγγλ.) invincible (= ανίκητος)." },
    { la:"fe-rociōres", el:"θήρ· θηρίο, πάν-θηρας // (αγγλ.) ferocious (= άγριος, θηριώδης), fierce (= άγριος, σφοδρός)." },
    { la:"im-potentiores [< possum]", el:"πόσις, δεσ-πότης // (αγγλ.) impotent (= ανίκανος, αδύναμος), potential (= δυνητικός, δυναμικό)." },
    { la:"red-dit", el:"δίδωμι // (γαλλ.) donner (= δίνω), reddition (= απόδοση, παράδοση), rendre (= επιστρέφω, αποδίδω) // (αγγλ.) render (= αποδίδω, παραδίδω)." },
    { la:"natūrā", el:"γί-γνο-μαι, γνήσιος // (γαλλ.) nature, naturel· νατουραλισμός (< γαλλ.) // (αγγλ.) natural (= φυσικός), innate (= έμφυτος)." },
    { la:"necessitāte", el:"νεσεσέρ (< γαλλ. nécessaire) // (αγγλ.) necessity (= αναγκαιότητα), necessary (= αναγκαίος) // (γαλλ.) nécessité (= αναγκαιότητα)." },
    { la:"cogantur [< cogo < cum + ago]", el:"ἄγω // (αγγλ.) cogent (= πειστικός), coagulate (= πήζω)." },
    { la:"ex-itus [< ex-eo]", el:"εἶμι // (αγγλ.) exit (= έξοδος) // (ιταλ.) esito (= έκβαση, αποτέλεσμα) // (ισπαν.) éxito (= επιτυχία)." },
    { la:"semper", el:"(ισπαν.) siempre (= πάντα) // (ιταλ.) sempre (= πάντα)." },
    { la:"solum", el:"σόλο (< ιταλ.), σολίστ(ας) // (αγγλ.) sole (= μοναδικός) // (γαλλ.) seul (= μόνος)." },
    { la:"fiant", el:"φύω, φύσις // (αγγλ.) fiat (= διάταγμα)." },
    { la:"velit [< volo]", el:"βούλομαι // (αγγλ.) volunteer (= εθελοντής), voluntary (= εκούσιος, εθελοντικός) // (γαλλ.) vouloir (= θέλω)." },
    { la:"ob-sequătur", el:"ἕπομαι // (αγγλ.) sequent (= ακόλουθος), sequence (= ακολουθία) // (γαλλ.) obséquieux (= δουλοπρεπής), seconde (= δευτερόλεπτο), suivre (= ακολουθώ) // σεκόντο (< ιταλ.) // (ισπαν.) seguir (= ακολουθώ)." },
    { la:"auxilio", el:"(γαλλ.) auxiliaire (= βοηθός) // (αγγλ.) auxiliary (= βοηθητικός)." }
  ]
};
