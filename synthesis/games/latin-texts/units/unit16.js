...
export const UNIT = {
  ...
  etymology: [
    { la:"hostes, hostium", el:"(αγγλ.) host (= ξενιστής), hostile (= εχθρικός) // (γαλλ.) hostilité (= εχθρότητα)." },
    { la:"miserunt, mittuntur", el:"(αγγλ.) mission (= αποστολή), missile (= βλήμα, πύραυλος) // (γαλλ.) message (= μήνυμα)." },
    { la:"gladius", el:"(υποκορ.) gladiolus (= κοντό ξίφος) — (λόγω του σχήματος) γλαδιόλα (φυτό) // (αγγλ.) gladiator (= μονομάχος)." },
    { la:"cohortes", el:"(αγγλ.) cohort, (γαλλ.) cohorte, court (= αυλή, δικαστήριο) // (γαλλ.) cour (= αυλή)." },
    { la:"vertunt", el:"(verso) βέρσο (= πίσω μέρος σελίδας), ρεβέρ (< γαλλ.), v. s. (= εναντίον) // (αγγλ.) convert (= μετατρέπω), vertebra (= σπόνδυλος)." },
    { la:"fugiunt, fuga", el:"φεύγω, φυγή // (αγγλ.) fugitive (= φυγάς), refuge (= καταφύγιο)." },
    { la:"occurrunt", el:"κούρσα (< γαλλ.), κουρσάρος (< ιταλ.) // (αγγλ.) occur (= συμβαίνω, παρουσιάζομαι), current (= ρεύμα· τρέχων)." },
    { la:"rem", el:"ρεαλισμός (< γαλλ.) // (αγγλ.) real (= πραγματικός), republic (= δημοκρατία, πολιτεία)." },
    { la:"fit", el:"φύω, φύσις." },
    { la:"equitatus, equites", el:"ίππος // (αγγλ.) equestrian (= ιππικός, ιππέας), equine (= ιππικός, του αλόγου)." },
    { la:"cernitur", el:"κρίνω // (αγγλ.) discern (= διακρίνω), certain (= βέβαιος)." },
    { la:"magna, magnus", el:"μέγας // (αγγλ.) magnitude (= μέγεθος), magnify (= μεγεθύνω), major (= μείζων, μεγαλύτερος)." },
    { la:"Sedulius", el:"Σεδούλιος." },
    { la:"dux, produci, duces, producuntur", el:"δούκας // (αγγλ.) duke (= δούκας, ηγεμόνας), produce (= παράγω, προϊόν), conduct (= διεξάγω, αγωγή), duct (= αγωγός, πόρος) // (γαλλ.) duc (= δούκας)." },
    { la:"princeps, principes", el:"πρίγκιπας // (γαλλ., αγγλ.) prince // (αγγλ.) principal (= κύριος, διευθυντής), principle (= αρχή) // (ιταλ.) principe (= πρίγκιπας) // (γερμ.) Prinz (= πρίγκιπας)." },
    { la:"numerus", el:"νούμερο (< ιταλ.) / (γαλλ.) numéral (= αριθμός, ψηφία) // (αγγλ.) number (= αριθμός), numerous (= πολυάριθμος) // (γαλλ.) nombre (= αριθμός)." },
    { la:"Lemovicum", el:"Λεμόβικες // (γαλλ.) limousine (= λιμουζίνα (τύπος αυτοκινήτου))." },
    { la:"Arvernorum", el:"Αρβέρνοι." },
    { la:"capitur", el:"(ιταλ.) capire (= καταλαβαίνω) // (αγγλ.) capture (= συλλαμβάνω, αιχμαλωσία), captive (= αιχμάλωτος) // (γαλλ.) captif (= αιχμάλωτος)." },
    { la:"vivus", el:"βίος // βιταλισμός (< γαλλ. vitalisme), βιταμίνη (< γαλλ.) // (αγγλ.) vivid (= ζωηρός, έντονος), survive (= επιβιώνω) // (γαλλ.) vif (= ζωντανός, ζωηρός) // (ιταλ.) vivo (= ζωντανός)." },
    { la:"interficitur", el:"(αγγλ.) facts (= γεγονότα), effect (= αποτέλεσμα, επίδραση), perfect (= τέλειος) // (γαλλ.) faire (= κάνω, φτιάχνω)." },
    { la:"comprehenditur", el:"(αγγλ.) comprehend (= κατανοώ, περιλαμβάνω), apprehend (= συλλαμβάνω· αντιλαμβάνομαι), prison (= φυλακή) // (γαλλ.) comprendre (= καταλαβαίνω)." },
    { la:"reliqui", el:"λείπω, λοιπός // (αγγλ.) relic (= λείψανο, κειμήλιο), relinquish (= παραιτούμαι, εγκαταλείπω), derelict (= εγκαταλελειμμένος) // (γαλλ.) relique (= λείψανο)." },
    { la:"signa", el:"σινιάλο (< ιταλ.) // (αγγλ.) sign (= σήμα, σημάδι), signal (= σήμα, σινιάλο), signature (= υπογραφή), design (= σχεδιάζω, σχέδιο) // (γαλλ.) signe (= σήμα, σημάδι, δείγμα) // (ισπαν.) señal (= σήμα, σημάδι)." },
    { la:"militaria", el:"μιλιταρισμός (< γαλλ.) // (αγγλ.) military (= στρατιωτικός), militia (= πολιτοφυλακή), militant (= μαχητικός, στρατευμένος) // (γαλλ.) militaire (= στρατιωτικός)." },
    { la:"septuaginta quattuor", el:"ἑπτά, ἕβδομος, ἑβδομήκοντα // (γαλλ.) quatre // τέτταρες // (αγγλ.) September (= Σεπτέμβριος (7ος μήνας)), quadruple (= τετραπλάσιος) // (ιταλ.) quattro (= τέσσερα) // (ισπαν.) cuatro (= τέσσερα)." },
    { la:"Caesarem, Caesar", el:"Καίσαρας, καισαρικός [καισαρική (τομή)], καισαρισμός // (γερμ.) Kaiser (= αυτοκράτορας)." },
    { la:"referuntur", el:"φέρω // (αγγλ.) transfer (= μεταφορά), refer (= αναφέρω, παραπέμπω), reference (= αναφορά, παραπομπή) // διαφορά, φορέας, φορείο // (γαλλ.) référence (= αναφορά, παραπομπή)." },
    { la:"civitates", el:"κοίτη // (αγγλ.) city (= πόλη), citizen (= πολίτης) // (γαλλ.) civilisation (= πολιτισμός), cité (= πόλη, οικισμός) // (ιταλ.) città (= πόλη) // (ισπαν.) ciudad (= πόλη)." },
    { la:"die", el:"(Ζεύς, γενική Διός) Δίας (ως «θεός του φωτός») // (αγγλ.) diary (= ημερολόγιο), diurnal (= ημερήσιος) // (γαλλ.) jour (= ημέρα) // (ιταλ.) giorno (= ημέρα) // (ισπαν.) día (= ημέρα)." },
    { la:"legati", el:"λέγω // (αγγλ.) legate (= απεσταλμένος, λεγάτος), delegate (= αντιπρόσωπος, εκπρόσωπος), legacy (= κληρονομιά, παρακαταθήκη) // (γαλλ.) légat (= απεσταλμένος, λεγάτος)." },
    { la:"arma", el:"άρμα, αρματολός // (αγγλ.) army (= στρατός), armour (= πανοπλία, θωράκιση), alarm (= συναγερμός) // (ισπαν.) armada (= στόλος, αρμάδα)." },
    { la:"tradi, deditur", el:"δίδωμι // (αγγλ.) tradition (= παράδοση), traitor (= προδότης), treason (= προδοσία) // (ιταλ.) tradire (= προδίδω)." },
    { la:"castris", el:"κάστρο // (αγγλ.) castle (= κάστρο, φρούριο), -chester / -caster (π.χ. Manchester) (= κατάληξη τοπωνυμίων = τόπος ρωμαϊκού στρατοπέδου) // (γαλλ.) château (= πύργος, κάστρο) // (ιταλ.) castello (= κάστρο) // (ισπαν.) castillo (= κάστρο)." },
    { la:"consedit", el:"ἕζομαι, ἕδρα, πρόεδρος, πάρεδρος // (αγγλ.) session (= συνεδρία, συνεδρίαση), sedentary (= καθιστικός), president (= πρόεδρος) // (γαλλ.) séance (= συνεδρία)." },
    { la:"Vercingetorix", el:"Βερκιγγετόριγας." },
    { la:"proiciuntur", el:"ἵημι (= ρίχνω) // (αγγλ.) project (= έργο, σχέδιο· προβάλλω), projectile (= βλήμα) // (γαλλ.) projet (= σχέδιο, έργο)." }
  ]
};
