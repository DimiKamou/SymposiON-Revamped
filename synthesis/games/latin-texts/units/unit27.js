  ...
  periods: [
    ...
    { n: 3, kids: [
      { type:"main", key:"kyria", label:"Κύρια", kids:[
        ...
        { l:"et", r:"Σύνδεσμος", g:"συμπλεκτικός σύνδεσμος", d:"et — και" },
        { l:"acerbiora", r:"Κατηγορούμενο", to:"στο ea (μέσω εννοούμενου esse)", g:"αιτ. πληθ., ουδ. — επίθ. γ΄ κλ. (συγκρ.)", d:"acerbior, -ior, -ius — πικρότερος (συγκρ. του acerbus)", note:"εκφράζει απόλυτη σύγκριση" },
        { l:"videri", r:"Ειδικό απαρέμφατο (αντικείμενο)", to:"στο dixit", g:"απαρέμφατο ενεστ. παθ. φωνής", d:"video, vidi, visum, videre (2) — βλέπω· (παθ.) φαίνομαι", a:"." }
      ]}
    ]},
