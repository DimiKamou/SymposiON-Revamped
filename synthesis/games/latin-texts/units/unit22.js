// ============================================================================
//  ΛΑΤΙΝΙΚΑ — ΦΥΛΛΟ ΔΕΔΟΜΕΝΩΝ ΕΝΟΤΗΤΑΣ 22
//  «Προτροπές προς τους Ρωμαίους» (Lectio XXII)
// ============================================================================
  ...
  periods: [
    { n: 1, kids: [
      { type:'main', key:'kyria', label:'Κύρια', kids:[
        ...
        { l:'alios', r:'Αντικείμενο', to:'στο Imitemur', g:'αιτ. πληθ., αρσ. — αόριστη επιθ. αντων. (αντωνυμικό επίθ.)', d:'alius, alia, aliud — άλλος, -η, -ο', a:',' },
