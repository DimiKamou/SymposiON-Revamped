...
export const UNIT = {
  ...
  periods: [
    { n: 1, kids: [
      { type:"main", key:"kyria", label:"Κύρια", kids:[
        ...
        { type:"sub", key:"anaforiki", label:"Αναφορική", note:"Δευτ. αναφορική προσδιοριστική στο omnia· εκφέρεται με οριστική (sentis), δηλώνει πραγματικό γεγονός. Εμπεριέχει ειδικό απαρέμφατο (iacere) εξαρτώμενο από το sentis.", kids:[
          ...
          { l:"ipsius", r:"Επιθετικός προσδ.", to:"στο belli", g:"γεν. ενικ., ουδ. — δεικτική (οριστική) αντων.", d:"ipse, ipsa, ipsum — ο ίδιος", a:"," },
    ...
    { n: 3, kids: [
      { type:"main", key:"kyria", label:"Κύρια", kids:[
        { l:"omnia", r:"Υποκείμενο", to:"στο vincienda sunt", g:"ονομ. πληθ., ουδ. — επίθ. γ΄ κλ.", d:"omnis, -is, -e — όλος· (ουδ. πληθ.) όλα", a:"," },
        { type:"sub", key:"anaforiki", label:"Αναφορική", note:"Δευτ. αναφορική προσδιοριστική στο omnia· εκφέρεται με οριστική (πραγματικό γεγονός).", kids:[
          ...
          { l:"dilapsa", r:"Επιρρ. κατηγορηματική μετοχή (χρονική)", to:"στο diffluxerunt (αναφέρεται στο quae)", g:"μετοχή παρακ. αποθ., ονομ. πληθ. ουδ.", d:"dilabor, dilapsus sum, dilabi (αποθ. 3) — διαλύομαι, καταρρέω", note:"Χρονική μετοχή (προτερόχρονο): «αφού κατέρρευσαν»." },
          { l:"iam", r:"Επιρρ. προσδ. του χρόνου", to:"στο diffluxerunt", g:"χρονικό επίρρημα", d:"iam — ήδη, πια" },
          { l:"diffluxerunt", r:"Ρήμα", g:"γ΄ πληθ. οριστ. παρακ. ενεργ.", d:"diffluo, diffluxi, —, diffluere (3) — διαρρέω, διαλύομαι· εδώ: καταλύομαι", a:"," }
        ]},
        { l:"severis", r:"Επιθετικός προσδ.", to:"στο legibus", g:"αφαιρ. πληθ., θηλ. — επίθ. β΄ κλ.", d:"severus, -a, -um — αυστηρός" },
        { l:"legibus", r:"Αφαιρετική του οργάνου (μέσου)", to:"στο vincienda sunt", g:"αφαιρ. πληθ., θηλ. γ΄ κλ.", d:"lex, legis (θηλ. γ΄) — ο νόμος" },
        ...
        { l:"sunt", r:"Ρήμα (βοηθητικό)", to:"στην περίφραση vincienda sunt", g:"γ΄ πληθ. οριστ. ενεστ. — ανώμαλο", d:"sum, fui, esse — είμαι", a:"." }
      ]}
    ]},
    ...
    { n: 5, kids: [
      { l:"-que", r:"Σύνδεσμος", g:"συμπλεκτικός (παρατακτικός) σύνδεσμος (εγκλιτικό στο multa)", d:"-que — και", conn:true },
      { type:"main", key:"kyria", label:"Κύρια", kids:[
        { l:"multa", r:"Αντικείμενο", to:"στο fecit", g:"αιτ. πληθ., ουδ. — επίθ. β΄ κλ. (ουσιαστικοπ.)", d:"multus, -a, -um — πολύς· (ουδ. πληθ.) πολλά" },
        ...
        { type:"sub", key:"anaforiki", label:"Αναφορική", note:"Δευτ. αναφορική προσδιοριστική στο multa· εκφέρεται με υποτακτική υπερσυντελίκου (prohibuisset) και έχει υποθετική/δυνητική χροιά — δηλώνει το μη πραγματικό στο παρελθόν (απόδοση λανθάνοντος υποθετικού λόγου).", kids:[
          ...
          { l:"togatus", r:"Επιρρ. κατηγορούμενο του χρόνου", to:"στο idem", g:"ονομ. ενικ., αρσ. — επίθ. β΄ κλ.", d:"togatus, -a, -um — ντυμένος με την τήβεννο· (ως) πολίτης", note:"Επιρρηματικό κατηγορούμενο: «όταν φορούσε την τήβεννο», δηλ. ως πολίτης / σε καιρό ειρήνης." },
          ...
          { l:"prohibuisset", r:"Ρήμα", g:"γ΄ ενικ. υποτ. υπερσυντ. ενεργ.", d:"prohibeo, prohibui, prohibitum, prohibere (2) — εμποδίζω", a:"." }
        ]}
      ]}
    ]},
    ...
    { n: 6, kids: [
      ...
      { type:"main", key:"kyria", label:"Κύρια", note:"Απρόσωπη παθητική περιφραστική από αμετάβατο ρήμα (χωρίς υποκείμενο).", kids:[
        ...
        { l:"tibi", r:"Δοτική προσωπική του ποιητικού αιτίου", to:"στο subveniendum est", g:"δοτ. ενικ. β΄ προσ. — προσωπική αντων.", d:"tu — εσύ", a:"," }
      ]}
    ]},
    ...
    { n: 7, kids: [
      ...
      { type:"main", key:"kyria", label:"Κύρια", kids:[
        ...
        { l:"belli", r:"Γενική αντικειμενική", to:"στο vulnera", g:"γεν. ενικ., ουδ.", d:"bellum, -i (ουδ. β΄) — ο πόλεμος" },
        { l:"vulnera", r:"Υποκείμενο", to:"στο sananda sunt", g:"ονομ. πληθ., ουδ. γ΄ κλ.", d:"vulnus, vulneris (ουδ. γ΄) — η πληγή", a:"," },
        { type:"sub", key:"anaforiki", label:"Αναφορική", note:"Δευτ. αναφορική προσδιοριστική στο vulnera· εκφέρεται με οριστική (πραγματικό γεγονός).", kids:[
          ...
          { l:"mederi", r:"Τελικό απαρέμφατο (αντικείμενο)", to:"στο potest", g:"απαρέμφατο ενεστ. — αποθετικό (medeor, 2)", d:"medeor, —, mederi (αποθ. 2) — θεραπεύω, γιατρεύω (+ δοτ.)" },
  ...
  sos: [
    ...
    { tag:"Δευτερεύουσα", title:"quae … prohibuisset", body:"Η αναφορική «quae idem togatus fieri prohibuisset» εκφέρεται με υποτακτική υπερσυντελίκου και έχει υποθετική/δυνητική χροιά (μη πραγματικό στο παρελθόν)· το fieri είναι τελικό απαρέμφατο-αντικείμενο και το quae υποκείμενό του." },
