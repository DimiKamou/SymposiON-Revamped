export const UNIT = {
  ...
  etymology: [
    { la:"excitanda", el:"(γαλλ.) inciter (= υποκινώ) // (αγγλ.) excite (= διεγείρω), incite (= υποκινώ)." },
    { la:"sentis", el:"(γαλλ.) sentir (= αισθάνομαι) // (αγγλ.) sense (= αίσθηση), sensible (= ευαίσθητος), sentiment (= συναίσθημα)." },
    { la:"perculsa (per + cello)", el:"κέλομαι (= παρακινώ) // (αγγλ.) excellent (= εξαίρετος), excel (= υπερέχω)." },
    { la:"prostrata", el:"στρώννυμι (= στρώνω) // (γαλλ.) prosterner (= υποκλίνω) // (αγγλ.) prostration (= κατάπτωση), prostrate (= πρηνής)." },
    { la:"impetu", el:"πίπτω, πέτομαι (= πετώ) // (αγγλ.) impetus (= ώθηση), impetuous (= ορμητικός)." },
    { la:"necesse", el:"νεσεσέρ (< γαλλ. nécessaire) // (αγγλ.) necessity (= αναγκαιότητα), necessary (= αναγκαίος)." },
    { la:"constituenda", el:"συν-ίστημι // (γαλλ.) constituer (= συγκροτώ) // (αγγλ.) constitute (= συγκροτώ), constitution (= σύνταγμα)." },
    { la:"iudicia (iudex)", el:"(γαλλ.) justice (= δικαιοσύνη), juste (= δίκαιος) // (αγγλ.) justice, judge (= κριτής), judicial (= δικαστικός)." },
    { la:"revocanda", el:"(αγγλ.) vocal (= φωνητικός), voice (= φωνή), revocation (= ανάκληση) // (γαλλ.) vocabulaire (= λεξιλόγιο), voix (= φωνή)." },
    { la:"fides", el:"πείθω // (αγγλ.) confidence (= αυτοπεποίθηση), fidelity (= πίστη) // (γαλλ.) fidèle (= πιστός)." },
    { la:"comprimendae", el:"(γαλλ.) comprimer (= συμπιέζω) // κομπρεσέρ (< γαλλ. compresseur), κομπρέσα (< ιταλ.) // (αγγλ.) compress (= συμπιέζω)." },
    { la:"libidines", el:"λίμπιντο // (γερμ.) Liebe (= αγάπη) // (αγγλ.) libido (= γενετήσια ορμή)." },
    { la:"propaganda", el:"προπαγάνδα (< γαλλ.) // (αγγλ.) propagate (= διαδίδω), propagation (= εξάπλωση, διάδοση)." },
    { la:"dilapsa (dis + labor)", el:"(αγγλ.) labor (= εργασία), lapse (= παρέλευση), collapse (= κατάρρευση) // (γαλλ.) laborieux (= κοπιαστικός)." },
    { la:"diffluxerunt (dis + fluo)", el:"φλύω (= αναβλύζω) // (αγγλ.) fluent (= ρέων), fluid (= ρευστό), flux (= ροή) // (γαλλ.) fluide (= ρευστό)." },
    { la:"severis", el:"(γαλλ.) sévère (= αυστηρός), sévérité (= αυστηρότητα) // (αγγλ.) severe (= αυστηρός), severity (= αυστηρότητα)." },
    { la:"legibus", el:"λέγω // (αγγλ.) legal (= νόμιμος), legislation (= νομοθεσία), legitimate (= νόμιμος) // (γαλλ.) loi (= νόμος)." },
    { la:"civili", el:"(αγγλ.) city (= πόλη), civil (= πολιτικός), civilisation (= πολιτισμός) // (γαλλ.) cité (= πόλη), civilisation (= πολιτισμός)." },
    { la:"ardore", el:"(γαλλ.) ardeur (= πάθος) // (αγγλ.) ardor (= πάθος), ardent (= φλογερός)." },
    { la:"animorum", el:"άνεμος // ανιμισμός (< γαλλ.) // (αγγλ.) animal (= ζώο), animate (= εμψυχώνω), unanimous (= ομόφωνος)." },
    { la:"armorum, armatus", el:"άρμα, αρματολός // (γαλλ.) armée (= στρατός), armer (= οπλίζω) // (αγγλ.) army (= στρατός), arms (= όπλα), armature." },
    { la:"quassata", el:"(αγγλ.) quash (= συντρίβω, ακυρώνω), squash (= συνθλίβω)." },
    { la:"res, rem", el:"ρεαλισμός (< γαλλ.) // (αγγλ.) real (= πραγματικός), reality (= πραγματικότητα)." },
    { la:"publica, publicam", el:"(γαλλ.) publique (= δημόσιος) // (αγγλ.) public (= δημόσιος), publication (= δημοσίευση), republic (= δημοκρατία)." },
    { la:"res publica, reipublicae", el:"ρεπουμπλικάνος, ρεπουμπλικανισμός // ρεπούμπλικα (= είδος ανδρικού καπέλου) (< ιταλ.) // (αγγλ.) republic, republican." },
    { la:"multa", el:"μάλα (= πολύ) // (αγγλ.) multiple (= πολλαπλός), multitude (= πλήθος) // (γαλλ.) multitude (= πλήθος)." },
    { la:"perdidit (per + do)", el:"δίδωμι // (γαλλ.) perdre (= χάνω), perdition (= απώλεια) // (αγγλ.) perdition (= απώλεια)." },
    { la:"ornamenta", el:"(αγγλ.) ornament (= στολίδι), ornate (= διακοσμημένος) // (γαλλ.) orner (= στολίζω)." },
    { la:"dignitatis", el:"(γαλλ.) dignité (= αξιοπρέπεια), αντίθ. indignité // (αγγλ.) dignity (= αξιοπρέπεια), dignitary (= αξιωματούχος)." },
    { la:"praesidia (prae + sedeo)", el:"έζομαι, έδρα // (αγγλ.) preside (= προεδρεύω), president (= πρόεδρος), possession (= κατοχή)." },
    { la:"stabilitatis", el:"ίστημι, στάση // (γαλλ.) stabilité (= σταθερότητα) // (αγγλ.) stability (= σταθερότητα), stable (= σταθερός)." },
    { la:"dux", el:"(αγγλ.) duke (= δούκας), conduct (= διεξάγω), educate (= εκπαιδεύω) // (γαλλ.) duc (= δούκας), conduire (= οδηγώ)." },
    { la:"fecit (facio)", el:"(αγγλ.) fact (= γεγονός), factory (= εργοστάσιο), fiction (= μυθοπλασία) // (γαλλ.) fait (= γεγονός), faire (= κάνω)." },
    { la:"togatus (toga)", el:"στέγω (= σκεπάζω) // (αγγλ.) toga (= τήβεννος)." },
    { la:"prohibuisset (prohibeo)", el:"(γερμ.) haben (= έχω) // (γαλλ.) prohiber (= απαγορεύω) // (αγγλ.) prohibit (= απαγορεύω), prohibition (= απαγόρευση)." },
    { la:"subveniendum (sub + venio)", el:"βαίνω // (γαλλ.) subvention (= επιχορήγηση) // (αγγλ.) subvention (= επιδότηση), convene (= συγκαλώ)." },
    { la:"nunc", el:"νυν // (αγγλ.) now (= τώρα)." },
    { la:"vulnera", el:"ουλή (= επουλωμένη πληγή) // (αγγλ.) vulnerable (= τρωτός, ευπαθής), invulnerable (= άτρωτος)." },
    { la:"sananda", el:"σῶς (= υγιής) // σανατόριο // (γαλλ.) sanatorium // (αγγλ.) sane (= υγιής), sanitary (= υγιεινός)." },
    { la:"mederi", el:"(ομηρ.) μέδομαι (= φροντίζω) // (γαλλ.) médecin (= γιατρός), médecine (= ιατρική) // (αγγλ.) medicine (= φάρμακο), remedy (= θεραπεία)." },
    { la:"nemo (ne + homo)", el:"(αγγλ.) homo sapiens, human (= ανθρώπινος) // (γαλλ.) homme (= άνθρωπος)." },
    { la:"potest (potis + sum)", el:"πόσις, δεσ-πότης (= «κύριος του σπιτιού») // (αγγλ.) potent (= ισχυρός), potential (= δυνητικός), possible (= δυνατός) // (γαλλ.) pouvoir (= μπορώ / δύναμη)." }
  ]
};
