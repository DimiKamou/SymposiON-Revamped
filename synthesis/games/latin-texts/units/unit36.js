export const UNIT = {
  ...
  etymology: [
    ...
    { la:"Dentatus", el:"Δεντάτος // (αγγλ.) dentist (= οδοντίατρος), dental (= οδοντικός) // (γαλλ.) dent (= δόντι) // (ιταλ.) dente (= δόντι) // (ισπαν.) diente (= δόντι)." },
    { la:"maxima", el:"μάξιμουμ // μαξιμαλισμός (< γαλλ.) // (αγγλ.) maxim (= απόφθεγμα, γνωμικό) // (γαλλ.) maxime (= απόφθεγμα, γνωμικό) // (ιταλ.) massimo (= μέγιστος)." },
    { la:"frugalitate", el:"(γαλλ.) frugal (= ολιγαρκής), frugalité (= λιτότητα) // (αγγλ.) frugality (= ολιγάρκεια, λιτότητα)." },
    { la:"utebatur, uteretur [< utor]", el:"(αγγλ.) utility (= χρησιμότητα), use (= χρήση), utensil (= σκεύος, εργαλείο), abuse (= κατάχρηση) // (γαλλ.) utile (= χρήσιμος), utiliser (= χρησιμοποιώ)." },
    { la:"facilius [< facio]", el:"(αγγλ.) facts (= γεγονότα), factory (= εργοστάσιο), facile (= εύκολος), facility (= ευκολία, εγκατάσταση), difficult (= δύσκολος) // (γαλλ.) facile (= εύκολος)." },
    { la:"divitias [< dives]", el:"δῖος [< Διός] (= όμοιος με / προς τους θεούς, θεϊκός) // (γαλλ.) divin (= θεϊκός) // (ιταλ.) dovizia (= αφθονία, πλούτος)." },
    { la:"con-temnere, con-tempsit [< con-temno]", el:"τέμνω // (αγγλ.) contempt (= περιφρόνηση), contemptible (= αξιοκαταφρόνητος)." },
    { la:"posset, posse [< potis + esse]", el:"πόσις, δεσπότης (= «κύριος σπιτιού») // (αγγλ.) possible (= δυνατός, πιθανός), power (= δύναμη, εξουσία) // (γαλλ.) pouvoir (= μπορώ / εξουσία)." },
    { la:"Samnitium, Samnites, Samnitibus", el:"Σαμνίτες." },
    { la:"legati, legationis [< lego]", el:"λέγω // (αγγλ.) legate (= απεσταλμένος, λεγάτος), delegate (= εκπρόσωπος, αντιπρόσωπος) // (γαλλ.) légat (= απεσταλμένος, λεγάτος)." },
    { la:"catillo", el:"κοτύλη (= κύπελλο)." },
    { la:"cenantem [< ceno]", el:"(ισπαν.) cena (= δείπνο) // (γαλλ.) cène (= ο Μυστικός Δείπνος)." },
    { la:"spectandum [< specto]", el:"σπέκουλα (= κερδοσκοπία), σπεκουλαδόρος, σπεκουλάρω (< ιταλ.) // (αγγλ.) pro-spect (= προοπτική, άποψη), spectator / inspect (= θεατής / επιθεωρώ) // (γαλλ.) spectateur (= θεατής)." },
    { la:"praebuit [< prae + habeo]", el:"(γερμ.) haben (= έχω), (αγγλ.) have // (γαλλ.) pro-hiber (= απαγορεύω), avoir (= έχω) // (αγγλ.) exhibit (= εκθέτω), habit (= συνήθεια, ένδυμα)." },
    { la:"paupertatem [< pauper]", el:"παῦρος // (γαλλ.) pau-vre (= φτωχός), pau-vreté (= φτώχεια) // (αγγλ.) pauper / poverty (= άπορος / φτώχεια) // (ιταλ.) povero (= φτωχός)." },
    { la:"mirati [< miror]", el:"(γαλλ.) miracle (= θαύμα), admirable (= θαυμαστός) // (αγγλ.) admire / marvel (= θαυμάζω / θαύμα) // (ιταλ.) ammirare (= θαυμάζω)." },
    { la:"sunt [< sum]", el:"εἰμί // (αγγλ.) essence / absent (= ουσία / απών) // (γαλλ.) présent / essence (= παρών / ουσία)." },
    { la:"magnum", el:"μέγας // (αγγλ.) magni-fic (= μεγαλοπρεπής), magnitude / magnify (= μέγεθος / μεγεθύνω) // (γαλλ.) magnificence (= μεγαλοπρέπεια), magnitude (= μέγεθος)." },
    { la:"pondus", el:"(γαλλ.) peser (= ζυγίζω), pondérer (= σταθμίζω, εξισορροπώ) // (αγγλ.) pending (= εκκρεμής), pound / ponder (= λίβρα / σταθμίζω, συλλογίζομαι)." },
    { la:"auri [< aurum]", el:"(γαλλ.) or (= χρυσός) // (ιταλ.) oro (= χρυσός) // (ισπαν.) oro (= χρυσός)." },
    { la:"publice", el:"(γαλλ.) publique (= δημόσιος), publier (= δημοσιεύω) // ρεπουμπλικανός // (αγγλ.) public / publish (= δημόσιος / δημοσιεύω)." },
    { la:"missum [< mitto]", el:"(αγγλ.) mission (= αποστολή), missile / message (= βλήμα / μήνυμα) // (γαλλ.) mettre (= βάζω, θέτω) // (ιταλ.) mettere (= βάζω, θέτω)." },
    { la:"venerunt [< venio]", el:"βαίνω // (γαλλ.) avenue (= λεωφόρος), venir (= έρχομαι) // (αγγλ.) event / invent (= γεγονός / εφευρίσκω) // (ιταλ.) venire (= έρχομαι)." },
    { la:"risu [< rideo]", el:"(γαλλ.) rire (= γελώ) // (αγγλ.) ridiculous / deride (= γελοίος / χλευάζω) // (ιταλ.) ridere (= γελώ) // (ισπαν.) reír (= γελώ)." },
    { la:"scamno", el:"σκίμπους, σκαμνί // σκαμπό (< γαλλ. escabeau) // (αγγλ.) shambles (= χάος, σφαγείο (αρχικά: πάγκος κρεοπωλείου)) // (ιταλ.) scanno (= κάθισμα, έδρανο) // (ισπαν.) escaño (= έδρανο, βουλευτική έδρα)." },
    { la:"assidentem [< assideo < ad + sedeo]", el:"ἕζομαι, ἕδρα // (γαλλ.) assis (= καθισμένος), séance (= συνεδρία, συνεδρίαση) // (αγγλ.) pos-session (= κατοχή, κτήση), sedentary (= καθιστικός)." },
    { la:"focum [< focus]", el:"(αγγλ.) focus (= εστίαση), fuel (= καύσιμο) // (γαλλ.) focaliser (= εστιάζω), feu (= φωτιά) // (ιταλ.) fuoco (= φωτιά) // (ισπαν.) fuego (= φωτιά)." },
    { la:"solvit [< solvo]", el:"σβέλτος (< ιταλ.) // (γαλλ.) solution (= λύση), solvant (= διαλύτης) // (αγγλ.) solve (= λύνω), dissolve (= διαλύω)." },
    { la:"dixit, dicam [< dico]", el:"δείκνυμι (= δείχνω) // (γαλλ.) dictionnaire (= λεξικό), dictée (= ορθογραφία, υπαγόρευση), dire (= λέω) // (αγγλ.) predict (= προβλέπω)." },
    { la:"super-vacaneae", el:"(αγγλ.) vacancy (= κενότητα), vacation (= διακοπές), evacuate (= εκκενώνω) // (γαλλ.) vacant (= κενός), vacuum (= κενό), vacances (= διακοπές)." },
    { la:"ligneo", el:"λιγνίτης (< γαλλ.) // (αγγλ.) ligneous (= ξυλώδης) // (γαλλ.) ligneux (= ξυλώδης)." },
    { la:"in-eptae [< in + aptus]", el:"ἅπτω // (αγγλ.) inept (= ανάρμοστος, ανόητος), adapt (= προσαρμόζω), attitude (= στάση, νοοτροπία)." },
    { la:"ministri", el:"(γαλλ.) ministre (= υπουργός), métier (= επάγγελμα, τέχνη) // (αγγλ.) ad-ministration (= διαχείριση), minstrel (= τραγουδιστής, βάρδος)." },
    { la:"narrate [< narro]", el:"(αγγλ.) narrator (= αφηγητής) // (γαλλ.) narration (= αφήγηση)." },
    { la:"malle [< malo < magis + volo]", el:"βούλομαι // (αγγλ.) volunteer (= εθελοντής), voluntary (= εθελοντικός, εκούσιος) // (γαλλ.) vouloir (= θέλω)." },
    { la:"locupletibus, locupletem [< locuples (= «πλούσιος σε γη») < locus + plenus]", el:"(γαλλ.) locale (= τοπικός), lieu (= τόπος, θέση), plein (= γεμάτος, πλήρης) // (αγγλ.) location (= τοποθεσία), plenty (= αφθονία) // πίμπλημι / πλήθω· πλήθος, πλημμύρα, πλήρης, πλησμονή." },
    { la:"imperare", el:"ιμπεριαλισμός (< γαλλ.) // (αγγλ.) emperor (= αυτοκράτορας), imperative (= προστακτική, επιτακτικός) // (γαλλ.) empire (= αυτοκρατορία)." },
    { la:"fieri [< fio]", el:"φύω, φύσις." },
    { la:"mementote [< memini]", el:"μέμνημαι, μνήμη, μνημονικός // (αγγλ.) monument (= μνημείο), memento (= ενθύμιο)." },
    { la:"acie [< acies]", el:"ἄκρη, ἀκμή // (γαλλ.) acide (= οξύς), aci-culaire (= βελονοειδής), aigu (= οξύς, αιχμηρός) // (αγγλ.) acute (= οξύς)." },
    { la:"vinci [< vinco]", el:"βικτοριανός (< αγγλ.) // (γαλλ.) victoire (= νίκη), (αγγλ.) victory, vaincre (= νικώ) // (αγγλ.) convince (= πείθω), invincible (= ανίκητος)." },
    { la:"corrumpi [< corrumpo]", el:"(γαλλ.) corruption (= διαφθορά), corrompre (= διαφθείρω), rompre (= σπάζω, διαρρηγνύω) // (αγγλ.) rupture (= ρήξη), interrupt (= διακόπτω)." }
  ]
};
