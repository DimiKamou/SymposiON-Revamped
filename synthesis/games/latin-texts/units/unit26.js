export const UNIT = {
  ...
  etymology: [
    ...
    { la:"salutem", el:"(γαλλ.) salutation (= χαιρετισμός) // (αγγλ.) salute (= χαιρετώ) // (ιταλ.) salute (= υγεία) // (ισπαν.) salud (= υγεία)." },
    { la:"tristissimus", el:"(γαλλ.) tristesse (= λύπη), triste (= λυπημένος) // (γερμ.) trist." },
    { la:"scribo", el:"σκάριφος (= όργανο γραφής), σκαρίφημα // (αγγλ.) script (= σενάριο κινηματογραφικής ταινίας), describe (= περιγράφω), scribe (= γραφέας) // (γαλλ.) écrire (= γράφω) // (ιταλ.) scrivere (= γράφω)." },
    { la:"Fundani", el:"Φουνδανός." },
    { la:"minor", el:"μινόρε, μίνιμουμ, μινιατούρα (< ιταλ.) // μινιμαλισμός (< γαλλ.) // (γαλλ.) minute (= δευτερόλεπτο) // (αγγλ.) minor (= ελάσσων, μικρότερος) // (ισπαν.) menor (= μικρότερος)." },
    { la:"mortua", el:"βροτός (= νεκρός) // (αγγλ.) mortal (= θνητός), immortal (= αθάνατος) // (γαλλ.) mourir (= πεθαίνω) // (ιταλ.) morte (= θάνατος) // (ισπαν.) muerte (= θάνατος)." },
    { la:"est, erat", el:"εἰμί // (αγγλ.) essence (= ουσία) // (γαλλ.) être (= είμαι / ον) // (ιταλ.) essere (= είμαι)." },
    { la:"puella, puellaris (puer)", el:"puerulus → pullus (= μικρό ζώο) → (κατάληξη) -πουλος // (αγγλ.) puerile (= παιδαριώδης) // (γαλλ.) poule (= κότα) // (ιταλ.) pollo (= κοτόπουλο)." },
    { la:"festivius", el:"φεστιβάλ (< γαλλ.) // (αγγλ.) feast (= γιορτή, συμπόσιο) // (γαλλ.) fête (= γιορτή) // (ιταλ.) festa (= γιορτή) // (ισπαν.) fiesta (= γιορτή)." },
    { la:"amabilius, amicos, amanter", el:"αμόρε (< ιταλ.) // (γαλλ.) amour (= αγάπη), ami (= φίλος), amical (= φιλικός) // (αγγλ.) amiable (= φιλικός, ευχάριστος), amateur (= ερασιτέχνης), enemy (= εχθρός) // (ιταλ.) amico (= φίλος)." },
    { la:"longiore", el:"δολιχ-ός // (αγγλ.) long, (γαλλ.) longue, longitude (= γεωγραφικό μήκος), prolong (= παρατείνω) // (ιταλ.) lungo (= μακρύς)." },
    { la:"vita", el:"βίος // βιταλισμός (< γαλλ. vitalisme), βιταμίνη (< γαλλ.) // (γαλλ.) vie (= ζωή) // (ισπαν.) vida (= ζωή)." },
    { la:"dignius", el:"(γαλλ.) dignité (= αξιοπρέπεια), αντιθ. indignité, digne (= άξιος) // (αγγλ.) dignity (= αξιοπρέπεια) // (ιταλ.) degno (= άξιος) // (ισπαν.) digno (= άξιος)." },
    { la:"vidi, prudentia [< pro-videntia < pro + video]", el:"(Ϝιδεῖν) ιδέα, βίντεο (< αγγλ.) // (αγγλ.) vision (= όραση), prudent (= συνετός) // (γαλλ.) voir (= βλέπω) // (ιταλ.) vedere (= βλέπω) // (ισπαν.) ver (= βλέπω)." },
    { la:"annos", el:"(γαλλ.) année (= έτος, χρονιά) // (αγγλ.) annual (= ετήσιος), anniversary (= επέτειος) // (ιταλ.) anno (= έτος) // (ισπαν.) año (= έτος)." },
    { la:"im-pleverat", el:"πίμπλημι / πληθύς· πλήθος, πλημμύρα, πλήρης, πλησμονή // (αγγλ.) complete (= πλήρης, ολοκληρωμένος), plenty (= αφθονία) // (γαλλ.) plein (= γεμάτος) // (ιταλ.) pieno (= γεμάτος) // (ισπαν.) lleno (= γεμάτος)." },
    { la:"matronalis", el:"μήτηρ // (γαλλ.) maternel (= μητρικός), mère (= μητέρα) // (αγγλ.) maternal (= μητρικός), matron (= σεβαστή/έγγαμη γυναίκα) // (ιταλ.) madre (= μητέρα) // (ισπαν.) madre (= μητέρα)." },
    { la:"gravitas", el:"βαρύς // (γαλλ.) gravité (= βαρύτητα, σοβαρότητα), grave (= βαρύς, σοβαρός) // (αγγλ.) gravity (= βαρύτητα), grave (= σοβαρός) // (ιταλ.) grave (= βαρύς, σοβαρός) // (ισπαν.) grave (= σοβαρός)." },
    { la:"suavitas", el:"ἁδύς (ἡδύς)· ηδονή // (αγγλ.) sweet (= γλυκύς), sweetness (= γλυκύτητα), suave (= απαλός, ευχάριστος) // (γαλλ.) suave (= γλυκός, απαλός) // (ιταλ.) soave (= γλυκός, απαλός) // (ισπαν.) suave (= απαλός, μαλακός)." },
    { la:"patris, paternos", el:"πατήρ // (γαλλ.) paternel (= πατρικός), père (= πατέρας) // (αγγλ.) paternal (= πατρικός), patron (= προστάτης, πάτρωνας) // (ιταλ.) padre (= πατέρας) // (ισπαν.) padre (= πατέρας)." },
    { la:"cer-vicibus", el:"κάρα, κορυφή // (αγγλ.) cervix (= τράχηλος), cervical (= τραχηλικός, αυχενικός) // (γαλλ.) cervical (= τραχηλικός) // (ιταλ.) cervice (= αυχένας, τράχηλος) // (ισπαν.) cerviz (= αυχένας)." },
    { la:"inhaerebat", el:"(γαλλ.) inhérent (= σύμφυτος), adhérer (= προσκολλώμαι) // (αγγλ.) coherent (= συνεκτικός), hesitate (= διστάζω) // (ιταλ.) aderire (= προσκολλώμαι) // (ισπαν.) adherir (= προσκολλώμαι)." },
    { la:"modeste", el:"(γαλλ.) modeste (= σεμνός) // (αγγλ.) moderate (= μετριοπαθής) // (ιταλ.) modesto (= σεμνός) // (ισπαν.) modesto (= σεμνός)." },
    { la:"complectebatur", el:"κόμπλεξ (< αγγλ.) // (γαλλ.) complexe (= σύμπλεγμα) // (ιταλ.) complesso (= σύνθετος, περίπλοκος) // (ισπαν.) complejo (= σύνθετος, περίπλοκος)." },
    { la:"nutrices", el:"(αγγλ.) nutrient (= θρεπτικό συστατικό), nurse (= νοσοκόμα, τροφός), nourish (= τρέφω) // (γαλλ.) nutrition [= (δια)τροφή], nourrir (= τρέφω), nourrice (= παραμάνα, τροφός)." },
    { la:"paedagogos", el:"παιδαγωγός // (αγγλ.) pedagogue (= παιδαγωγός) // (γαλλ.) pédagogie (= παιδαγωγική)." },
    { la:"praeceptores [< prae + capio]", el:"(γαλλ.) ac-cepter (= δέχομαι), précepteur (= οικοδιδάσκαλος) // (ιταλ.) capire (= καταλαβαίνω) // (αγγλ.) precept (= παράγγελμα, κανόνας)." },
    { la:"diligebat", el:"λέγω // (αγγλ.) diligent (= επιμελής), diligence (= επιμέλεια) // (γαλλ.) diligence (= επιμέλεια)." },
    { la:"studiose", el:"στούντιο (< ιταλ.) (= εργαστήριο καλλιτέχνη, σπουδαστήριο, μικρό διαμέρισμα) // (αγγλ.) student (= μαθητής), studious (= επιμελής) // (γαλλ.) étude (= μελέτη, σπουδή), étudier (= μελετώ, σπουδάζω)." },
    { la:"intellegenter", el:"(γαλλ.) intelligent (= ευφυής) // (αγγλ.) intelligence (= νοημοσύνη), intellect (= διάνοια) // (ιταλ.) intelligente (= ευφυής)." },
    { la:"lectitabat", el:"λέκτορας // (αγγλ.) lecture (= διάλεξη) // (γαλλ.) lecture (= ανάγνωση), leçon (= μάθημα)." },
    { la:"patientia", el:"παθεῖν // πασιέντσα (< ιταλ.) // (γαλλ.) patience (= υπομονή), passif (= παθητικός) // (αγγλ.) patiens (= ασθενής), passion (= πάθος), passive (= παθητικός)." },
    { la:"constantia", el:"ἵστημι, στάση, Κωνσταντίνος // (γαλλ.) station (= στάση, σταθμός), stable (= σταθερός), stabilité (= σταθερότητα), constance (= σταθερότητα), constant (= σταθερός) // (αγγλ.) constant (= σταθερός)." },
    { la:"novissimam", el:"νέος· (αγγλ.) new // (αγγλ.) novel (= καινοφανής· μυθιστόρημα), novice (= αρχάριος) // (γαλλ.) nouveau (= νέος)." },
    { la:"valetudinem [< validus]", el:"(γαλλ.) valider (= επιβεβαιώνω), valeur (= αξία) // (αγγλ.) value (= αξία)." }
  ]
};
