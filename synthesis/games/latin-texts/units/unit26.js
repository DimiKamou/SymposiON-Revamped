  ...
  periods: [
    ...
    { n: 2, kids: [
      { type:'main', key:'kyria', label:'Κύρια', kids:[
        ...
        { type:'sub', key:'anaforiki', label:'Αναφορική', note:'Δευτ. αναφορική προσδιοριστική στο Accius, με οριστική (πραγματικό).', kids:[
          ...
          { l:'natu', r:'Αφαιρετική της αναφοράς', to:'στο minor', g:'αφαιρ. ενικ. (δ΄ κλ.) — απαντά μόνο σε αφαιρετική (natu)', d:'natus, -us (αρσ. δ΄) — η ηλικία· «minor natu» = μικρότερος στην ηλικία' },
    ...
    { n: 3, kids: [
      { type:'main', key:'kyria', label:'Κύρια', note:'Ρήμα εξάρτησης dixit· ακολουθεί πλάγιος λόγος με δύο ειδικά απαρέμφατα (esse, videri) ως αντικείμενα.', kids:[
        ...
        { type:'sub', key:'anaforiki', label:'Αναφορική', note:'Δευτ. αναφορική προσδιοριστική· λειτουργεί ως υποκείμενο του απαρεμφάτου esse. Εκφέρεται με υποτακτική (scripsisset) λόγω πλαγίου λόγου (έλξη).', kids:[
          { l:'quae', r:'Αντικείμενο', to:'στο scripsisset (και υποκ. του esse)', g:'αιτ. πληθ., ουδ. — αναφορ. αντων.', d:'qui, quae, quod — αυτά που, όσα' },
