...
<div id="mn-screen-end" class="mn-screen">
  ...
  function rosetteSVG(){ return `<svg viewBox="0 0 48 48" class="mn-rosette" aria-hidden="true" fill="none" stroke="currentColor">
    <circle cx="24" cy="24" r="16" stroke-width="1"/>
    <circle cx="24" cy="24" r="9.5" stroke-width="1" opacity="0.8"/>
    <path d="M24 8v6M24 34v6M8 24h6M34 24h6" stroke-width="1" opacity="0.7"/>
    <path d="M13 13l4 4M31 31l4 4M35 13l-4 4M17 31l-4 4" stroke-width="1" opacity="0.45"/>
