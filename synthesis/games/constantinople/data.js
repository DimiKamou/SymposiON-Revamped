...
window.XP_APP = {
  ...
  exhibits: [
    ...
    { id: 'hagiasophia', n: 5, at: [195, -8], view: [165, -45, 2.7, -0.15], viewY: 45, era: 2,
      ...
      body: { en: 'Watch the skyline change between 413 and 537: the long gabled basilica burns in the Nika riot and Justinian answers with the impossible — a 31-metre dome floating over the city. For nine hundred years travellers coming up the Marmara saw this silhouette first and understood what the City claimed to be. Beside it, from 543, Justinian\'s own column carried his bronze horseman — arm stretched out to the east, Prokopios says, commanding the Persians to stay home. To stand under that dome, open the separate Hagia Sophia 537 experience in SymposiON.',
        gr: 'Δείτε τον ορίζοντα να αλλάζει από το 413 στο 537: η μακριά ξυλόστεγη βασιλική καίγεται στη Στάση του Νίκα και ο Ιουστινιανός απαντά με το αδύνατο — έναν τρούλο 31 μέτρων να πλέει πάνω από την πόλη. Επί εννιακόσια χρόνια οι ταξιδιώτες που ανέβαιναν τον Μαρμαρά έβλεπαν πρώτη αυτή τη σιλουέτα. Δίπλα της, από το 543, ο κίονας του Ιουστινιανού σήκωνε τον χάλκινο καβαλάρη του — με το χέρι τεντωμένο ανατολικά, γράφει ο Προκόπιος, να προστάζει τους Πέρσες να μείνουν στον τόπο τους. Για να σταθείτε κάτω από τον τρούλο, ανοίξτε την εμπειρία «Αγία Σοφία 537» στο SymposiON.' } },
    ...
    { id: 'mese', n: 8, at: [148, 10], view: [120, 40, 1.05, -0.22], viewY: 40, era: 3,
      ...
      body: { en: 'One colonnaded avenue — the Mese, "Middle Street" — ran from the palace square through a string of round and square forums, each with its monument: Constantine\'s porphyry column carried the founder as sun-god; in the Forum of Theodosius a spiral column of victories answered Rome\'s, and the column of Arcadius rose over the southwest branch toward the Golden Gate. Under the porticoes were the silk shops, perfumers and money-changers of the richest market in Christendom; along it rolled triumphs, icons and funerals for eleven centuries.',
        gr: 'Μία λεωφόρος με κιονοστοιχίες — η Μέση Οδός — έτρεχε από την πλατεία του παλατιού μέσα από μια αλυσίδα φόρουμ, καθένα με το μνημείο του: ο πορφυρός κίονας του Κωνσταντίνου έφερε τον ιδρυτή ως θεό-Ήλιο· στο Φόρον του Ταύρου ελισσόταν κίονας με τις νίκες του Θεοδοσίου, απάντηση στη Ρώμη, και πάνω από τη νοτιοδυτική διακλάδωση, προς τη Χρυσή Πύλη, υψωνόταν ο κίονας του Αρκαδίου. Στις στοές βρίσκονταν τα μεταξωτά, οι αρωματοπώλες και οι αργυραμοιβοί της πλουσιότερης αγοράς της χριστιανοσύνης· πάνω της κύλησαν θρίαμβοι, εικόνες και κηδείες έντεκα αιώνων.' } },
