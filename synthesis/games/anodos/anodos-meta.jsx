...
const COSMETICS = [
  ...
  { id: "frost",    slot: "palette", price: 200, icon: "❄", name: "Κρύσταλλος Βορρᾶ", en: "Boreal Frost", note: "Τὸ παγωμένο ἀναπνευστὸ τοῦ Βορρᾶ.", swatch: ["#0A0F14", "#7FC8D6"] },
  { id: "ember",    slot: "palette", price: 240, icon: "🌋", name: "Αἷμα τοῦ Ἄρεος", en: "Blood of Ares", note: "Τὸ κόκκινο τῆς μάχης καὶ τῆς φωτιᾶς.", swatch: ["#120808", "#E0563E"] },
  { id: "verdant",  slot: "palette", price: 200, icon: "🌿", name: "Ἀσφόδελος Λειμών", en: "Asphodel Meadow", note: "Τὸ αἰώνιο πράσινο τῶν νεκρῶν λιβαδιῶν.", swatch: ["#0A0F0A", "#7FB069"] },
  // backdrops ─────────────────────────────────────────────
  ...
  { id: "olympus",        slot: "backdrop", price: 190, icon: "☁", name: "Νεφέλαι Ὀλύμπου", en: "Olympus", note: "Νέφη καὶ θεῆες ἀκτῖνες πάνω ἀπ' τὸν θρόνο τῶν θεῶν." },
  { id: "storm",          slot: "backdrop", price: 200, icon: "⚡", name: "Κεραυνὸς τοῦ Διός", en: "Zeus' Storm", note: "Μαῦρα σύννεφα σχισμένα ἀπὸ ἀστραπές." },
  { id: "eclipse",        slot: "backdrop", price: 180, icon: "🌑", name: "Ἔκλειψις", en: "Eclipse", note: "ὁ μαῦρος ἥλιος μὲ τὴ φλεγόμενη στεφάνη." },
  { id: "volley",         slot: "backdrop", price: 150, icon: "🏹", name: "Βέλη τῶν Τειχῶν", en: "Arrow Volley", note: "Μιὰ αἰώνια βροχὴ ἀπὸ βέλη στὸν ἀέρα." },
  // particles ─────────────────────────────────────────────
  ...
  { id: "rain",   slot: "particles", price: 100, icon: "🌧", name: "Βροχὴ τοῦ Διός", en: "Rain", note: "Λοξὲς σταγόνες βροχῆς." },
  { id: "snow",   slot: "particles", price: 110, icon: "❅", name: "Χιὼν Θρᾷκης", en: "Snowfall", note: "Λευκὲς νιφάδες ποὺ στροβιλίζονται." },
  { id: "glyphs", slot: "particles", price: 140, icon: "Α", name: "Πίπτοντα Γράμματα", en: "Falling Letters", note: "Γράμματα ποὺ πέφτουν σὰν βροχή." },
  // path skins ────────────────────────────────────────────
  ...
  { id: "blood",   slot: "path", price: 100, icon: "〜", name: "Αἱμάτινο Μονοπάτι", en: "Blood Path", note: "Ὁ κόκκινος δρόμος τοῦ Ἄρεος." },
  { id: "shadow",  slot: "path", price: 110, icon: "〜", name: "Σκιερὸ Μονοπάτι", en: "Shadow Path", note: "Τὸ μονοπάτι τῶν σκιῶν τοῦ Ἄιδου." },
];
...
const BOOSTS = [
  ...
  { id: "torch",    icon: "🔦", name: "Δᾴς Προνοίας", en: "Torch",     price: 140, desc: "Προβλέπεις τὸ περιεχόμενο κάθε κόμβου.", enDesc: "Foresee what every node on the map holds." },
  { id: "phoenix",  icon: "🔥", name: "Φοῖνιξ",      en: "Phoenix",   price: 240, desc: "Μία φορὰ ἀνὰ ἄνοδο: ἀναστήσου μὲ 25 μένος.", enDesc: "Once per climb: rise again with 25 spirit." },
  { id: "fortune",  icon: "🍀", name: "Τύχη Ἀγαθή",  en: "Good Fortune", price: 170, desc: "Τὰ γεγονότα τύχης γέρνουν πρὸς τὸ καλό (72%).", enDesc: "Luck events lean lucky — 72% to land a boon." },
  { id: "scavenger",icon: "🦅", name: "Σκυλεύων",    en: "Scavenger", price: 130, desc: "+6 δραχμὲς ἀπὸ κάθε νικημένη μάχη.", enDesc: "+6 drachmas from every battle you win." },
  { id: "haggler",  icon: "⚖", name: "Παζαρευτής",   en: "Haggler",   price: 120, desc: "Οἱ ἀγορὲς χρεώνουν 25% λιγότερο.", enDesc: "Markets charge 25% less for relics." },
];
...
const ACHIEVEMENTS = [
  ...
  { id: "legend",     group: "Δόξα",     icon: "🏆", name: "Θρῦλος",         en: "Living Legend",   desc: "Κέρδισε 12 πλήρεις ἀνόδους.",       stat: "wins",     goal: 12,  reward: 500 },
  // ── extended ladders ──
  { id: "climb_iv",   group: "Ἄνοδος",   icon: "⛰", name: "Ἀκάματος",       en: "Unwearied",       desc: "Ἀνέβα 600 κόμβους συνολικά.",       stat: "tiles",    goal: 600, reward: 360 },
  { id: "sage_iii",   group: "Σοφία",    icon: "📜", name: "Πάνσοφος",       en: "All-Wise",        desc: "Ἀπάντησε σωστὰ 600 φορές.",         stat: "correct",  goal: 600, reward: 280 },
  { id: "streak_iii", group: "Σοφία",    icon: "✦", name: "Ἀδάμαστος Νοῦς", en: "Adamant Mind",    desc: "Σερὶ 40 σωστῶν ἀπαντήσεων.",        stat: "bestStreak", goal: 40, reward: 240 },
  { id: "riddle_iii", group: "Αἰνίγματα",icon: "𓁹", name: "Σφιγγολύτης",    en: "Sphinx-breaker",  desc: "Λῦσε 50 αἰνίγματα.",                stat: "riddles",  goal: 50,  reward: 280 },
  { id: "swift_ii",   group: "Ταχύτης",  icon: "🪶", name: "Ἀνεμόπους",      en: "Wind-footed",     desc: "40 ἀστραπιαῖες ἀπαντήσεις.",        stat: "fast",     goal: 40,  reward: 180 },
  { id: "boss_ii",    group: "Πόλεμος",  icon: "♛", name: "Πορθητής",       en: "City-sacker",     desc: "Νίκησε 15 ἄρχοντες.",               stat: "bosses",   goal: 15,  reward: 200 },
  { id: "boss_iii",   group: "Πόλεμος",  icon: "♛", name: "Θεομάχος",       en: "God-fighter",     desc: "Νίκησε 40 ἄρχοντες.",               stat: "bosses",   goal: 40,  reward: 360 },
  { id: "flawless_ii",group: "Πόλεμος",  icon: "🏛", name: "Ἀσπίλωτος",      en: "Spotless",        desc: "10 νίκες χωρὶς καμία πληγή.",       stat: "flawless", goal: 10,  reward: 220 },
  { id: "enduring_ii",group: "Περίαπτα", icon: "🩸", name: "Ἀδάμας",         en: "Indomitable",     desc: "Ἄντεξε 50 μιάσματα.",               stat: "cursesEndured", goal: 50, reward: 220 },
  // ── new tracks ──
  { id: "merchant_i", group: "Ἀγορά",    icon: "🪙", name: "Ἔμπορος",        en: "Merchant",        desc: "Ξόδεψε 1.000 δραχμὲς συνολικά.",    stat: "drachmesSpent", goal: 1000, reward: 160 },
  { id: "merchant_ii",group: "Ἀγορά",    icon: "🪙", name: "Ναύκληρος",      en: "Magnate",         desc: "Ξόδεψε 4.000 δραχμὲς συνολικά.",    stat: "drachmesSpent", goal: 4000, reward: 320 },
  { id: "gambler_i",  group: "Τύχη",     icon: "🎲", name: "Παίκτης τῆς Τύχης", en: "Gambler",      desc: "Δοκίμασε τὴν τύχη σου 15 φορές.",   stat: "luck",     goal: 15,  reward: 140 },
  { id: "gambler_ii", group: "Τύχη",     icon: "🎲", name: "Ἀγαπημένος τῆς Τύχης", en: "Fortune's Darling", desc: "Δοκίμασε τὴν τύχη σου 50 φορές.", stat: "luck", goal: 50, reward: 280 },
  { id: "helper",     group: "Τύχη",     icon: "🔮", name: "Πολυμήχανος",    en: "Resourceful",     desc: "Ξόδεψε 30 βοήθειες (lifelines).",   stat: "lifelinesUsed", goal: 30, reward: 150 },
  { id: "atheos_i",   group: "Ἄθεος",    icon: "∅", name: "Αὐτάρκης",        en: "Self-Reliant",    desc: "Κέρδισε 3 ἀνόδους χωρὶς πάτρωνα.",   stat: "godlessWins", goal: 3, reward: 220 },
  { id: "atheos_ii",  group: "Ἄθεος",    icon: "∅", name: "Δίχως Θεούς",     en: "Without Gods",    desc: "Κέρδισε 10 ἀνόδους χωρὶς πάτρωνα.",  stat: "godlessWins", goal: 10, reward: 460 },
  { id: "martyr_i",   group: "Δοκιμασία",icon: "🩸", name: "Μάρτυς",         en: "The Tested",      desc: "Κέρδισε μὲ τὴ Δυσμένεια (3 μιάσματα).", stat: "cursedWins", goal: 1, reward: 180 },
  { id: "martyr_ii",  group: "Δοκιμασία",icon: "⛓", name: "Ἀτσάλινος",      en: "Tempered Steel",  desc: "Κέρδισε 5 ἀνόδους ὑπὸ Δυσμένεια.",   stat: "cursedWins", goal: 5, reward: 380 },
  { id: "ana_i",      group: "Ἀνάβασις", icon: "⛰", name: "Ἥρως τῆς Ἀνάβασης", en: "Ascension Hero", desc: "Φτάσε στὴν Ἀνάβασιν 5.",            stat: "maxAna",   goal: 5,   reward: 300 },
  { id: "ana_ii",     group: "Ἀνάβασις", icon: "⛰", name: "Ὀλύμπιος Νικητής", en: "Olympian Victor", desc: "Κατάκτησε τὴν Ἀνάβασιν 10.",        stat: "maxAna",   goal: 10,  reward: 640 },
  { id: "daily_i",    group: "Ἡμερήσιος",icon: "📅", name: "Καθημερινός",    en: "Daily Climber",   desc: "Κέρδισε 1 ἡμερήσιο ἆθλο.",           stat: "dailyWins", goal: 1,  reward: 120 },
  { id: "daily_ii",   group: "Ἡμερήσιος",icon: "📅", name: "Ἀκοίμητος",      en: "Ever-Vigilant",   desc: "Κέρδισε 7 ἡμερήσιους ἄθλους.",       stat: "dailyWins", goal: 7,  reward: 340 },
];
...
const QUESTS = {
  ...
  q_luck3:    { icon: "🎲", name: "Δοκιμασία τῆς Τύχης",     en: "Tempt Fate",      desc: "Δοκίμασε τὴν τύχη 3 φορές.",  goal: 3,  reward: 40, match: (e) => e === "luck" },
  q_spend:    { icon: "🪙", name: "Ὁ Σπάταλος",             en: "Big Spender",     desc: "Ξόδεψε 120 δραχμές.",         goal: 120,reward: 40, match: (e, p) => e === "spend" ? (p.amt || 0) : false },
  q_lifeline: { icon: "🔮", name: "Ἡ Βοήθεια τῶν Μουσῶν",   en: "A Helping Hand",  desc: "Ξόδεψε 3 βοήθειες σὲ μάχη.", goal: 3,  reward: 35, match: (e) => e === "lifeline" },
  q_curse3:   { icon: "🩸", name: "Ἄντεξε τὰ Μιάσματα",     en: "Endure the Curse",desc: "Ἄντεξε 3 μιάσματα.",          goal: 3,  reward: 40, match: (e) => e === "curse" },
  q_volley:   { icon: "⚡", name: "Ταχεῖα Ριπή",            en: "Quick Volley",    desc: "Κέρδισε 3 ταχεῖες ριπές.",    goal: 3,  reward: 45, match: (e, p) => e === "battleWin" && p.format === "volley" },
  q_correct25:{ icon: "📜", name: "Ἡ Μεγάλη Διδαχή",        en: "Great Lesson",    desc: "Ἀπάντησε σωστὰ 25 φορές.",    goal: 25, reward: 45, match: (e, p) => e === "answer" && p.correct },
  q_riddle5:  { icon: "𓁹", name: "Πέντε Αἰνίγματα",        en: "Five Riddles",    desc: "Λῦσε 5 αἰνίγματα.",           goal: 5,  reward: 50, match: (e, p) => e === "riddle" && p.solved },
  q_relic5:   { icon: "❣", name: "Συλλογὴ Περιάπτων",       en: "Relic Hoard",     desc: "Ἀπόκτησε 5 περίαπτα.",        goal: 5,  reward: 55, match: (e) => e === "relic" },
  q_godless:  { icon: "∅", name: "Μόνος ἐναντίον Ὅλων",     en: "Alone Against All",desc: "Τελείωσε μιὰ ἄνοδο χωρὶς πάτρωνα.", goal: 1, reward: 50, match: (e, p) => e === "runEnd" && p.patron === "none" },
};
...
const QUESTLINE = [
  ...
  { id: "ql8", icon: "∅", name: "Ὁ Ἄθεος Ἀνήρ",        en: "The Godless One", desc: "Κέρδισε μιὰ ἄνοδο χωρὶς πάτρωνα.",   stat: "godlessWins", goal: 1, reward: 260, unlock: "ember" },
  { id: "ql9", icon: "🩸", name: "Διὰ Πυρὸς καὶ Σιδήρου",en: "Through Fire & Iron", desc: "Κέρδισε ὑπὸ τὴ Δυσμένεια (3 μιάσματα).", stat: "cursedWins", goal: 1, reward: 320, unlock: "storm" },
  { id: "ql10",icon: "⛰", name: "Ἡ Ὁδὸς τοῦ Ὀλύμπου",  en: "The Road to Olympus", desc: "Φτάσε στὴν Ἀνάβασιν 5.",         stat: "maxAna",  goal: 5,  reward: 420, unlock: "olympus" },
  { id: "ql11",icon: "🌑", name: "Ἡ Ἔσχατη Δοκιμασία",  en: "The Final Trial", desc: "Κατάκτησε τὴν Ἀνάβασιν 10.",         stat: "maxAna",  goal: 10, reward: 700, unlock: "eclipse" },
];
...
function freshStats() {
  return {
    ...
    luck: 0, luckGood: 0, luckBad: 0, lifelinesUsed: 0,
    godlessWins: 0, cursedWins: 0, dailyWins: 0, maxAna: 0,
    relicIds: [],
  };
}
...
function applyEvent(meta, ev, payload = {}) {
  ...
  switch (ev) {
    ...
    case "luck": s.luck += 1; if (payload.good) s.luckGood += 1; else s.luckBad += 1; break;
    case "lifeline": s.lifelinesUsed += 1; break;
    case "spend": s.drachmesSpent += (payload.amt || 0); break;
    case "runEnd":
      s.runs += 1;
      if (payload.won) {
        s.wins += 1;
        if (payload.patron === "none") s.godlessWins += 1;
        if (payload.cursed) s.cursedWins += 1;
        if (payload.daily) s.dailyWins += 1;
      }
      s.maxAna = Math.max(s.maxAna || 0, payload.anabasis || 0);
      break;
    default: break;
  }
...
function computeRunKleos(run, won) {
  ...
  const fav = (typeof rewardMultiplier === "function") ? rewardMultiplier(run) : 1; // patron + trials
  return Math.max(1, Math.round(base * ana * fav));
}
...
function useMeta() {
  ...
  const api = React.useMemo(() => ({
    ...
    endRun: (run, won) => setMeta((m) => {
      ...
      const res = applyEvent(nm, "runEnd", { won, patron: run.patron || "none", cursed: (run.trials || []).includes("cursed3"), daily: !!run.daily, anabasis: run.anabasis || 0 });
