...
const EVENTS = [
  ...
  {
    title: "Ὁ οἰωνὸς τοῦ ἀετοῦ", sub: "An eagle in the sky",
    body: "Ένας ἀετὸς περνᾶ ἀπὸ δεξιά, κρατώντας ἕνα φίδι. Οἱ μάντεις διχάζονται γιὰ τὸ σημάδι. Πῶς τὸ διαβάζεις;",
    choices: [
      { icon: "🦅", name: "Καλὸς οἰωνὸς — ὅρμα", desc: "Τόλμησε: 60% γιὰ περίαπτο, ἀλλιῶς −8 μένος.", effect: { gamble: true } },
      { icon: "🐍", name: "Κακὸς οἰωνὸς — φυλάξου", desc: "Θεραπεύσου +14 μένος καὶ προχώρα προσεκτικά.", effect: { menos: 14 } },
      { icon: "🕊", name: "Ἀγνόησε τὶς προλήψεις", desc: "Συγκέντρωσε 30 δραχμὲς ἀπ' τοὺς φοβισμένους.", effect: { drachmes: 30 } },
    ],
  },
  {
    title: "Ἡ σκηνὴ τοῦ Νέστορος", sub: "Counsel of old Nestor",
    body: "Ὁ γέρο-Νέστωρ σὲ καλεῖ γιὰ κρασὶ καὶ συμβουλές. Ἡ σοφία του ἔχει τίμημα σὲ χρόνο.",
    choices: [
      { icon: "🍷", name: "Ἄκου τὶς ἱστορίες του", desc: "Κέρδισε δόξα τῆς ἐμπειρίας: +18 ἀνώτατο μένος.", effect: { fortify: 18 } },
      { icon: "📜", name: "Ζήτησε στρατηγικὴ", desc: "Δώσε 28 δραχμές, πάρε ἕνα περίαπτο.", effect: { drachmes: -28, relic: true, needDrachmes: 28 } },
      { icon: "🚶", name: "Εὐχαρίστησε καὶ φύγε", desc: "Δὲν χάνεις χρόνο. Συνέχισε τὴν ἄνοδο.", effect: {} },
    ],
  },
  {
    title: "Τὸ δῶρον τοῦ ξένου", sub: "The laws of xenia",
    body: "Ένας ἄγνωστος ξένος σοῦ προσφέρει φιλοξενία. Ἡ ξενία εἶναι ἱερή — μὰ καὶ ἐπικίνδυνη μὲ ἀγνώστους.",
    choices: [
      { icon: "🤝", name: "Δέξου τὸ δῶρο", desc: "Πάρε 45 δραχμὲς — ὁ ξένος εἶναι γενναιόδωρος.", effect: { drachmes: 45 } },
      { icon: "🎁", name: "Ἀντάλλαξε δῶρα", desc: "Δώσε 20 δρ, κέρδισε +22 μένος ἀπ' τὸ συμπόσιο.", effect: { drachmes: -20, menos: 22, needDrachmes: 20 } },
      { icon: "🗡", name: "Δυσπιστία", desc: "Ρίσκαρε: 50% περίαπτο, ἀλλιῶς −10 μένος.", effect: { gamble: true } },
    ],
  },
  {
    title: "Τὸ αἴνιγμα τοῦ Σειληνοῦ", sub: "The Silenus riddle",
    body: "Ένας μεθυσμένος Σειληνὸς σοῦ ψιθυρίζει ἕναν γρῖφο πρὶν λαγοκοιμηθεῖ.",
    riddle: true,
    riddleQ: "«Ἔχω πόλεις χωρὶς ἀνθρώπους, ποτάμια χωρὶς νερὸ καὶ δάση χωρὶς δέντρα.» Τί εἶμαι;",
    riddleOpts: ["Τὸ ὄνειρο", "Ὁ χάρτης", "Ἡ θάλασσα", "Ὁ οὐρανός"],
    riddleA: 1,
  },
  {
    title: "Ἡ φωνὴ τῆς Ἠχοῦς", sub: "Echo's whisper",
    body: "Στὴ χαράδρα μιὰ φωνὴ ἐπαναλαμβάνει τὰ λόγια σου — καὶ ζητᾶ μιὰ ἀπάντηση.",
    riddle: true,
    riddleQ: "«Δύο ἀδέλφια: τὸ ἕνα βλέπει τὸ ἄλλο, μὰ ποτὲ δὲν συναντιοῦνται.» Τί εἶναι;",
    riddleOpts: ["Τὰ χέρια", "Τὰ μάτια", "Οἱ δύο ὄχθες", "Τὰ πόδια"],
    riddleA: 1,
  },
  {
    title: "Ὁ χρησμὸς τῶν Δελφῶν", sub: "The Delphic oracle",
    body: "Ἡ Πυθία ἐκπνέει ἀτμοὺς καὶ θέτει ἕνα αἴνιγμα ἀντὶ γιὰ χρησμό.",
    riddle: true,
    riddleQ: "«Σπάω χωρὶς νὰ μὲ ἀγγίξεις, καὶ χάνομαι μόλις πεῖς τ' ὄνομά μου.» Τί εἶμαι;",
    riddleOpts: ["Τὸ γυαλί", "Ἡ σιωπή", "Ἡ ὑπόσχεση", "Ὁ καθρέφτης"],
    riddleA: 1,
  },
  // ── LUCK events (Τύχη) — tempt fate for a random boon OR bane ───────
  {
    luck: true, title: "Ὁ τροχὸς τῆς Τύχης", sub: "Fortune's wheel",
    body: "Ἡ θεὰ Τύχη γυρίζει τὸν τροχό της στὴ διασταύρωση. Τολμᾷς νὰ τὸν ἀγγίξεις; Ἡ μοῖρα μπορεῖ νὰ σὲ εὐλογήσει — ἢ νὰ σὲ πλήξει.",
  },
  {
    luck: true, title: "Τὰ ζάρια τοῦ Ἑρμοῦ", sub: "Hermes' dice",
    body: "Ἕνας ταξιδιώτης μὲ φτερωτὰ πέδιλα σοῦ προτείνει μιὰ ζαριά. Ὅ,τι φέρει ὁ κύβος, τὸ δέχεσαι — καλὸ ἢ κακό.",
  },
  {
    luck: true, title: "Τὸ κέρας τῆς Ἀμαλθείας", sub: "Horn of plenty",
    body: "Βρίσκεις τὸ κέρας τῆς αἰγὸς ποὺ θήλασε τὸν Δία. Βάζεις τὸ χέρι μέσα — ἀλλὰ κανεὶς δὲν ξέρει τί θὰ βγάλει.",
  },
  {
    luck: true, title: "Ἡ κλήρωσις τοῦ Καιροῦ", sub: "The fleeting moment",
    body: "Ὁ Καιρός — ὁ θεὸς τῆς εὐκαιρίας — τρέχει μπροστά σου μὲ τὴ μοναδική του τούφα. Ἁρπάζεις; Ἢ θὰ σοῦ ξεφύγει καὶ θὰ πληρώσεις;",
  },
];

// ── LUCK outcome pools (Τύχη) — resolved randomly when you tempt fate ─
const LUCK_BOONS = [
  { id: "heal",    icon: "💧", label: "Εὐλογία ὑγείας",  en: "Blessing of health", apply: (ctx) => { ctx.heal(22); }, msg: "Ἡ Τύχη σὲ θεραπεύει: +22 μένος." },
  { id: "gold",    icon: "🪙", label: "Πλοῦτος",         en: "Sudden riches",      apply: (ctx) => { ctx.gainDrachmes(48); }, msg: "Χρυσὸς πέφτει στὰ χέρια σου: +48 δραχμές." },
  { id: "fortify", icon: "🔥", label: "Ἀνδρεία",         en: "Surge of courage",   apply: (ctx) => { ctx.fortify(18); }, msg: "Τὸ θάρρος σου φουντώνει: +18 ἀνώτατο μένος." },
  { id: "xp",      icon: "✦", label: "Δόξα",            en: "Glory",              apply: (ctx) => { ctx.gainXp(34); }, msg: "Ἡ φήμη σου ἁπλώνεται: +34 δόξα." },
  { id: "relic",   icon: "❣", label: "Δῶρον τῶν θεῶν",  en: "Gift of the gods",   apply: (ctx) => { const r = ctx.takeRelic(); return r ? ("Περίαπτον: " + r.name) : "+30 δραχμές"; }, msg: "Οἱ θεοὶ σοῦ χαρίζουν ἕνα περίαπτο!" },
];
const LUCK_BANES = [
  { id: "wound",  icon: "🩸", label: "Πληγὴ τῆς Τύχης", en: "Wound of fate",   apply: (ctx) => { ctx.damage(16); }, msg: "Ἡ μοῖρα σὲ πληγώνει: −16 μένος." },
  { id: "theft",  icon: "🪤", label: "Κλοπή",           en: "Pickpocketed",   apply: (ctx) => { ctx.spendDrachmes(34); }, msg: "Ἕνας λωποδύτης σὲ ξάφρισε: −34 δραχμές." },
  { id: "curse",  icon: "🌑", label: "Μίασμα",          en: "A miasma clings", apply: (ctx) => { ctx.inflictCurse(); }, msg: "Ἕνα μίασμα προσκολλᾶται πάνω σου." },
];
...
// ── ΔΟΚΙΜΑΣΙΑΙ (Trials) — optional hardship modes toggled at the gate ─────
// each trial RAISES the κλέος reward (mult is ADDED on top of the base 1.0).
// stack as many as you dare — the climb gets brutal, the glory immense.
const TRIALS = [
  { id: "cursed3", icon: "🩸", name: "Δυσμένεια", en: "Curse Trial", mult: 0.40,
    desc: "Ξεκινᾷς τὴν ἄνοδο βαρυμένος μὲ 3 τυχαῖα μιάσματα.", enDesc: "Begin the climb bearing 3 random miasmata." },
  { id: "pauper", icon: "🪨", name: "Πενία", en: "Pauper", mult: 0.20,
    desc: "Ξεκινᾷς χωρὶς καμία δραχμή — πτωχὸς σὰν ἰκέτης.", enDesc: "Begin with no drachmas — poor as a beggar." },
  { id: "glass", icon: "🥀", name: "Ὑάλινος", en: "Glass", mult: 0.35,
    desc: "Ξεκινᾷς μὲ τὸ μισὸ ἀνώτατο μένος.", enDesc: "Begin with half your maximum spirit." },
  { id: "fasting", icon: "🚫", name: "Νηστεία", en: "Fasting", mult: 0.25,
    desc: "Καμία βοήθεια (lifeline) σ' ὅλη τὴν ἄνοδο.", enDesc: "No lifelines may be spent the whole climb." },
  { id: "ironwill", icon: "⛓", name: "Ἀτεστραμμένος", en: "Iron Will", mult: 0.30,
    desc: "Τὰ μιάσματα διαρκοῦν 2 κόμβους παραπάνω.", enDesc: "Every miasma lingers 2 nodes longer." },
];
const TRIAL_BY_ID = Object.fromEntries(TRIALS.map((t) => [t.id, t]));

// ── κλέος favour multiplier — patrons help (less glory), the godless & trials earn more ─
const PATRON_KLEOS_MULT = { none: 1.20, athena: 0.82, ares: 0.82, hermes: 0.82, apollo: 0.82 };
function rewardMultiplier(run) {
  if (!run) return 1;
  let m = (PATRON_KLEOS_MULT[run.patron] != null) ? PATRON_KLEOS_MULT[run.patron] : 1;
  (run.trials || []).forEach((id) => { const t = TRIAL_BY_ID[id]; if (t) m += t.mult; });
...
Object.assign(window, { NODE_TYPES, ACTS, FOES, INTENTS, CURSES, CURSE_POOL, RELICS, QUESTIONS, TF_BANK, EVENTS, generateMap, makeRng, pickFoe,
  ...
  TRIALS, TRIAL_BY_ID, rewardMultiplier, LUCK_BOONS, LUCK_BANES });
