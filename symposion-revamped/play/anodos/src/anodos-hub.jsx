...
function Backdrop({ backdrop, particles }) {
  return (
    ...
    <div className="boosts">
      ...
      <div className="hub__grid hub__grid--wide">
        {BOOSTS.map((b) => {
          ...
          return (
            <div key={b.id} className={"card card--boost" + (equipped ? " card--on" : "") + (owned ? "" : " card--locked")}>
      ...
      <div className="hub__grid hub__grid--wide">
        {LIFELINES.map((l) => {
          ...
          return (
            <div key={l.id} className={"card card--lifeline" + (l.kind === "cheat" ? " card--cheat" : "")}>
              <div className="card__top">
